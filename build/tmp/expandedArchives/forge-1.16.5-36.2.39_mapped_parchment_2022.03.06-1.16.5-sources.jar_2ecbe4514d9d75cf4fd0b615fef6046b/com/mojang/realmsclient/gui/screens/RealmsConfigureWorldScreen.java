...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      drawCenteredString(pMatrixStack, this.font, TITLE, this.width / 2, row(4), 16777215);
      super.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
      if (this.serverData == null) {
         drawCenteredString(pMatrixStack, this.font, WORLD_TITLE, this.width / 2, 17, 16777215);
      } else {
         ...
         drawCenteredString(pMatrixStack, this.font, WORLD_TITLE, this.width / 2, 12, 16777215);
