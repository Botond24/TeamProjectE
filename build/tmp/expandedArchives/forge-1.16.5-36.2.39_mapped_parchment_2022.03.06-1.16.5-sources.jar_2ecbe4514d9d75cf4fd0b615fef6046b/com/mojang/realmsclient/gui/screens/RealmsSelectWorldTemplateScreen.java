...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      if (this.displayWarning) {
         ...
         for(int i1 = 0; i1 < aitextcomponent.length; ++i1) {
            ...
            drawCenteredString(pMatrixStack, this.font, itextcomponent, this.width / 2, row(-1 + i1), j1);
         }
      }
   ...
   class WorldTemplateSelectionList extends RealmsObjectSelectionList<RealmsSelectWorldTemplateScreen.WorldTemplateSelectionEntry> {
      ...
      public void selectItem(int pIndex) {
         ...
         if (pIndex != -1) {
            WorldTemplate worldtemplate = RealmsSelectWorldTemplateScreen.this.worldTemplateObjectSelectionList.get(pIndex);
            String s = I18n.get("narrator.select.list.position", pIndex + 1, RealmsSelectWorldTemplateScreen.this.worldTemplateObjectSelectionList.getItemCount());
      ...
      public void setSelected(@Nullable RealmsSelectWorldTemplateScreen.WorldTemplateSelectionEntry pEntry) {
