...
public class RealmsSelectFileToUploadScreen extends RealmsScreen {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      this.subtitleLabel.render(this, pMatrixStack);
      if (this.noWorldsLabel != null) {
         this.noWorldsLabel.render(this, pMatrixStack);
      }
   ...
   class WorldSelectionEntry extends ExtendedList.AbstractListEntry<RealmsSelectFileToUploadScreen.WorldSelectionEntry> {
      ...
      public void render(MatrixStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks) {
         this.renderItem(pMatrixStack, this.levelSummary, pIndex, pLeft, pTop);
      }
   ...
   class WorldSelectionList extends RealmsObjectSelectionList<RealmsSelectFileToUploadScreen.WorldSelectionEntry> {
      ...
      public void selectItem(int pIndex) {
         ...
         if (pIndex != -1) {
            WorldSummary worldsummary = RealmsSelectFileToUploadScreen.this.levelList.get(pIndex);
            String s = I18n.get("narrator.select.list.position", pIndex + 1, RealmsSelectFileToUploadScreen.this.levelList.size());
      ...
      public void setSelected(@Nullable RealmsSelectFileToUploadScreen.WorldSelectionEntry pEntry) {
