...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   class BackupObjectSelectionList extends RealmsObjectSelectionList<RealmsBackupScreen.BackupObjectSelectionListEntry> {
      ...
      public void selectItem(int pIndex) {
         ...
         if (pIndex != -1) {
            RealmsNarratorHelper.now(I18n.get("narrator.select", (RealmsBackupScreen.this.backups.get(pIndex)).lastModifiedDate.toString()));
         }
      ...
      public void setSelected(@Nullable RealmsBackupScreen.BackupObjectSelectionListEntry pEntry) {
