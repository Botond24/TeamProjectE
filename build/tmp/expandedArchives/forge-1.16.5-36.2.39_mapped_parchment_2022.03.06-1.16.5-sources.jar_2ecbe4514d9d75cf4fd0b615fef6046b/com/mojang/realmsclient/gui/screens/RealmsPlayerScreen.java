...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      if (this.serverData != null && this.serverData.players != null) {
         this.font.draw(pMatrixStack, (new StringTextComponent("")).append(INVITED_LABEL).append(" (").append(Integer.toString(this.serverData.players.size())).append(")"), (float)this.column1X, (float)row(0), 10526880);
      } else {
   ...
   class InvitedList extends RealmsObjectSelectionList<RealmsPlayerScreen.InvitedEntry> {
      ...
      public void selectItem(int pIndex) {
         ...
         if (pIndex != -1) {
            RealmsNarratorHelper.now(I18n.get("narrator.select", RealmsPlayerScreen.this.serverData.players.get(pIndex).getName()));
         }
      ...
      public void setSelected(@Nullable RealmsPlayerScreen.InvitedEntry pEntry) {
