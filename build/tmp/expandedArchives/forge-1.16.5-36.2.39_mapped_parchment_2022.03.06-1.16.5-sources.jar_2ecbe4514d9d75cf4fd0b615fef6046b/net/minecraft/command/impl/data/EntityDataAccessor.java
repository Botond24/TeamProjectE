...
public class EntityDataAccessor implements IDataAccessor {
   ...
   public static final Function<String, DataCommand.IDataProvider> PROVIDER = (p_218922_0_) -> {
      return new DataCommand.IDataProvider() {
         ...
         public IDataAccessor access(CommandContext<CommandSource> pContext) throws CommandSyntaxException {
            return new EntityDataAccessor(EntityArgument.getEntity(pContext, p_218922_0_));
         }
         ...
         public ArgumentBuilder<CommandSource, ?> wrap(ArgumentBuilder<CommandSource, ?> pBuilder, Function<ArgumentBuilder<CommandSource, ?>, ArgumentBuilder<CommandSource, ?>> pAction) {
            return pBuilder.then(Commands.literal("entity").then((ArgumentBuilder)pAction.apply(Commands.argument(p_218922_0_, EntityArgument.entity()))));
         }
      };
   };
   ...
   public void setData(CompoundNBT pOther) throws CommandSyntaxException {
   ...
   public ITextComponent getPrintSuccess(INBT pNbt) {
      return new TranslationTextComponent("commands.data.entity.query", this.entity.getDisplayName(), pNbt.getPrettyDisplay());
   }
   ...
   public ITextComponent getPrintSuccess(NBTPathArgument.NBTPath pPath, double pScale, int pValue) {
      return new TranslationTextComponent("commands.data.entity.get", pPath, this.entity.getDisplayName(), String.format(Locale.ROOT, "%.2f", pScale), pValue);
   }
}