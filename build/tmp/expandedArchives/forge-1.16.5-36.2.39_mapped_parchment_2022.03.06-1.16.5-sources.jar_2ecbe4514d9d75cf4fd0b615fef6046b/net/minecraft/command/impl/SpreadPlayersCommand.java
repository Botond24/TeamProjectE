...
public class SpreadPlayersCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> pDispatcher) {
      pDispatcher.register(Commands.literal("spreadplayers").requires((p_198721_0_) -> {
         ...
         return spreadPlayers(p_198718_0_.getSource(), Vec2Argument.getVec2(p_198718_0_, "center"), FloatArgumentType.getFloat(p_198718_0_, "spreadDistance"), FloatArgumentType.getFloat(p_198718_0_, "maxRange"), 256, BoolArgumentType.getBool(p_198718_0_, "respectTeams"), EntityArgument.getEntities(p_198718_0_, "targets"));
         ...
         return spreadPlayers(p_241069_0_.getSource(), Vec2Argument.getVec2(p_241069_0_, "center"), FloatArgumentType.getFloat(p_241069_0_, "spreadDistance"), FloatArgumentType.getFloat(p_241069_0_, "maxRange"), IntegerArgumentType.getInteger(p_241069_0_, "maxHeight"), BoolArgumentType.getBool(p_241069_0_, "respectTeams"), EntityArgument.getEntities(p_241069_0_, "targets"));
      })))))))));
   }

   private static int spreadPlayers(CommandSource p_241070_0_, Vector2f p_241070_1_, float p_241070_2_, float p_241070_3_, int p_241070_4_, boolean p_241070_5_, Collection<? extends Entity> p_241070_6_) throws CommandSyntaxException {
      ...
      SpreadPlayersCommand.Position[] aspreadplayerscommand$position = createInitialPositions(random, p_241070_5_ ? getNumberOfTeams(p_241070_6_) : p_241070_6_.size(), d0, d1, d2, d3);
      spreadPositions(p_241070_1_, (double)p_241070_2_, p_241070_0_.getLevel(), random, d0, d1, d2, d3, p_241070_4_, aspreadplayerscommand$position, p_241070_5_);
      double d4 = setPlayerPositions(p_241070_6_, p_241070_0_.getLevel(), aspreadplayerscommand$position, p_241070_4_, p_241070_5_);
      p_241070_0_.sendSuccess(new TranslationTextComponent("commands.spreadplayers.success." + (p_241070_5_ ? "teams" : "entities"), aspreadplayerscommand$position.length, p_241070_1_.x, p_241070_1_.y, String.format(Locale.ROOT, "%.2f", d4)), true);
   ...
   private static void spreadPositions(Vector2f p_241071_0_, double p_241071_1_, ServerWorld p_241071_3_, Random p_241071_4_, double p_241071_5_, double p_241071_7_, double p_241071_9_, double p_241071_11_, int p_241071_13_, SpreadPlayersCommand.Position[] p_241071_14_, boolean p_241071_15_) throws CommandSyntaxException {
      ...
      for(i = 0; i < 10000 && flag; ++i) {
         ...
         for(int j = 0; j < p_241071_14_.length; ++j) {
            ...
            if (k > 0) {
               ...
               if (d2 > 0.0D) {
                  ...
                  spreadplayerscommand$position.randomize(p_241071_4_, p_241071_5_, p_241071_7_, p_241071_9_, p_241071_11_);
               }

               flag = true;
            }

            if (spreadplayerscommand$position.clamp(p_241071_5_, p_241071_7_, p_241071_9_, p_241071_11_)) {
               flag = true;
            }
         }
         ...
         if (!flag) {
            for(SpreadPlayersCommand.Position spreadplayerscommand$position3 : p_241071_14_) {
               if (!spreadplayerscommand$position3.isSafe(p_241071_3_, p_241071_13_)) {
                  spreadplayerscommand$position3.randomize(p_241071_4_, p_241071_5_, p_241071_7_, p_241071_9_, p_241071_11_);
                  flag = true;
               }
            }
         }
      ...
      if (i >= 10000) {
         if (p_241071_15_) {
            throw ERROR_FAILED_TO_SPREAD_TEAMS.create(p_241071_14_.length, p_241071_0_.x, p_241071_0_.y, String.format(Locale.ROOT, "%.2f", d0));
         } else {
            throw ERROR_FAILED_TO_SPREAD_ENTITIES.create(p_241071_14_.length, p_241071_0_.x, p_241071_0_.y, String.format(Locale.ROOT, "%.2f", d0));
         }
      }
   }
   ...
   static class Position {
      ...
      public int getSpawnY(IBlockReader pLevel, int p_198710_2_) {
         BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable(this.x, (double)(p_198710_2_ + 1), this.z);
         boolean flag = pLevel.getBlockState(blockpos$mutable).isAir();
         blockpos$mutable.move(Direction.DOWN);

         boolean flag2;
         for(boolean flag1 = pLevel.getBlockState(blockpos$mutable).isAir(); blockpos$mutable.getY() > 0; flag1 = flag2) {
            blockpos$mutable.move(Direction.DOWN);
            flag2 = pLevel.getBlockState(blockpos$mutable).isAir();
            if (!flag2 && flag1 && flag) {
      ...
      public void randomize(Random pRandom, double pMinX, double pMinZ, double pMaxX, double pMaZx) {
         this.x = MathHelper.nextDouble(pRandom, pMinX, pMaxX);
         this.z = MathHelper.nextDouble(pRandom, pMinZ, pMaZx);
      }
   }
}
