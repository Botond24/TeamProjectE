...
public class Vec3Argument implements ArgumentType<ILocationArgument> {
   ...
   public static Vector3d getVec3(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      return pContext.getArgument(pName, ILocationArgument.class).getPosition(pContext.getSource());
   }

   public static ILocationArgument getCoordinates(CommandContext<CommandSource> pContext, String pName) {
      return pContext.getArgument(pName, ILocationArgument.class);
   }
