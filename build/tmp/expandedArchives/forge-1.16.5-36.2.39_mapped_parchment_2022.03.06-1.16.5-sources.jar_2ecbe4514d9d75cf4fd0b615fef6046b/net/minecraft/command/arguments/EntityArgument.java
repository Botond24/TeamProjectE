...
public class EntityArgument implements ArgumentType<EntitySelector> {
   ...
   public static Entity getEntity(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
   ...
   public static Collection<? extends Entity> getEntities(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
   ...
   public static Collection<? extends Entity> getOptionalEntities(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      return pContext.getArgument(pName, EntitySelector.class).findEntities(pContext.getSource());
   }

   public static Collection<ServerPlayerEntity> getOptionalPlayers(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
   ...
   public static ServerPlayerEntity getPlayer(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
   ...
   public static Collection<ServerPlayerEntity> getPlayers(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      List<ServerPlayerEntity> list = pContext.getArgument(pName, EntitySelector.class).findPlayers(pContext.getSource());
      if (list.isEmpty()) {
   ...
   public static class Serializer implements IArgumentSerializer<EntityArgument> {
      public void serializeToNetwork(EntityArgument pArgument, PacketBuffer pBuffer) {
         byte b0 = 0;
         if (pArgument.single) {
            b0 = (byte)(b0 | 1);
         }
      ...
      public EntityArgument deserializeFromNetwork(PacketBuffer pBuffer) {
