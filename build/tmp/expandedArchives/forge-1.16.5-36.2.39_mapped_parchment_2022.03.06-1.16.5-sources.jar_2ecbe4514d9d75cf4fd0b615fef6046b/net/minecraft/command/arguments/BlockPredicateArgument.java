...
public class BlockPredicateArgument implements ArgumentType<BlockPredicateArgument.IResult> {
   ...
   public static Predicate<CachedBlockInfo> getBlockPredicate(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      return pContext.getArgument(pName, BlockPredicateArgument.IResult.class).create(pContext.getSource().getServer().getTags());
   }
   ...
   static class BlockPredicate implements Predicate<CachedBlockInfo> {
      ...
      public BlockPredicate(BlockState pState, Set<Property<?>> pProperties, @Nullable CompoundNBT pNbt) {
         this.state = pState;
   ...
   static class TagPredicate implements Predicate<CachedBlockInfo> {
      ...
      private TagPredicate(ITag<Block> pTag, Map<String, String> pVagueProperties, @Nullable CompoundNBT pNbt) {
         this.tag = pTag;
