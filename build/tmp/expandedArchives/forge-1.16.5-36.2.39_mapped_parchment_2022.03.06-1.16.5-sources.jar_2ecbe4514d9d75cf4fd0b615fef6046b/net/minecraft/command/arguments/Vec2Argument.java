...
public class Vec2Argument implements ArgumentType<ILocationArgument> {
   ...
   public static Vector2f getVec2(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      Vector3d vector3d = pContext.getArgument(pName, ILocationArgument.class).getPosition(pContext.getSource());
