...
public class OperationArgument implements ArgumentType<OperationArgument.IOperation> {
   ...
   public static OperationArgument.IOperation getOperation(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      return pContext.getArgument(pName, OperationArgument.IOperation.class);
   }
    ...
    */
   private static OperationArgument.IOperation getOperation(String pName) throws CommandSyntaxException {
      return (pName.equals("><") ? (p_197175_0_, p_197175_1_) -> {
    ...
    */
   private static OperationArgument.IIntOperation getSimpleOperation(String pName) throws CommandSyntaxException {
      switch(pName) {
      case "=":
