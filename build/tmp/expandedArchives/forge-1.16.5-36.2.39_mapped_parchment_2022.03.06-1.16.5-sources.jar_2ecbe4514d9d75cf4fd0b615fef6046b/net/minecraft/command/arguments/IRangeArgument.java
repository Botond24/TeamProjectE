...
public interface IRangeArgument<T extends MinMaxBounds<?>> extends ArgumentType<T> {
   ...
   public static class IntRange implements IRangeArgument<MinMaxBounds.IntBound> {
      ...
      public static MinMaxBounds.IntBound getRange(CommandContext<CommandSource> pContext, String pName) {
         return pContext.getArgument(pName, MinMaxBounds.IntBound.class);
      }
