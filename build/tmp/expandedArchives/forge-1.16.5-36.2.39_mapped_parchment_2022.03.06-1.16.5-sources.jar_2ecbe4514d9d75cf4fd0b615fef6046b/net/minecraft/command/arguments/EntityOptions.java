...
public class EntityOptions {
   ...
   public static void register(String pId, EntityOptions.IFilter pHandler, Predicate<EntitySelectorParser> pPredicate, ITextComponent pTooltip) {
      OPTIONS.put(pId, new EntityOptions.OptionHandler(pHandler, pPredicate, pTooltip));
   }
   ...
   public static EntityOptions.IFilter get(EntitySelectorParser pParser, String pId, int pCursor) throws CommandSyntaxException {
      EntityOptions.OptionHandler entityoptions$optionhandler = OPTIONS.get(pId);
      if (entityoptions$optionhandler != null) {
         if (entityoptions$optionhandler.predicate.test(pParser)) {
   ...
   static class OptionHandler {
      ...
      private OptionHandler(EntityOptions.IFilter pModifier, Predicate<EntitySelectorParser> pPredicate, ITextComponent pDescription) {
