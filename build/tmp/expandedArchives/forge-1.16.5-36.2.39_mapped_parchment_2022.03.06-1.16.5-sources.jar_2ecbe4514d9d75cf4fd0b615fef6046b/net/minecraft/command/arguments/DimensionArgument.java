...
public class DimensionArgument implements ArgumentType<ResourceLocation> {
   ...
   public static ServerWorld getDimension(CommandContext<CommandSource> pContext, String pName) throws CommandSyntaxException {
      ...
      ServerWorld serverworld = pContext.getSource().getServer().getLevel(registrykey);
      if (serverworld == null) {
