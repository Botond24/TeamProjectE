...
public class CrashReport {
   ...
   public void getDetails(StringBuilder pBuilder) {
      ...
      if (this.uncategorizedStackTrace != null && this.uncategorizedStackTrace.length > 0) {
         ...
         pBuilder.append(net.minecraftforge.fml.CrashReportExtender.generateEnhancedStackTrace(this.uncategorizedStackTrace));
      }
      ...
      this.systemDetails.getDetails(pBuilder);
   }
   ...
   public CrashReportCategory addCategory(String pCategoryName, int pStacktraceLength) {
      CrashReportCategory crashreportcategory = new CrashReportCategory(this, pCategoryName);
