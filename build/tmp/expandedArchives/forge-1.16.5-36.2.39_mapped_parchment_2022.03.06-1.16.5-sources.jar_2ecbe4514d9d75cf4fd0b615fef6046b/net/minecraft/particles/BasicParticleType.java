...
public class BasicParticleType extends ParticleType<BasicParticleType> implements IParticleData {
   private static final IParticleData.IDeserializer<BasicParticleType> DESERIALIZER = new IParticleData.IDeserializer<BasicParticleType>() {
      public BasicParticleType fromCommand(ParticleType<BasicParticleType> pParticleType, StringReader pReader) throws CommandSyntaxException {
         return (BasicParticleType)pParticleType;
      }

      public BasicParticleType fromNetwork(ParticleType<BasicParticleType> pParticleType, PacketBuffer pBuffer) {
         return (BasicParticleType)pParticleType;
      }
   };
