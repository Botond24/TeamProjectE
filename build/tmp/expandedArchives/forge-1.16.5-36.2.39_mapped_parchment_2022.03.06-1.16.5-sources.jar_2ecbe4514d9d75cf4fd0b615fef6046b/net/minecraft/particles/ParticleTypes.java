...
public class ParticleTypes {
   ...
   private static BasicParticleType register(String pKey, boolean pAlwaysShow) {
      return Registry.register(Registry.PARTICLE_TYPE, pKey, new BasicParticleType(pAlwaysShow));
   }

   private static <T extends IParticleData> ParticleType<T> register(String pKey, IParticleData.IDeserializer<T> pDeserializer, final Function<ParticleType<T>, Codec<T>> p_218416_2_) {
