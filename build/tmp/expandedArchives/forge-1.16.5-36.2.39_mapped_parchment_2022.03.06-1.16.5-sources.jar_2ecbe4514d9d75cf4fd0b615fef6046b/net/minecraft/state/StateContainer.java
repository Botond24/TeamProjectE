...
public class StateContainer<O, S extends StateHolder<O, S>> {
   ...
   protected StateContainer(Function<O, S> p_i231877_1_, O pOwner, StateContainer.IFactory<O, S> p_i231877_3_, Map<String, Property<?>> pPropertiesByName) {
      this.owner = pOwner;
      this.propertiesByName = ImmutableSortedMap.copyOf(pPropertiesByName);
      Supplier<S> supplier = () -> {
         return p_i231877_1_.apply(pOwner);
      };
      ...
      stream.forEach((p_201000_5_) -> {
         ...
         S s1 = p_i231877_3_.create(pOwner, immutablemap, mapcodec1);
   ...
   public static class Builder<O, S extends StateHolder<O, S>> {
      ...
      public StateContainer.Builder<O, S> add(Property<?>... pProperties) {
