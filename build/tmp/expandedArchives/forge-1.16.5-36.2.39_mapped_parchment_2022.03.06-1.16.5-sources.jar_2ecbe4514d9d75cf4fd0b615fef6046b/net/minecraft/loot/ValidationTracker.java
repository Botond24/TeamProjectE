...
public class ValidationTracker {
   ...
   public ValidationTracker(LootParameterSet pParams, Function<ResourceLocation, ILootCondition> pConditionResolver, Function<ResourceLocation, LootTable> pTableResolver) {
      this(HashMultimap.create(), () -> {
         return "";
      }, pParams, pConditionResolver, ImmutableSet.of(), pTableResolver, ImmutableSet.of());
   }

   public ValidationTracker(Multimap<String, String> pProblems, Supplier<String> pContext, LootParameterSet pParams, Function<ResourceLocation, ILootCondition> pConditionResolver, Set<ResourceLocation> pVisitedConditions, Function<ResourceLocation, LootTable> pTableResolver, Set<ResourceLocation> pVisitedTables) {
    ...
    */
   public ValidationTracker forChild(String pChildName) {
    ...
    */
   public ValidationTracker enterTable(String pContextName, ResourceLocation pLootTableId) {
    ...
    */
   public ValidationTracker enterCondition(String pContextName, ResourceLocation pConditionId) {
    ...
    */
   public void validateUser(IParameterized pLootContextUser) {
   ...
   @Nullable
   public ILootCondition resolveCondition(ResourceLocation pConditionId) {
    ...
    */
   public ValidationTracker setParams(LootParameterSet pParams) {
      return new ValidationTracker(this.problems, this.context, pParams, this.conditionResolver, this.visitedConditions, this.tableResolver, this.visitedTables);
   }
}