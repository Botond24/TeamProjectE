...
public class LootTypesManager {
   public static <E, T extends LootType<E>> LootTypesManager.LootTypeRegistryWrapper<E, T> builder(Registry<T> pRegistry, String pId, String pName, Function<E, T> pTypeFunction) {
      return new LootTypesManager.LootTypeRegistryWrapper<>(pRegistry, pId, pName, pTypeFunction);
   }
   ...
   public static class LootTypeRegistryWrapper<E, T extends LootType<E>> {
      ...
      private LootTypeRegistryWrapper(Registry<T> pRegistry, String pElementName, String pTypeKey, Function<E, T> pTypeGetter) {
