...
public class LongArrayNBT extends CollectionNBT<LongNBT> {
   ...
   public LongArrayNBT(long[] pData) {
      this.data = pData;
   }

   public LongArrayNBT(LongSet pDataSet) {
      this.data = pDataSet.toLongArray();
   }

   public LongArrayNBT(List<Long> pDataList) {
   ...
   public boolean setTag(int pIndex, INBT pTag) {
      if (pTag instanceof NumberNBT) {
         this.data[pIndex] = ((NumberNBT)pTag).getAsLong();
         return true;
      } else {
         return false;
      }
   ...
   public boolean addTag(int pIndex, INBT pTag) {
      if (pTag instanceof NumberNBT) {
         this.data = ArrayUtils.add(this.data, pIndex, ((NumberNBT)pTag).getAsLong());
         return true;
      } else {
         return false;
      }
