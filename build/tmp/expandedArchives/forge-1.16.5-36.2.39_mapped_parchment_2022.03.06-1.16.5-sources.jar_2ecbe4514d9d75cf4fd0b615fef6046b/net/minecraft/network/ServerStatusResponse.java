...
public class ServerStatusResponse {
   ...
   public void setDescription(ITextComponent pDescription) {
   ...
   public void setPlayers(ServerStatusResponse.Players pPlayers) {
   ...
   public void setVersion(ServerStatusResponse.Version pVersion) {
