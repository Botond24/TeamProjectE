...
public enum ProtocolType {
   ...
   private ProtocolType(int pId, ProtocolType.PacketRegistry pProtocolBuilder) {
      this.id = pId;
    ...
    */
   @Nullable
   public Integer getPacketId(PacketDirection pDirection, IPacket<?> pPacket) {
    ...
    */
   @Nullable
   public static ProtocolType getById(int pStateId) {
    ...
    */
   public static ProtocolType getProtocolForPacket(IPacket<?> pPacket) {
   ...
   static class PacketRegistry {
      ...
      public <T extends INetHandler> ProtocolType.PacketRegistry addFlow(PacketDirection pPacketFlow, ProtocolType.PacketList<T> pPacketSet) {
