...
public class NetworkSystem {
   ...
   public void startTcpServerListener(@Nullable InetAddress pAddress, int pPort) throws IOException {
      if (pAddress instanceof java.net.Inet6Address) System.setProperty("java.net.preferIPv4Stack", "false");
      synchronized(this.channels) {
         ...
         }).group(lazyvalue.get()).localAddress(pAddress, pPort).bind().syncUninterruptibly());
      }
   }
