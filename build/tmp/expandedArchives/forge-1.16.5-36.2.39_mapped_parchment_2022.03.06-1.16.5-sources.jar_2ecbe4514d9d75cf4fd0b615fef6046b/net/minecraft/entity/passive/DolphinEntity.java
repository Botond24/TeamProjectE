...
public class DolphinEntity extends WaterMobEntity {
   ...
   public static boolean checkDolphinSpawnRules(EntityType<DolphinEntity> pDolphin, IWorld pLevel, SpawnReason pSpawnType, BlockPos pPos, Random pRandom) {
      if (pPos.getY() > 45 && pPos.getY() < pLevel.getSeaLevel()) {
         Optional<RegistryKey<Biome>> optional = pLevel.getBiomeName(pPos);
         return (!Objects.equals(optional, Optional.of(Biomes.OCEAN)) || !Objects.equals(optional, Optional.of(Biomes.DEEP_OCEAN))) && pLevel.getFluidState(pPos).is(FluidTags.WATER);
      } else {
         return false;
      }
   }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public MoveHelperController(DolphinEntity pDolphin) {
         super(pDolphin);
   ...
   class PlayWithItemsGoal extends Goal {
      ...
      private void drop(ItemStack pStack) {
         if (!pStack.isEmpty()) {
            ...
            ItemEntity itementity = new ItemEntity(DolphinEntity.this.level, DolphinEntity.this.getX(), d0, DolphinEntity.this.getZ(), pStack);
   ...
   static class SwimToTreasureGoal extends Goal {
      ...
      SwimToTreasureGoal(DolphinEntity pDolphin) {
         this.dolphin = pDolphin;
   ...
   static class SwimWithPlayerGoal extends Goal {
      ...
      SwimWithPlayerGoal(DolphinEntity pDolphin, double pSpeedModifier) {
         this.dolphin = pDolphin;
