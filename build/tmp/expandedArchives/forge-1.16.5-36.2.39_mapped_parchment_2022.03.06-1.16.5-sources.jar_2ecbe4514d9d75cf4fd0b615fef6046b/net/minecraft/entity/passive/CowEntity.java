...
public class CowEntity extends AnimalEntity {
   ...
   public ActionResultType mobInteract(PlayerEntity pPlayer, Hand pHand) {
      ...
      if (itemstack.getItem() == Items.BUCKET && !this.isBaby()) {
         ...
         ItemStack itemstack1 = DrinkHelper.createFilledResult(itemstack, pPlayer, Items.MILK_BUCKET.getDefaultInstance());
   ...
   public CowEntity getBreedOffspring(ServerWorld pServerLevel, AgeableEntity pMate) {
      return EntityType.COW.create(pServerLevel);
   }
