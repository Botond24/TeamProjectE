...
public abstract class AnimalEntity extends AgeableEntity {
    ...
    */
   public static boolean checkAnimalSpawnRules(EntityType<? extends AnimalEntity> pAnimal, IWorld pLevel, SpawnReason pSpawnType, BlockPos pPos, Random pRandom) {
   ...
   public void spawnChildFromBreeding(ServerWorld pLevel, AnimalEntity pMate) {
      AgeableEntity ageableentity = this.getBreedOffspring(pLevel, pMate);
      final net.minecraftforge.event.entity.living.BabyEntitySpawnEvent event = new net.minecraftforge.event.entity.living.BabyEntitySpawnEvent(this, pMate, ageableentity);
      ...
      if (ageableentity != null) {
         ...
         if (serverplayerentity == null && pMate.getLoveCause() != null) {
            serverplayerentity = pMate.getLoveCause();
         }

         if (serverplayerentity != null) {
            serverplayerentity.awardStat(Stats.ANIMALS_BRED);
            CriteriaTriggers.BRED_ANIMALS.trigger(serverplayerentity, this, pMate, ageableentity);
         }
