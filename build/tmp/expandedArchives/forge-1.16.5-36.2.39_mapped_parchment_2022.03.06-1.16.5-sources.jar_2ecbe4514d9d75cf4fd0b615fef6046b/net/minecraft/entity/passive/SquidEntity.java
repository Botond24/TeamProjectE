...
public class SquidEntity extends WaterMobEntity {
   ...
   private Vector3d rotateVector(Vector3d pVector) {
      Vector3d vector3d = pVector.xRot(this.xBodyRotO * ((float)Math.PI / 180F));
   ...
   public static boolean checkSquidSpawnRules(EntityType<SquidEntity> pSquid, IWorld pLevel, SpawnReason pSpawnType, BlockPos pPos, Random pRandom) {
      return pPos.getY() > 45 && pPos.getY() < pLevel.getSeaLevel();
   }
   ...
   class MoveRandomGoal extends Goal {
      ...
      public MoveRandomGoal(SquidEntity pSquid) {
         this.squid = pSquid;
      }
