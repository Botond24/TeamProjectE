...
public class MultiTask<E extends LivingEntity> extends Task<E> {
   ...
   protected boolean canStillUse(ServerWorld pLevel, E pEntity, long pGameTime) {
      return this.behaviors.stream().filter((p_220414_0_) -> {
         ...
         return p_220413_4_.canStillUse(pLevel, pEntity, pGameTime);
      });
   }
   ...
   protected void start(ServerWorld pLevel, E pEntity, long pGameTime) {
      ...
      this.runningPolicy.apply(this.behaviors, pLevel, pEntity, pGameTime);
   }
   ...
   protected void tick(ServerWorld pLevel, E pOwner, long pGameTime) {
      this.behaviors.stream().filter((p_220408_0_) -> {
         ...
         p_220409_4_.tickOrStop(pLevel, pOwner, pGameTime);
      });
   }
   ...
   protected void stop(ServerWorld pLevel, E pEntity, long pGameTime) {
      this.behaviors.stream().filter((p_220407_0_) -> {
         ...
         p_220412_4_.doStop(pLevel, pEntity, pGameTime);
      });
