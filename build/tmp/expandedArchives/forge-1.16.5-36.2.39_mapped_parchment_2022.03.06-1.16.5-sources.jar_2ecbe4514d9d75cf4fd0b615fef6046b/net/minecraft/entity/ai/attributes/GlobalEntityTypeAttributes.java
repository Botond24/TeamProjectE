...
public class GlobalEntityTypeAttributes {
   ...
   public static AttributeModifierMap getSupplier(EntityType<? extends LivingEntity> pLivingEntity) {
      AttributeModifierMap map = FORGE_ATTRIBUTES.get(pLivingEntity);
      return map != null ? map : SUPPLIERS.get(pLivingEntity);
   }

   public static boolean hasSupplier(EntityType<?> pEntityType) {
      return SUPPLIERS.containsKey(pEntityType) || FORGE_ATTRIBUTES.containsKey(pEntityType);
   }
