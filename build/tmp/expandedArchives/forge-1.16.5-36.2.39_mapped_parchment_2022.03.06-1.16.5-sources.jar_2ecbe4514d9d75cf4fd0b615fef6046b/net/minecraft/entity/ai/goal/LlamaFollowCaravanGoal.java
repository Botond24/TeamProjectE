...
public class LlamaFollowCaravanGoal extends Goal {
   ...
   private boolean firstIsLeashed(LlamaEntity pLlama, int pLeashedQueuePosition) {
      if (pLeashedQueuePosition > 8) {
         ...
         if (pLlama.getCaravanHead().isLeashed()) {
            ...
            LlamaEntity llamaentity = pLlama.getCaravanHead();
            ++pLeashedQueuePosition;
            return this.firstIsLeashed(llamaentity, pLeashedQueuePosition);
         }
      } else {
         return false;
      }
