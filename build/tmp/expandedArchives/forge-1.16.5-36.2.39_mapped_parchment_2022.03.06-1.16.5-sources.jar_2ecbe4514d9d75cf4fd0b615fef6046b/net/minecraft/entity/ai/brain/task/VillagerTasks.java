...
public class VillagerTasks {
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getCorePackage(VillagerProfession pProfession, float p_220638_1_) {
      return ImmutableList.of(Pair.of(0, new SwimTask(0.8F)), Pair.of(0, new InteractWithDoorTask()), Pair.of(0, new LookTask(45, 90)), Pair.of(0, new PanicTask()), Pair.of(0, new WakeUpTask()), Pair.of(0, new HideFromRaidOnBellRingTask()), Pair.of(0, new BeginRaidTask()), Pair.of(0, new ExpirePOITask(pProfession.getJobPoiType(), MemoryModuleType.JOB_SITE)), Pair.of(0, new ExpirePOITask(pProfession.getJobPoiType(), MemoryModuleType.POTENTIAL_JOB_SITE)), Pair.of(1, new WalkToTargetTask()), Pair.of(2, new SwitchVillagerJobTask(pProfession)), Pair.of(3, new TradeTask(p_220638_1_)), Pair.of(5, new PickupWantedItemTask(p_220638_1_, false, 4)), Pair.of(6, new GatherPOITask(pProfession.getJobPoiType(), MemoryModuleType.JOB_SITE, MemoryModuleType.POTENTIAL_JOB_SITE, true, Optional.empty())), Pair.of(7, new FindPotentialJobTask(p_220638_1_)), Pair.of(8, new FindJobTask(p_220638_1_)), Pair.of(10, new GatherPOITask(PointOfInterestType.HOME, MemoryModuleType.HOME, false, Optional.of((byte)14))), Pair.of(10, new GatherPOITask(PointOfInterestType.MEETING, MemoryModuleType.MEETING_POINT, true, Optional.of((byte)14))), Pair.of(10, new AssignProfessionTask()), Pair.of(10, new ChangeJobTask()));
   }

   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getWorkPackage(VillagerProfession pProfession, float p_220639_1_) {
      ...
      return ImmutableList.of(getMinimalLookBehavior(), Pair.of(5, new FirstShuffledTask<>(ImmutableList.of(Pair.of(spawngolemtask, 7), Pair.of(new WorkTask(MemoryModuleType.JOB_SITE, 0.4F, 4), 2), Pair.of(new WalkTowardsPosTask(MemoryModuleType.JOB_SITE, 0.4F, 1, 10), 5), Pair.of(new WalkTowardsRandomSecondaryPosTask(MemoryModuleType.SECONDARY_JOB_SITE, p_220639_1_, 1, 6, MemoryModuleType.JOB_SITE), 5), Pair.of(new FarmTask(), pProfession == VillagerProfession.FARMER ? 2 : 5), Pair.of(new BoneMealCropsTask(), pProfession == VillagerProfession.FARMER ? 4 : 7)))), Pair.of(10, new ShowWaresTask(400, 1600)), Pair.of(10, new FindInteractionAndLookTargetTask(EntityType.PLAYER, 4)), Pair.of(2, new StayNearPointTask(MemoryModuleType.JOB_SITE, p_220639_1_, 9, 100, 1200)), Pair.of(3, new GiveHeroGiftsTask(100)), Pair.of(99, new UpdateActivityTask()));
   }

   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getPlayPackage(float pWalkingSpeed) {
      return ImmutableList.of(Pair.of(0, new WalkToTargetTask(80, 120)), getFullLookBehavior(), Pair.of(5, new WalkToVillagerBabiesTask()), Pair.of(5, new FirstShuffledTask<>(ImmutableMap.of(MemoryModuleType.VISIBLE_VILLAGER_BABIES, MemoryModuleStatus.VALUE_ABSENT), ImmutableList.of(Pair.of(InteractWithEntityTask.of(EntityType.VILLAGER, 8, MemoryModuleType.INTERACTION_TARGET, pWalkingSpeed, 2), 2), Pair.of(InteractWithEntityTask.of(EntityType.CAT, 8, MemoryModuleType.INTERACTION_TARGET, pWalkingSpeed, 2), 1), Pair.of(new FindWalkTargetTask(pWalkingSpeed), 1), Pair.of(new WalkTowardsLookTargetTask(pWalkingSpeed, 2), 1), Pair.of(new JumpOnBedTask(pWalkingSpeed), 2), Pair.of(new DummyTask(20, 40), 2)))), Pair.of(99, new UpdateActivityTask()));
   }

   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getRestPackage(VillagerProfession pProfession, float pWalkingSpeed) {
      return ImmutableList.of(Pair.of(2, new StayNearPointTask(MemoryModuleType.HOME, pWalkingSpeed, 1, 150, 1200)), Pair.of(3, new ExpirePOITask(PointOfInterestType.HOME, MemoryModuleType.HOME)), Pair.of(3, new SleepAtHomeTask()), Pair.of(5, new FirstShuffledTask<>(ImmutableMap.of(MemoryModuleType.HOME, MemoryModuleStatus.VALUE_ABSENT), ImmutableList.of(Pair.of(new WalkToHouseTask(pWalkingSpeed), 1), Pair.of(new WalkRandomlyInsideTask(pWalkingSpeed), 4), Pair.of(new WalkToPOITask(pWalkingSpeed, 4), 2), Pair.of(new DummyTask(20, 40), 2)))), getMinimalLookBehavior(), Pair.of(99, new UpdateActivityTask()));
   }

   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getMeetPackage(VillagerProfession pProfession, float p_220637_1_) {
   ...
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getIdlePackage(VillagerProfession pProfession, float p_220641_1_) {
   ...
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getPanicPackage(VillagerProfession pProfession, float p_220636_1_) {
   ...
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getPreRaidPackage(VillagerProfession pProfession, float p_220642_1_) {
   ...
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getRaidPackage(VillagerProfession pProfession, float p_220640_1_) {
   ...
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getHidePackage(VillagerProfession pProfession, float p_220644_1_) {
      int i = 2;
