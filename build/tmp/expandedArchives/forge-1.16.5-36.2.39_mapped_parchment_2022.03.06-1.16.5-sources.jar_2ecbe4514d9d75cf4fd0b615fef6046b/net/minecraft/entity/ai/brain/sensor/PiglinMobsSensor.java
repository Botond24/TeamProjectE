...
public class PiglinMobsSensor extends Sensor<LivingEntity> {
   ...
   private static Optional<BlockPos> findNearestRepellent(ServerWorld pLevel, LivingEntity pLivingEntity) {
      return BlockPos.findClosestMatch(pLivingEntity.blockPosition(), 8, 4, (p_234125_1_) -> {
         return isValidRepellent(pLevel, p_234125_1_);
      });
   }

   private static boolean isValidRepellent(ServerWorld pLevel, BlockPos pPos) {
