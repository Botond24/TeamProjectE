...
public class Memory<T> {
   ...
   public static <T> Memory<T> of(T pValue) {
      return new Memory<>(pValue, Long.MAX_VALUE);
   }

   public static <T> Memory<T> of(T pValue, long pTimeToLive) {
      return new Memory<>(pValue, pTimeToLive);
   }
   ...
   public static <T> Codec<Memory<T>> codec(Codec<T> pValueCodec) {
      return RecordCodecBuilder.create((p_234067_1_) -> {
         return p_234067_1_.group(pValueCodec.fieldOf("value").forGetter((p_234071_0_) -> {
