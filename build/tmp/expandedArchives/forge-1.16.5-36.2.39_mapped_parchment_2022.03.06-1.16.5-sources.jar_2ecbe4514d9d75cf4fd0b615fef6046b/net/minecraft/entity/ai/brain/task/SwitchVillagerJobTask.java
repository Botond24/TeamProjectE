...
public class SwitchVillagerJobTask extends Task<VillagerEntity> {
   ...
   protected void start(ServerWorld pLevel, VillagerEntity pEntity, long pGameTime) {
      ...
      pLevel.getPoiManager().getType(globalpos.pos()).ifPresent((p_233933_3_) -> {
         BrainUtil.getNearbyVillagersWithCondition(pEntity, (p_233935_3_) -> {
            return this.competesForSameJobsite(globalpos, p_233933_3_, p_233935_3_);
         }).reduce(pEntity, SwitchVillagerJobTask::selectWinner);
      });
   }
