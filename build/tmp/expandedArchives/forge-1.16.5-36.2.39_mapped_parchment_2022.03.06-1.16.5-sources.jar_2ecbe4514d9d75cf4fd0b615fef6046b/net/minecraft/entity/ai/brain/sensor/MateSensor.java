...
public class MateSensor extends Sensor<AgeableEntity> {
   ...
   protected void doTick(ServerWorld pLevel, AgeableEntity pEntity) {
      pEntity.getBrain().getMemory(MemoryModuleType.VISIBLE_LIVING_ENTITIES).ifPresent((p_234118_2_) -> {
         this.setNearestVisibleAdult(pEntity, p_234118_2_);
      });
   }
