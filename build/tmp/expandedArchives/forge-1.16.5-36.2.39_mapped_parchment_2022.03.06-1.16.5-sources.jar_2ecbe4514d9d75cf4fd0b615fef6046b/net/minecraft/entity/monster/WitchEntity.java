...
public class WitchEntity extends AbstractRaiderEntity implements IRangedAttackMob {
   ...
   protected float getDamageAfterMagicAbsorb(DamageSource pDamageSource, float pDamageAmount) {
      pDamageAmount = super.getDamageAfterMagicAbsorb(pDamageSource, pDamageAmount);
      if (pDamageSource.getEntity() == this) {
         pDamageAmount = 0.0F;
      }

      if (pDamageSource.isMagic()) {
         pDamageAmount = (float)((double)pDamageAmount * 0.15D);
      }
