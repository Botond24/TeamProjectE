...
public class ZombifiedPiglinEntity extends ZombieEntity implements IAngerable {
   ...
   public void setTarget(@Nullable LivingEntity pLivingEntity) {
      ...
      if (pLivingEntity instanceof PlayerEntity) {
         this.setLastHurtByPlayer((PlayerEntity)pLivingEntity);
      }
   ...
   public static boolean checkZombifiedPiglinSpawnRules(EntityType<ZombifiedPiglinEntity> pZombifiedPiglin, IWorld pLevel, SpawnReason pSpawnType, BlockPos pPos, Random pRandom) {
      return pLevel.getDifficulty() != Difficulty.PEACEFUL && pLevel.getBlockState(pPos.below()).getBlock() != Blocks.NETHER_WART_BLOCK;
   }
