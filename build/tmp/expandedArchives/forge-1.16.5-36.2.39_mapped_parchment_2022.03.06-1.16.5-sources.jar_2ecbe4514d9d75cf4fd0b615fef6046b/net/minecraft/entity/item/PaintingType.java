...
public class PaintingType extends net.minecraftforge.registries.ForgeRegistryEntry<PaintingType> {
   ...
   private static PaintingType register(String pKey, int pWidth, int pHeight) {
      return Registry.register(Registry.MOTIVE, pKey, new PaintingType(pWidth, pHeight));
   }

   public PaintingType(int pWidth, int pHeight) {
      this.width = pWidth;
      this.height = pHeight;
   }
