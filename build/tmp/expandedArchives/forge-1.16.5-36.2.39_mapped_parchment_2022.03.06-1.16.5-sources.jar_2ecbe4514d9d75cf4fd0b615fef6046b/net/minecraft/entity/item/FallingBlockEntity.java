...
public class FallingBlockEntity extends Entity {
   ...
   public FallingBlockEntity(World pLevel, double pX, double pY, double pZ, BlockState pState) {
   ...
   protected void addAdditionalSaveData(CompoundNBT pCompound) {
      pCompound.put("BlockState", NBTUtil.writeBlockState(this.blockState));
      ...
      pCompound.putFloat("FallHurtAmount", this.fallDamageAmount);
   ...
   protected void readAdditionalSaveData(CompoundNBT pCompound) {
      this.blockState = NBTUtil.readBlockState(pCompound.getCompound("BlockState"));
      this.time = pCompound.getInt("Time");
      if (pCompound.contains("HurtEntities", 99)) {
         this.hurtEntities = pCompound.getBoolean("HurtEntities");
         this.fallDamageAmount = pCompound.getFloat("FallHurtAmount");
