...
public abstract class HangingEntity extends Entity {
   ...
   protected HangingEntity(EntityType<? extends HangingEntity> pEntityType, World pLevel, BlockPos pPos) {
   ...
   public void move(MoverType pType, Vector3d pPos) {
      if (!this.level.isClientSide && !this.removed && pPos.lengthSqr() > 0.0D) {
         this.remove();
         this.dropItem((Entity)null);
      }
   ...
   public void push(double pX, double pY, double pZ) {
      if (!this.level.isClientSide && !this.removed && pX * pX + pY * pY + pZ * pZ > 0.0D) {
         this.remove();
         this.dropItem((Entity)null);
      }
