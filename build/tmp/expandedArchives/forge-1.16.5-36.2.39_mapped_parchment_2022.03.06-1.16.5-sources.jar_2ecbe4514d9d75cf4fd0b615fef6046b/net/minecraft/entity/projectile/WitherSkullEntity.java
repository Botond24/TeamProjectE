...
public class WitherSkullEntity extends DamagingProjectileEntity {
   ...
   public WitherSkullEntity(World pLevel, LivingEntity pShooter, double pOffsetX, double pOffsetY, double pOffsetZ) {
      super(EntityType.WITHER_SKULL, pShooter, pOffsetX, pOffsetY, pOffsetZ, pLevel);
   }

   @OnlyIn(Dist.CLIENT)
   public WitherSkullEntity(World pLevel, double pX, double pY, double pZ, double pOffsetX, double pOffsetY, double pOffsetZ) {
      super(EntityType.WITHER_SKULL, pX, pY, pZ, pOffsetX, pOffsetY, pOffsetZ, pLevel);
   }
