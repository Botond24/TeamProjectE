...
public abstract class ThrowableEntity extends ProjectileEntity {
   ...
   protected ThrowableEntity(EntityType<? extends ThrowableEntity> pEntityType, double pX, double pY, double pZ, World pLevel) {
      this(pEntityType, pLevel);
      this.setPos(pX, pY, pZ);
   }

   protected ThrowableEntity(EntityType<? extends ThrowableEntity> pEntityType, LivingEntity pShooter, World pLevel) {
