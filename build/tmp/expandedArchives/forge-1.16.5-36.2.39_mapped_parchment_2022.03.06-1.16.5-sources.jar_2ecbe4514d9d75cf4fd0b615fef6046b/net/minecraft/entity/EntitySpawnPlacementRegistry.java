...
public class EntitySpawnPlacementRegistry {
   ...
   public static <T extends MobEntity> void register(EntityType<T> pEntityType, EntitySpawnPlacementRegistry.PlacementType pDecoratorType, Heightmap.Type pHeightMapType, EntitySpawnPlacementRegistry.IPlacementPredicate<T> pDecoratorPredicate) {
      EntitySpawnPlacementRegistry.Entry entityspawnplacementregistry$entry = DATA_BY_TYPE.put(pEntityType, new EntitySpawnPlacementRegistry.Entry(pHeightMapType, pDecoratorType, pDecoratorPredicate));
   ...
   public static EntitySpawnPlacementRegistry.PlacementType getPlacementType(EntityType<?> pEntityType) {
      EntitySpawnPlacementRegistry.Entry entityspawnplacementregistry$entry = DATA_BY_TYPE.get(pEntityType);
   ...
   public static Heightmap.Type getHeightmapType(@Nullable EntityType<?> pEntityType) {
      EntitySpawnPlacementRegistry.Entry entityspawnplacementregistry$entry = DATA_BY_TYPE.get(pEntityType);
   ...
   public static <T extends Entity> boolean checkSpawnRules(EntityType<T> pEntityType, IServerWorld pServerLevel, SpawnReason pSpawnType, BlockPos pPos, Random pRandom) {
      EntitySpawnPlacementRegistry.Entry entityspawnplacementregistry$entry = DATA_BY_TYPE.get(pEntityType);
      return entityspawnplacementregistry$entry == null || entityspawnplacementregistry$entry.predicate.test((EntityType)pEntityType, pServerLevel, pSpawnType, pPos, pRandom);
   }
   ...
   static class Entry {
      ...
      public Entry(Heightmap.Type pHeightMap, EntitySpawnPlacementRegistry.PlacementType pPlacement, EntitySpawnPlacementRegistry.IPlacementPredicate<?> pPredicate) {
