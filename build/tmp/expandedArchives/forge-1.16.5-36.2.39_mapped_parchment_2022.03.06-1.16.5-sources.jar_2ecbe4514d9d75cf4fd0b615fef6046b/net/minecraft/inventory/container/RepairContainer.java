...
public class RepairContainer extends AbstractRepairContainer {
   ...
   public RepairContainer(int pContainerId, PlayerInventory pPlayerInventory) {
      this(pContainerId, pPlayerInventory, IWorldPosCallable.NULL);
   }

   public RepairContainer(int pContainerId, PlayerInventory pPlayerInventory, IWorldPosCallable pAccess) {
      super(ContainerType.ANVIL, pContainerId, pPlayerInventory, pAccess);
   ...
   protected boolean mayPickup(PlayerEntity pPlayer, boolean pHasStack) {
      return (pPlayer.abilities.instabuild || pPlayer.experienceLevel >= this.cost.get()) && this.cost.get() > 0;
   }
   ...
   protected ItemStack onTake(PlayerEntity pPlayer, ItemStack pInputItem) {
      ...
      float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(pPlayer, pInputItem, RepairContainer.this.inputSlots.getItem(0), RepairContainer.this.inputSlots.getItem(1));
      ...
      this.access.execute((p_234633_1_, p_234633_2_) -> {
         ...
         if (!pPlayer.abilities.instabuild && blockstate.is(BlockTags.ANVIL) && pPlayer.getRandom().nextFloat() < breakChance) {
