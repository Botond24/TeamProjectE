...
public class SmithingTableContainer extends AbstractRepairContainer {
   ...
   public SmithingTableContainer(int pContainerId, PlayerInventory pPlayerInventory) {
      this(pContainerId, pPlayerInventory, IWorldPosCallable.NULL);
   }

   public SmithingTableContainer(int pContainerId, PlayerInventory pPlayerInventory, IWorldPosCallable pAccess) {
      super(ContainerType.SMITHING, pContainerId, pPlayerInventory, pAccess);
