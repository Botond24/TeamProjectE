...
public class Advancement {
   ...
   public Advancement(ResourceLocation pId, @Nullable Advancement pParent, @Nullable DisplayInfo pDisplay, AdvancementRewards pRewards, Map<String, Criterion> pCriteria, String[][] pRequirements) {
      ...
      if (pDisplay == null) {
         this.chatComponent = new StringTextComponent(pId.toString());
      } else {
         ITextComponent itextcomponent = pDisplay.getTitle();
         TextFormatting textformatting = pDisplay.getFrame().getChatColor();
   ...
   public static class Builder implements net.minecraftforge.common.extensions.IForgeAdvancementBuilder {
      ...
      private Builder(@Nullable ResourceLocation pParentId, @Nullable DisplayInfo pDisplay, AdvancementRewards pRewards, Map<String, Criterion> pCriteria, String[][] pRequirements) {
