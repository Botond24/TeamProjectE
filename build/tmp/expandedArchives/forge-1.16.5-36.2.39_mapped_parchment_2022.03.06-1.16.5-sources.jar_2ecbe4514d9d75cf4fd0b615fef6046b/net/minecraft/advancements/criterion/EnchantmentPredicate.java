...
public class EnchantmentPredicate {
   ...
   public EnchantmentPredicate(@Nullable Enchantment pEnchantment, MinMaxBounds.IntBound pLevel) {
   ...
   public static EnchantmentPredicate fromJson(@Nullable JsonElement pElement) {
      if (pElement != null && !pElement.isJsonNull()) {
         JsonObject jsonobject = JSONUtils.convertToJsonObject(pElement, "enchantment");
   ...
   public static EnchantmentPredicate[] fromJsonArray(@Nullable JsonElement pElement) {
      if (pElement != null && !pElement.isJsonNull()) {
         JsonArray jsonarray = JSONUtils.convertToJsonArray(pElement, "enchantments");
