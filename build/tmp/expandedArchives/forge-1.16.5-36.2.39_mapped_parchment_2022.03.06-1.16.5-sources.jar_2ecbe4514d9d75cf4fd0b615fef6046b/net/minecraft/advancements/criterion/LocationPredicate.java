...
public class LocationPredicate {
   ...
   public static LocationPredicate inBiome(RegistryKey<Biome> pBiome) {
      return new LocationPredicate(MinMaxBounds.FloatBound.ANY, MinMaxBounds.FloatBound.ANY, MinMaxBounds.FloatBound.ANY, pBiome, (Structure<?>)null, (RegistryKey<World>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
   }

   public static LocationPredicate inDimension(RegistryKey<World> pDimension) {
      return new LocationPredicate(MinMaxBounds.FloatBound.ANY, MinMaxBounds.FloatBound.ANY, MinMaxBounds.FloatBound.ANY, (RegistryKey<Biome>)null, (Structure<?>)null, pDimension, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
   }

   public static LocationPredicate inFeature(Structure<?> pFeature) {
      return new LocationPredicate(MinMaxBounds.FloatBound.ANY, MinMaxBounds.FloatBound.ANY, MinMaxBounds.FloatBound.ANY, (RegistryKey<Biome>)null, pFeature, (RegistryKey<World>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
   }

   public boolean matches(ServerWorld pLevel, double pX, double pY, double pZ) {
      return this.matches(pLevel, (float)pX, (float)pY, (float)pZ);
   }
   ...
   public static LocationPredicate fromJson(@Nullable JsonElement pElement) {
      if (pElement != null && !pElement.isJsonNull()) {
         JsonObject jsonobject = JSONUtils.convertToJsonObject(pElement, "location");
   ...
   public static class Builder {
      ...
      public LocationPredicate.Builder setBiome(@Nullable RegistryKey<Biome> pBiome) {
         this.biome = pBiome;
         return this;
      }
