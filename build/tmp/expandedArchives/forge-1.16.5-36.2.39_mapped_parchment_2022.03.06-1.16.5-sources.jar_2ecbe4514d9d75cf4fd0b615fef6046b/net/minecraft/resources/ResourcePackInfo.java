...
public class ResourcePackInfo implements AutoCloseable {
   ...
   @Nullable
   public static ResourcePackInfo create(String pName, boolean p_195793_1_, Supplier<IResourcePack> p_195793_2_, ResourcePackInfo.IFactory pFactory, ResourcePackInfo.Priority p_195793_4_, IPackNameDecorator p_195793_5_) {
      try (IResourcePack iresourcepack = p_195793_2_.get()) {
         ...
         if (packmetadatasection != null) {
            return pFactory.create(pName, p_195793_1_, p_195793_2_, iresourcepack, packmetadatasection, p_195793_4_, p_195793_5_);
         }
