...
public class AsyncReloader<S> implements IAsyncReloader {
   ...
   public static AsyncReloader<Void> of(IResourceManager pResourceManager, List<IFutureReloadListener> pListeners, Executor pBackgroundExecutor, Executor pGameExecutor, CompletableFuture<Unit> pAlsoWaitedFor) {
      return new AsyncReloader<>(pBackgroundExecutor, pGameExecutor, pResourceManager, pListeners, (p_219561_1_, p_219561_2_, p_219561_3_, p_219561_4_, p_219561_5_) -> {
         return p_219561_3_.reload(p_219561_1_, p_219561_2_, EmptyProfiler.INSTANCE, EmptyProfiler.INSTANCE, pBackgroundExecutor, p_219561_5_);
      }, pAlsoWaitedFor);
   }
