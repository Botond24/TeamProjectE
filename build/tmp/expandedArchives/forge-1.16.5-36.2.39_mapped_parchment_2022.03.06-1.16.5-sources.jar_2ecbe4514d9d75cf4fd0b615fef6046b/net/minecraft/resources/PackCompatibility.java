...
public enum PackCompatibility {
   ...
   private PackCompatibility(String pType) {
      this.description = (new TranslationTextComponent("pack.incompatible." + pType)).withStyle(TextFormatting.GRAY);
      this.confirmation = new TranslationTextComponent("pack.incompatible.confirm." + pType);
   }
