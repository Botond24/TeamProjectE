...
public class SimpleReloadableResourceManager implements IReloadableResourceManager {
   ...
   public boolean hasResource(ResourceLocation pPath) {
      IResourceManager iresourcemanager = this.namespacedPacks.get(pPath.getNamespace());
      return iresourcemanager != null ? iresourcemanager.hasResource(pPath) : false;
   }

   public List<IResource> getResources(ResourceLocation pResourceLocation) throws IOException {
      IResourceManager iresourcemanager = this.namespacedPacks.get(pResourceLocation.getNamespace());
      if (iresourcemanager != null) {
         return iresourcemanager.getResources(pResourceLocation);
      } else {
   ...
   public void registerReloadListener(IFutureReloadListener pListener) {
      ...
      this.recentlyRegistered.add(pListener);
   }
