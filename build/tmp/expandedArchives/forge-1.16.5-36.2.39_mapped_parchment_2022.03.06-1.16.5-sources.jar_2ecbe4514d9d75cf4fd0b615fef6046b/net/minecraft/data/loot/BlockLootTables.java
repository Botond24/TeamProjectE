...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   protected static <T> T applyExplosionDecay(IItemProvider pItem, ILootFunctionConsumer<T> pFunction) {
      return (T)(!EXPLOSION_RESISTANT.contains(pItem.asItem()) ? pFunction.apply(ExplosionDecay.explosionDecay()) : pFunction.unwrap());
   }

   protected static <T> T applyExplosionCondition(IItemProvider pItem, ILootConditionConsumer<T> pCondition) {
      return (T)(!EXPLOSION_RESISTANT.contains(pItem.asItem()) ? pCondition.when(SurvivesExplosion.survivesExplosion()) : pCondition.unwrap());
   }
    ...
    */
   protected static LootTable.Builder createSelfDropDispatchTable(Block pBlock, ILootCondition.IBuilder pConditionBuilder, LootEntry.Builder<?> pAlternativeEntryBuilder) {
      return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantRange.exactly(1)).add(ItemLootEntry.lootTableItem(pBlock).when(pConditionBuilder).otherwise(pAlternativeEntryBuilder)));
   }
    ...
    * Otherwise, drops loot specified by {@code alternativeEntryBuilder}.
    */
   protected static LootTable.Builder createSilkTouchDispatchTable(Block pBlock, LootEntry.Builder<?> pAlternativeEntryBuilder) {
    ...
    * Otherwise, drops loot specified by {@code alternativeEntryBuilder}.
    */
   protected static LootTable.Builder createShearsDispatchTable(Block pBlock, LootEntry.Builder<?> pAlternativeEntryBuilder) {
    ...
    * Otherwise, drops loot specified by {@code alternativeEntryBuilder}.
    */
   protected static LootTable.Builder createSilkTouchOrShearsDispatchTable(Block pBlock, LootEntry.Builder<?> pAlternativeEntryBuilder) {
      return createSelfDropDispatchTable(pBlock, HAS_SHEARS_OR_SILK_TOUCH, pAlternativeEntryBuilder);
   }

   protected static LootTable.Builder createSingleItemTableWithSilkTouch(Block pSilkTouchBlock, IItemProvider pNoSilkTouchItemLike) {
      return createSilkTouchDispatchTable(pSilkTouchBlock, applyExplosionCondition(pSilkTouchBlock, ItemLootEntry.lootTableItem(pNoSilkTouchItemLike)));
   }
   ...
   protected static LootTable.Builder createSilkTouchOnlyTable(IItemProvider pItem) {
      return LootTable.lootTable().withPool(LootPool.lootPool().when(HAS_SILK_TOUCH).setRolls(ConstantRange.exactly(1)).add(ItemLootEntry.lootTableItem(pItem)));
   }

   protected static LootTable.Builder createPotFlowerItemTable(IItemProvider pFlowerPotContent) {
      return LootTable.lootTable().withPool(applyExplosionCondition(Blocks.FLOWER_POT, LootPool.lootPool().setRolls(ConstantRange.exactly(1)).add(ItemLootEntry.lootTableItem(Blocks.FLOWER_POT)))).withPool(applyExplosionCondition(pFlowerPotContent, LootPool.lootPool().setRolls(ConstantRange.exactly(1)).add(ItemLootEntry.lootTableItem(pFlowerPotContent))));
   }
   ...
   protected static <T extends Comparable<T> & IStringSerializable> LootTable.Builder createSinglePropConditionTable(Block pBlock, Property<T> pProperty, T pValue) {
      return LootTable.lootTable().withPool(applyExplosionCondition(pBlock, LootPool.lootPool().setRolls(ConstantRange.exactly(1)).add(ItemLootEntry.lootTableItem(pBlock).when(BlockStateProperty.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(pProperty, pValue))))));
   }
   ...
   protected static LootTable.Builder createOreDrop(Block pBlock, Item pItem) {
      return createSilkTouchDispatchTable(pBlock, applyExplosionDecay(pBlock, ItemLootEntry.lootTableItem(pItem).apply(ApplyBonus.addOreBonusCount(Enchantments.BLOCK_FORTUNE))));
   }
    ...
    */
   protected static LootTable.Builder createMushroomBlockDrop(Block pBlock, IItemProvider pItem) {
      return createSilkTouchDispatchTable(pBlock, applyExplosionDecay(pBlock, ItemLootEntry.lootTableItem(pItem).apply(SetCount.setCount(RandomValueRange.between(-6.0F, 2.0F))).apply(LimitCount.limitCount(IntClamper.lowerBound(0)))));
   }
   ...
   protected static LootTable.Builder createStemDrops(Block pStemBlock, Item pSeedsItem) {
      return LootTable.lootTable().withPool(applyExplosionDecay(pStemBlock, LootPool.lootPool().setRolls(ConstantRange.exactly(1)).add(ItemLootEntry.lootTableItem(pSeedsItem).apply(SetCount.setCount(BinomialRange.binomial(3, 0.06666667F)).when(BlockStateProperty.hasBlockStateProperties(pStemBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StemBlock.AGE, 0)))).apply(SetCount.setCount(BinomialRange.binomial(3, 0.13333334F)).when(BlockStateProperty.hasBlockStateProperties(pStemBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StemBlock.AGE, 1)))).apply(SetCount.setCount(BinomialRange.binomial(3, 0.2F)).when(BlockStateProperty.hasBlockStateProperties(pStemBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StemBlock.AGE, 2)))).apply(SetCount.setCount(BinomialRange.binomial(3, 0.26666668F)).when(BlockStateProperty.hasBlockStateProperties(pStemBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StemBlock.AGE, 3)))).apply(SetCount.setCount(BinomialRange.binomial(3, 0.33333334F)).when(BlockStateProperty.hasBlockStateProperties(pStemBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StemBlock.AGE, 4)))).apply(SetCount.setCount(BinomialRange.binomial(3, 0.4F)).when(BlockStateProperty.hasBlockStateProperties(pStemBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StemBlock.AGE, 5)))).apply(SetCount.setCount(BinomialRange.binomial(3, 0.46666667F)).when(BlockStateProperty.hasBlockStateProperties(pStemBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StemBlock.AGE, 6)))).apply(SetCount.setCount(BinomialRange.binomial(3, 0.53333336F)).when(BlockStateProperty.hasBlockStateProperties(pStemBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StemBlock.AGE, 7)))))));
   }

   private static LootTable.Builder createAttachedStemDrops(Block pAttachedStemBlock, Item pSeedsItem) {
      return LootTable.lootTable().withPool(applyExplosionDecay(pAttachedStemBlock, LootPool.lootPool().setRolls(ConstantRange.exactly(1)).add(ItemLootEntry.lootTableItem(pSeedsItem).apply(SetCount.setCount(BinomialRange.binomial(3, 0.53333336F))))));
   }
   ...
   private static LootTable.Builder createDoublePlantShearsDrop(Block pSheared) {
      return LootTable.lootTable().withPool(LootPool.lootPool().when(HAS_SHEARS).add(ItemLootEntry.lootTableItem(pSheared).apply(SetCount.setCount(ConstantRange.exactly(2)))));
   }

   private static LootTable.Builder createDoublePlantWithSeedDrops(Block pBlock, Block pSheared) {
      LootEntry.Builder<?> builder = ItemLootEntry.lootTableItem(pSheared).apply(SetCount.setCount(ConstantRange.exactly(2))).when(HAS_SHEARS).otherwise(applyExplosionCondition(pBlock, ItemLootEntry.lootTableItem(Items.WHEAT_SEEDS)).when(RandomChance.randomChance(0.125F)));
      return LootTable.lootTable().withPool(LootPool.lootPool().add(builder).when(BlockStateProperty.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER))).when(LocationCheck.checkLocation(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.UPPER).build()).build()), new BlockPos(0, 1, 0)))).withPool(LootPool.lootPool().add(builder).when(BlockStateProperty.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.UPPER))).when(LocationCheck.checkLocation(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER).build()).build()), new BlockPos(0, -1, 0))));
   }
   ...
   private void addNetherVinesDropTable(Block pVines, Block pPlant) {
      LootTable.Builder loottable$builder = createSilkTouchOrShearsDispatchTable(pVines, ItemLootEntry.lootTableItem(pVines).when(TableBonus.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.33F, 0.55F, 0.77F, 1.0F)));
   ...
   public void dropPottedContents(Block pFlowerPot) {
      this.add(pFlowerPot, (p_241751_0_) -> {
   ...
   public void dropOther(Block pBlock, IItemProvider pDrop) {
