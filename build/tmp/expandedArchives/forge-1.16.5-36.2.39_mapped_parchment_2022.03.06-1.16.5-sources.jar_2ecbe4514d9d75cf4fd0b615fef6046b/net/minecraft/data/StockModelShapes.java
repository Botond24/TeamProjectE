...
public class StockModelShapes {
   ...
   private static ModelsUtil create(StockTextureAliases... pRequiredSlots) {
      return new ModelsUtil(Optional.empty(), Optional.empty(), pRequiredSlots);
   }

   private static ModelsUtil create(String pBlockModelLocation, StockTextureAliases... pRequiredSlots) {
      return new ModelsUtil(Optional.of(new ResourceLocation("minecraft", "block/" + pBlockModelLocation)), Optional.empty(), pRequiredSlots);
   }

   private static ModelsUtil createItem(String pItemModelLocation, StockTextureAliases... pRequiredSlots) {
      return new ModelsUtil(Optional.of(new ResourceLocation("minecraft", "item/" + pItemModelLocation)), Optional.empty(), pRequiredSlots);
   }

   private static ModelsUtil create(String pBlockModelLocation, String pSuffix, StockTextureAliases... pRequiredSlots) {
      return new ModelsUtil(Optional.of(new ResourceLocation("minecraft", "block/" + pBlockModelLocation)), Optional.of(pSuffix), pRequiredSlots);
   }
}