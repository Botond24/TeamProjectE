...
public class ShapedRecipeBuilder {
   ...
   public ShapedRecipeBuilder(IItemProvider pResult, int pCount) {
    ...
    */
   public static ShapedRecipeBuilder shaped(IItemProvider pResult) {
    ...
    * Creates a new builder for a shaped recipe.
    */
   public static ShapedRecipeBuilder shaped(IItemProvider pResult, int pCount) {
    ...
    */
   public ShapedRecipeBuilder define(Character pSymbol, ITag<Item> pTag) {
    ...
    * Adds a key to the recipe pattern.
    */
   public ShapedRecipeBuilder define(Character pSymbol, IItemProvider pItem) {
   ...
   public ShapedRecipeBuilder unlockedBy(String p_200465_1_, ICriterionInstance p_200465_2_) {
      this.advancement.addCriterion(p_200465_1_, p_200465_2_);
      return this;
   }

   public ShapedRecipeBuilder group(String p_200473_1_) {
