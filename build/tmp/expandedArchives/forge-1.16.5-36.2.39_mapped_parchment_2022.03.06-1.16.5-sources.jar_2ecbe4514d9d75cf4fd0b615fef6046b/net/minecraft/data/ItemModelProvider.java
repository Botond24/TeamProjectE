...
public class ItemModelProvider {
   ...
   public ItemModelProvider(BiConsumer<ResourceLocation, Supplier<JsonElement>> pOutput) {
      this.output = pOutput;
   }

   private void generateFlatItem(Item pItem, ModelsUtil pModelTemplate) {
      pModelTemplate.create(ModelsResourceUtil.getModelLocation(pItem), ModelTextures.layer0(pItem), this.output);
   }

   private void generateFlatItem(Item pItem, String pModelLocationSuffix, ModelsUtil pModelTemplate) {
      pModelTemplate.create(ModelsResourceUtil.getModelLocation(pItem, pModelLocationSuffix), ModelTextures.layer0(ModelTextures.getItemTexture(pItem, pModelLocationSuffix)), this.output);
   }

   private void generateFlatItem(Item pItem, Item pLayerZeroItem, ModelsUtil pModelTemplate) {
      pModelTemplate.create(ModelsResourceUtil.getModelLocation(pItem), ModelTextures.layer0(pLayerZeroItem), this.output);
   }
