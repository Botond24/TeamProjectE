...
public class ItemTagsProvider extends TagsProvider<Item> {
   ...
   public ItemTagsProvider(DataGenerator pGenerator, BlockTagsProvider pBlockTagsProvider) {
      ...
      this.blockTags = pBlockTagsProvider::getOrCreateRawBuilder;
   }
   public ItemTagsProvider(DataGenerator pGenerator, BlockTagsProvider pBlockTagsProvider, String modId, @javax.annotation.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
    ...
    */
   protected void copy(ITag.INamedTag<Block> pBlockTag, ITag.INamedTag<Item> pItemTag) {
      ITag.Builder itag$builder = this.getOrCreateRawBuilder(pItemTag);
      ITag.Builder itag$builder1 = this.blockTags.apply(pBlockTag);
