...
public class BlockModelProvider {
   ...
   public BlockModelProvider(Consumer<IFinishedBlockState> pBlockStateOutput, BiConsumer<ResourceLocation, Supplier<JsonElement>> pModelOutput, Consumer<Item> pSkippedAutoModelsOutput) {
   ...
   private void delegateItemModel(Block pBlock, ResourceLocation pDelegateModelLocation) {
      this.modelOutput.accept(ModelsResourceUtil.getModelLocation(pBlock.asItem()), new BlockModelWriter(pDelegateModelLocation));
   }

   private void delegateItemModel(Item pItem, ResourceLocation pDelegateModelLocation) {
      this.modelOutput.accept(ModelsResourceUtil.getModelLocation(pItem), new BlockModelWriter(pDelegateModelLocation));
   }

   private void createSimpleFlatItemModel(Item pFlatItem) {
      StockModelShapes.FLAT_ITEM.create(ModelsResourceUtil.getModelLocation(pFlatItem), ModelTextures.layer0(pFlatItem), this.modelOutput);
   }

   private void createSimpleFlatItemModel(Block pFlatBlock) {
      Item item = pFlatBlock.asItem();
      if (item != Items.AIR) {
         StockModelShapes.FLAT_ITEM.create(ModelsResourceUtil.getModelLocation(item), ModelTextures.layer0(pFlatBlock), this.modelOutput);
      }
   ...
   private void createSimpleFlatItemModel(Block pFlatBlock, String pLayerZeroTextureSuffix) {
      Item item = pFlatBlock.asItem();
      StockModelShapes.FLAT_ITEM.create(ModelsResourceUtil.getModelLocation(item), ModelTextures.layer0(ModelTextures.getBlockTexture(pFlatBlock, pLayerZeroTextureSuffix)), this.modelOutput);
   }
   ...
   private static FinishedVariantBlockState createRotatedVariant(Block pBlock, ResourceLocation pModelLocation) {
      return FinishedVariantBlockState.multiVariant(pBlock, createRotatedVariants(pModelLocation));
   }

   private static BlockModelDefinition[] createRotatedVariants(ResourceLocation pModelLocation) {
      return new BlockModelDefinition[]{BlockModelDefinition.variant().with(BlockModelFields.MODEL, pModelLocation), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)};
   }

   private static FinishedVariantBlockState createRotatedVariant(Block pBlock, ResourceLocation pNormalModelLocation, ResourceLocation pMirroredModelLocation) {
      return FinishedVariantBlockState.multiVariant(pBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pNormalModelLocation), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pMirroredModelLocation), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pNormalModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pMirroredModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180));
   }

   private static BlockStateVariantBuilder createBooleanModelDispatch(BooleanProperty pProperty, ResourceLocation pTrueModelLocation, ResourceLocation pFalseModelLocation) {
      return BlockStateVariantBuilder.property(pProperty).select(true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTrueModelLocation)).select(false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pFalseModelLocation));
   }
   ...
   private static BlockStateVariantBuilder.Four<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> configureDoorHalf(BlockStateVariantBuilder.Four<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> pDoorProperties, DoubleBlockHalf pDoorHalf, ResourceLocation pDoorModelLocation, ResourceLocation pDoorRightHingeModelLocation) {
      return pDoorProperties.select(Direction.EAST, pDoorHalf, DoorHingeSide.LEFT, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorModelLocation)).select(Direction.SOUTH, pDoorHalf, DoorHingeSide.LEFT, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, pDoorHalf, DoorHingeSide.LEFT, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.NORTH, pDoorHalf, DoorHingeSide.LEFT, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.EAST, pDoorHalf, DoorHingeSide.RIGHT, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorRightHingeModelLocation)).select(Direction.SOUTH, pDoorHalf, DoorHingeSide.RIGHT, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorRightHingeModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, pDoorHalf, DoorHingeSide.RIGHT, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorRightHingeModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.NORTH, pDoorHalf, DoorHingeSide.RIGHT, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorRightHingeModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.EAST, pDoorHalf, DoorHingeSide.LEFT, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorRightHingeModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.SOUTH, pDoorHalf, DoorHingeSide.LEFT, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorRightHingeModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.WEST, pDoorHalf, DoorHingeSide.LEFT, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorRightHingeModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, pDoorHalf, DoorHingeSide.LEFT, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorRightHingeModelLocation)).select(Direction.EAST, pDoorHalf, DoorHingeSide.RIGHT, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.SOUTH, pDoorHalf, DoorHingeSide.RIGHT, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorModelLocation)).select(Direction.WEST, pDoorHalf, DoorHingeSide.RIGHT, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.NORTH, pDoorHalf, DoorHingeSide.RIGHT, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoorModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180));
   }

   private static IFinishedBlockState createDoor(Block pDoorBlock, ResourceLocation pBottomHalfModelLocation, ResourceLocation pBottomHalfRightHingeModelLocation, ResourceLocation pTopHalfModelLocation, ResourceLocation pTopHalfRightHingeModelLocation) {
      return FinishedVariantBlockState.multiVariant(pDoorBlock).with(configureDoorHalf(configureDoorHalf(BlockStateVariantBuilder.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.DOUBLE_BLOCK_HALF, BlockStateProperties.DOOR_HINGE, BlockStateProperties.OPEN), DoubleBlockHalf.LOWER, pBottomHalfModelLocation, pBottomHalfRightHingeModelLocation), DoubleBlockHalf.UPPER, pTopHalfModelLocation, pTopHalfRightHingeModelLocation));
   }

   private static IFinishedBlockState createFence(Block pFenceBlock, ResourceLocation pFencePostModelLocation, ResourceLocation pFenceSideModelLocation) {
      return FinishedMultiPartBlockState.multiPart(pFenceBlock).with(BlockModelDefinition.variant().with(BlockModelFields.MODEL, pFencePostModelLocation)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH, true), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pFenceSideModelLocation).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST, true), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pFenceSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH, true), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pFenceSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST, true), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pFenceSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true));
   }

   private static IFinishedBlockState createWall(Block pWallBlock, ResourceLocation pPostModelLocation, ResourceLocation pLowSideModelLocation, ResourceLocation pTallSideModelLocation) {
      return FinishedMultiPartBlockState.multiPart(pWallBlock).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.UP, true), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pPostModelLocation)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH_WALL, WallHeight.LOW), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pLowSideModelLocation).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST_WALL, WallHeight.LOW), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pLowSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH_WALL, WallHeight.LOW), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pLowSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST_WALL, WallHeight.LOW), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pLowSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.NORTH_WALL, WallHeight.TALL), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTallSideModelLocation).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.EAST_WALL, WallHeight.TALL), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTallSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.SOUTH_WALL, WallHeight.TALL), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTallSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.UV_LOCK, true)).with(IMultiPartPredicateBuilder.condition().term(BlockStateProperties.WEST_WALL, WallHeight.TALL), BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTallSideModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.UV_LOCK, true));
   }

   private static IFinishedBlockState createFenceGate(Block pFenceGateBlock, ResourceLocation pOpenModelLocation, ResourceLocation pClosedModelLocation, ResourceLocation pWallOpenModelLocation, ResourceLocation pWallClosedModelLocation) {
      return FinishedVariantBlockState.multiVariant(pFenceGateBlock, BlockModelDefinition.variant().with(BlockModelFields.UV_LOCK, true)).with(createHorizontalFacingDispatchAlt()).with(BlockStateVariantBuilder.properties(BlockStateProperties.IN_WALL, BlockStateProperties.OPEN).select(false, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pClosedModelLocation)).select(true, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pWallClosedModelLocation)).select(false, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation)).select(true, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pWallOpenModelLocation)));
   }
   ...
   private static IFinishedBlockState createOrientableTrapdoor(Block pOrientableTrapdoorBlock, ResourceLocation pTopModelLocation, ResourceLocation pBottomModelLocation, ResourceLocation pOpenModelLocation) {
      return FinishedVariantBlockState.multiVariant(pOrientableTrapdoorBlock).with(BlockStateVariantBuilder.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN).select(Direction.NORTH, Half.BOTTOM, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomModelLocation)).select(Direction.SOUTH, Half.BOTTOM, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, Half.TOP, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopModelLocation)).select(Direction.SOUTH, Half.TOP, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.TOP, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.TOP, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, Half.BOTTOM, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation)).select(Direction.SOUTH, Half.BOTTOM, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, Half.TOP, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.SOUTH, Half.TOP, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R0)).select(Direction.EAST, Half.TOP, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.WEST, Half.TOP, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R180).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)));
   }
   ...
   private static IFinishedBlockState createTrapdoor(Block pTrapdoorBlock, ResourceLocation pTopModelLocation, ResourceLocation pBottomModelLocation, ResourceLocation pOpenModelLocation) {
      return FinishedVariantBlockState.multiVariant(pTrapdoorBlock).with(BlockStateVariantBuilder.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN).select(Direction.NORTH, Half.BOTTOM, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomModelLocation)).select(Direction.SOUTH, Half.BOTTOM, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomModelLocation)).select(Direction.EAST, Half.BOTTOM, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomModelLocation)).select(Direction.WEST, Half.BOTTOM, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomModelLocation)).select(Direction.NORTH, Half.TOP, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopModelLocation)).select(Direction.SOUTH, Half.TOP, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopModelLocation)).select(Direction.EAST, Half.TOP, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopModelLocation)).select(Direction.WEST, Half.TOP, false, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopModelLocation)).select(Direction.NORTH, Half.BOTTOM, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation)).select(Direction.SOUTH, Half.BOTTOM, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)).select(Direction.NORTH, Half.TOP, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation)).select(Direction.SOUTH, Half.TOP, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180)).select(Direction.EAST, Half.TOP, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)).select(Direction.WEST, Half.TOP, true, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pOpenModelLocation).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270)));
   }
   ...
   private static IFinishedBlockState createAxisAlignedPillarBlock(Block pAxisAlignedPillarBlock, ResourceLocation pModelLocation) {
      return FinishedVariantBlockState.multiVariant(pAxisAlignedPillarBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pModelLocation)).with(createRotatedPillar());
   }
   ...
   private void createAxisAlignedPillarBlock(Block pAxisAlignedPillarBlock, TexturedModel.ISupplier pProvider) {
   ...
   private void createHorizontallyRotatedBlock(Block pHorizontallyRotatedBlock, TexturedModel.ISupplier pProvider) {
      ResourceLocation resourcelocation = pProvider.create(pHorizontallyRotatedBlock, this.modelOutput);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pHorizontallyRotatedBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, resourcelocation)).with(createHorizontalFacingDispatch()));
   }

   private static IFinishedBlockState createRotatedPillarWithHorizontalVariant(Block pRotatedPillarBlock, ResourceLocation pModelLocation, ResourceLocation pHorizontalModelLocation) {
      return FinishedVariantBlockState.multiVariant(pRotatedPillarBlock).with(BlockStateVariantBuilder.property(BlockStateProperties.AXIS).select(Direction.Axis.Y, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pModelLocation)).select(Direction.Axis.Z, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pHorizontalModelLocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90)).select(Direction.Axis.X, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pHorizontalModelLocation).with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90)));
   }

   private void createRotatedPillarWithHorizontalVariant(Block pRotatedPillarBlock, TexturedModel.ISupplier pModelProvider, TexturedModel.ISupplier pHorizontalModelProvider) {
   ...
   private ResourceLocation createSuffixedVariant(Block pBlock, String pSuffix, ModelsUtil pModelTemplate, Function<ResourceLocation, ModelTextures> pTextureMappingGetter) {
      return pModelTemplate.createWithSuffix(pBlock, pSuffix, pTextureMappingGetter.apply(ModelTextures.getBlockTexture(pBlock, pSuffix)), this.modelOutput);
   }

   private static IFinishedBlockState createPressurePlate(Block pPressurePlateBlock, ResourceLocation pUnpoweredModelLocation, ResourceLocation pPoweredModelLocation) {
      return FinishedVariantBlockState.multiVariant(pPressurePlateBlock).with(createBooleanModelDispatch(BlockStateProperties.POWERED, pPoweredModelLocation, pUnpoweredModelLocation));
   }

   private static IFinishedBlockState createSlab(Block pSlabBlock, ResourceLocation pBottomHalfModelLocation, ResourceLocation pTopHalfModelLocation, ResourceLocation pDoubleModelLocation) {
      return FinishedVariantBlockState.multiVariant(pSlabBlock).with(BlockStateVariantBuilder.property(BlockStateProperties.SLAB_TYPE).select(SlabType.BOTTOM, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pBottomHalfModelLocation)).select(SlabType.TOP, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pTopHalfModelLocation)).select(SlabType.DOUBLE, BlockModelDefinition.variant().with(BlockModelFields.MODEL, pDoubleModelLocation)));
   }
   ...
   private void createTrivialBlock(Block pBlock, TexturedModel.ISupplier pProvider) {
      this.blockStateOutput.accept(createSimpleBlock(pBlock, pProvider.create(pBlock, this.modelOutput)));
   }

   private void createTrivialBlock(Block pBlock, ModelTextures pTextureMapping, ModelsUtil pModelTemplate) {
   ...
   private BlockModelProvider.BlockTextureCombiner family(Block pBlock) {
      return this.family(pBlock, TexturedModel.CUBE);
   }
   ...
   private void createDoor(Block pDoorBlock) {
      ModelTextures modeltextures = ModelTextures.door(pDoorBlock);
      ResourceLocation resourcelocation = StockModelShapes.DOOR_BOTTOM.create(pDoorBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.DOOR_BOTTOM_HINGE.create(pDoorBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation2 = StockModelShapes.DOOR_TOP.create(pDoorBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation3 = StockModelShapes.DOOR_TOP_HINGE.create(pDoorBlock, modeltextures, this.modelOutput);
      this.createSimpleFlatItemModel(pDoorBlock.asItem());
      this.blockStateOutput.accept(createDoor(pDoorBlock, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3));
   }

   private void createOrientableTrapdoor(Block pOrientableTrapdoorBlock) {
      ModelTextures modeltextures = ModelTextures.defaultTexture(pOrientableTrapdoorBlock);
      ResourceLocation resourcelocation = StockModelShapes.ORIENTABLE_TRAPDOOR_TOP.create(pOrientableTrapdoorBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.ORIENTABLE_TRAPDOOR_BOTTOM.create(pOrientableTrapdoorBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation2 = StockModelShapes.ORIENTABLE_TRAPDOOR_OPEN.create(pOrientableTrapdoorBlock, modeltextures, this.modelOutput);
   ...
   private void createTrapdoor(Block pTrapdoorBlock) {
      ModelTextures modeltextures = ModelTextures.defaultTexture(pTrapdoorBlock);
      ResourceLocation resourcelocation = StockModelShapes.TRAPDOOR_TOP.create(pTrapdoorBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.TRAPDOOR_BOTTOM.create(pTrapdoorBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation2 = StockModelShapes.TRAPDOOR_OPEN.create(pTrapdoorBlock, modeltextures, this.modelOutput);
   ...
   private BlockModelProvider.LogsVariantHelper woodProvider(Block pLogBlock) {
      return new BlockModelProvider.LogsVariantHelper(ModelTextures.logColumn(pLogBlock));
   }
   ...
   private void createNonTemplateModelBlock(Block pBlock, Block pModelBlock) {
      this.blockStateOutput.accept(createSimpleBlock(pBlock, ModelsResourceUtil.getModelLocation(pModelBlock)));
   }

   private void createCrossBlockWithDefaultItem(Block pCrossBlock, BlockModelProvider.TintMode pTintState) {
      this.createSimpleFlatItemModel(pCrossBlock);
      this.createCrossBlock(pCrossBlock, pTintState);
   }

   private void createCrossBlockWithDefaultItem(Block pCrossBlock, BlockModelProvider.TintMode pTintState, ModelTextures pTextureMapping) {
      this.createSimpleFlatItemModel(pCrossBlock);
      this.createCrossBlock(pCrossBlock, pTintState, pTextureMapping);
   }

   private void createCrossBlock(Block pCrossBlock, BlockModelProvider.TintMode pTintState) {
      ModelTextures modeltextures = ModelTextures.cross(pCrossBlock);
      this.createCrossBlock(pCrossBlock, pTintState, modeltextures);
   }

   private void createCrossBlock(Block pCrossBlock, BlockModelProvider.TintMode pTintState, ModelTextures pTextureMapping) {
   ...
   private void createPlant(Block pPlantBlock, Block pPottedPlantBlock, BlockModelProvider.TintMode pTintState) {
      this.createCrossBlockWithDefaultItem(pPlantBlock, pTintState);
      ModelTextures modeltextures = ModelTextures.plant(pPlantBlock);
      ResourceLocation resourcelocation = pTintState.getCrossPot().create(pPottedPlantBlock, modeltextures, this.modelOutput);
   ...
   private void createCoralFans(Block pCoralFanBlock, Block pCoralWallFanBlock) {
      ...
      ResourceLocation resourcelocation1 = StockModelShapes.CORAL_WALL_FAN.create(pCoralWallFanBlock, texturedmodel.getMapping(), this.modelOutput);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pCoralWallFanBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, resourcelocation1)).with(createHorizontalFacingDispatch()));
   ...
   private void createCoral(Block pCoralBlock, Block pDeadCoralBlock, Block pCoralFullBlock, Block pDeadCoralFullBlock, Block pCoralFanBlock, Block pDeadCoralFanBlock, Block pCoralWallFanBlock, Block pDeadCoralWallFanBlock) {
      this.createCrossBlockWithDefaultItem(pCoralBlock, BlockModelProvider.TintMode.NOT_TINTED);
      this.createCrossBlockWithDefaultItem(pDeadCoralBlock, BlockModelProvider.TintMode.NOT_TINTED);
   ...
   private void createDoublePlant(Block pDoublePlantBlock, BlockModelProvider.TintMode pTintState) {
      this.createSimpleFlatItemModel(pDoublePlantBlock, "_top");
      ResourceLocation resourcelocation = this.createSuffixedVariant(pDoublePlantBlock, "_top", pTintState.getCross(), ModelTextures::cross);
      ResourceLocation resourcelocation1 = this.createSuffixedVariant(pDoublePlantBlock, "_bottom", pTintState.getCross(), ModelTextures::cross);
   ...
   private void createActiveRail(Block pRailBlock) {
      ...
      this.createSimpleFlatItemModel(pRailBlock);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pRailBlock).with(blockstatevariantbuilder));
   }

   private BlockModelProvider.BreakParticleHelper blockEntityModels(ResourceLocation pEntityBlockModelLocation, Block pParticleBlock) {
      return new BlockModelProvider.BreakParticleHelper(pEntityBlockModelLocation, pParticleBlock);
   }

   private BlockModelProvider.BreakParticleHelper blockEntityModels(Block pEntityBlockBaseModel, Block pParticleBlock) {
      return new BlockModelProvider.BreakParticleHelper(ModelsResourceUtil.getModelLocation(pEntityBlockBaseModel), pParticleBlock);
   }

   private void createAirLikeBlock(Block pAirLikeBlock, Item pParticleItem) {
      ResourceLocation resourcelocation = StockModelShapes.PARTICLE_ONLY.create(pAirLikeBlock, ModelTextures.particleFromItem(pParticleItem), this.modelOutput);
   ...
   private void createAirLikeBlock(Block pAirLikeBlock, ResourceLocation pParticleTexture) {
      ResourceLocation resourcelocation = StockModelShapes.PARTICLE_ONLY.create(pAirLikeBlock, ModelTextures.particle(pParticleTexture), this.modelOutput);
      this.blockStateOutput.accept(createSimpleBlock(pAirLikeBlock, resourcelocation));
   }
   ...
   private void createColoredBlockWithRandomRotations(TexturedModel.ISupplier pModelProvider, Block... pColoredBlocks) {
   ...
   private void createColoredBlockWithStateRotations(TexturedModel.ISupplier pModelProvider, Block... pColoredBlocks) {
      for(Block block : pColoredBlocks) {
         ResourceLocation resourcelocation = pModelProvider.create(block, this.modelOutput);
   ...
   private List<BlockModelDefinition> createBambooModels(int pAge) {
      String s = "_age" + pAge;
   ...
   private static <T extends Comparable<T>> BlockStateVariantBuilder createEmptyOrFullDispatch(Property<T> pProperty, T pMinimumValueForFullVariant, ResourceLocation pFullVariantModelLocation, ResourceLocation pEmptyVariantModelLocation) {
      BlockModelDefinition blockmodeldefinition = BlockModelDefinition.variant().with(BlockModelFields.MODEL, pFullVariantModelLocation);
      BlockModelDefinition blockmodeldefinition1 = BlockModelDefinition.variant().with(BlockModelFields.MODEL, pEmptyVariantModelLocation);
      return BlockStateVariantBuilder.property(pProperty).generate((p_239909_3_) -> {
         boolean flag = p_239909_3_.compareTo(pMinimumValueForFullVariant) >= 0;
         return flag ? blockmodeldefinition : blockmodeldefinition1;
      });
   }

   private void createBeeNest(Block pBeeNestBlock, Function<Block, ModelTextures> pTextureMappingGetter) {
      ModelTextures modeltextures = pTextureMappingGetter.apply(pBeeNestBlock).copyForced(StockTextureAliases.SIDE, StockTextureAliases.PARTICLE);
      ModelTextures modeltextures1 = modeltextures.copyAndUpdate(StockTextureAliases.FRONT, ModelTextures.getBlockTexture(pBeeNestBlock, "_front_honey"));
      ResourceLocation resourcelocation = StockModelShapes.CUBE_ORIENTABLE_TOP_BOTTOM.create(pBeeNestBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.CUBE_ORIENTABLE_TOP_BOTTOM.createWithSuffix(pBeeNestBlock, "_honey", modeltextures1, this.modelOutput);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pBeeNestBlock).with(createHorizontalFacingDispatch()).with(createEmptyOrFullDispatch(BlockStateProperties.LEVEL_HONEY, 5, resourcelocation1, resourcelocation)));
   }
   ...
   private void createCropBlock(Block pCropBlock, Property<Integer> pAgeProperty, int... pAgeToVisualStageMapping) {
      if (pAgeProperty.getPossibleValues().size() != pAgeToVisualStageMapping.length) {
         ...
         BlockStateVariantBuilder blockstatevariantbuilder = BlockStateVariantBuilder.property(pAgeProperty).generate((p_239920_4_) -> {
            int i = pAgeToVisualStageMapping[p_239920_4_];
            ResourceLocation resourcelocation = int2objectmap.computeIfAbsent(i, (p_239870_3_) -> {
               return this.createSuffixedVariant(pCropBlock, "_stage" + i, StockModelShapes.CROP, ModelTextures::crop);
            });
         ...
         this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pCropBlock).with(blockstatevariantbuilder));
      }
   }
   ...
   private void createFurnace(Block pFurnaceBlock, TexturedModel.ISupplier pModelProvider) {
      ResourceLocation resourcelocation = pModelProvider.create(pFurnaceBlock, this.modelOutput);
      ResourceLocation resourcelocation1 = ModelTextures.getBlockTexture(pFurnaceBlock, "_front_on");
      ResourceLocation resourcelocation2 = pModelProvider.get(pFurnaceBlock).updateTextures((p_239963_1_) -> {
         p_239963_1_.put(StockTextureAliases.FRONT, resourcelocation1);
      }).createWithSuffix(pFurnaceBlock, "_on", this.modelOutput);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pFurnaceBlock).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourcelocation2, resourcelocation)).with(createHorizontalFacingDispatch()));
   }
   ...
   private void createCraftingTableLike(Block pCraftingTableBlock, Block pCraftingTableMaterialBlock, BiFunction<Block, Block, ModelTextures> pTextureMappingGetter) {
      ModelTextures modeltextures = pTextureMappingGetter.apply(pCraftingTableBlock, pCraftingTableMaterialBlock);
      this.blockStateOutput.accept(createSimpleBlock(pCraftingTableBlock, StockModelShapes.CUBE.create(pCraftingTableBlock, modeltextures, this.modelOutput)));
   }
   ...
   private void createPumpkinVariant(Block pPumpkinBlock, ModelTextures pColumnTextureMapping) {
      ResourceLocation resourcelocation = StockModelShapes.CUBE_ORIENTABLE.create(pPumpkinBlock, pColumnTextureMapping.copyAndUpdate(StockTextureAliases.FRONT, ModelTextures.getBlockTexture(pPumpkinBlock)), this.modelOutput);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pPumpkinBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, resourcelocation)).with(createHorizontalFacingDispatch()));
   }
   ...
   private void createNyliumBlock(Block pNyliumBlock) {
      ModelTextures modeltextures = (new ModelTextures()).put(StockTextureAliases.BOTTOM, ModelTextures.getBlockTexture(Blocks.NETHERRACK)).put(StockTextureAliases.TOP, ModelTextures.getBlockTexture(pNyliumBlock)).put(StockTextureAliases.SIDE, ModelTextures.getBlockTexture(pNyliumBlock, "_side"));
      this.blockStateOutput.accept(createSimpleBlock(pNyliumBlock, StockModelShapes.CUBE_BOTTOM_TOP.create(pNyliumBlock, modeltextures, this.modelOutput)));
   }
   ...
   private void createRotatableColumn(Block pRotatableColumnBlock) {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pRotatableColumnBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, ModelsResourceUtil.getModelLocation(pRotatableColumnBlock))).with(this.createColumnWithFacing()));
   }
   ...
   private List<ResourceLocation> createFloorFireModels(Block pFireBlock) {
      ResourceLocation resourcelocation = StockModelShapes.FIRE_FLOOR.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_floor0"), ModelTextures.fire0(pFireBlock), this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.FIRE_FLOOR.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_floor1"), ModelTextures.fire1(pFireBlock), this.modelOutput);
   ...
   private List<ResourceLocation> createSideFireModels(Block pFireBlock) {
      ResourceLocation resourcelocation = StockModelShapes.FIRE_SIDE.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_side0"), ModelTextures.fire0(pFireBlock), this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.FIRE_SIDE.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_side1"), ModelTextures.fire1(pFireBlock), this.modelOutput);
      ResourceLocation resourcelocation2 = StockModelShapes.FIRE_SIDE_ALT.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_side_alt0"), ModelTextures.fire0(pFireBlock), this.modelOutput);
      ResourceLocation resourcelocation3 = StockModelShapes.FIRE_SIDE_ALT.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_side_alt1"), ModelTextures.fire1(pFireBlock), this.modelOutput);
   ...
   private List<ResourceLocation> createTopFireModels(Block pFireBlock) {
      ResourceLocation resourcelocation = StockModelShapes.FIRE_UP.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_up0"), ModelTextures.fire0(pFireBlock), this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.FIRE_UP.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_up1"), ModelTextures.fire1(pFireBlock), this.modelOutput);
      ResourceLocation resourcelocation2 = StockModelShapes.FIRE_UP_ALT.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_up_alt0"), ModelTextures.fire0(pFireBlock), this.modelOutput);
      ResourceLocation resourcelocation3 = StockModelShapes.FIRE_UP_ALT.create(ModelsResourceUtil.getModelLocation(pFireBlock, "_up_alt1"), ModelTextures.fire1(pFireBlock), this.modelOutput);
      return ImmutableList.of(resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3);
   }

   private static List<BlockModelDefinition> wrapModels(List<ResourceLocation> pModelLocations, UnaryOperator<BlockModelDefinition> pVariantMapper) {
      return pModelLocations.stream().map((p_239950_0_) -> {
   ...
   private void createLantern(Block pLanternBlock) {
      ...
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pLanternBlock).with(createBooleanModelDispatch(BlockStateProperties.HANGING, resourcelocation1, resourcelocation)));
   }
   ...
   private void createGrassLikeBlock(Block pGrassLikeBlock, ResourceLocation pModelLocation, BlockModelDefinition pVariant) {
      List<BlockModelDefinition> list = Arrays.asList(createRotatedVariants(pModelLocation));
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pGrassLikeBlock).with(BlockStateVariantBuilder.property(BlockStateProperties.SNOWY).select(true, pVariant).select(false, list)));
   }
   ...
   private void createWeightedPressurePlate(Block pPressurePlateBlock, Block pPlateMaterialBlock) {
      ModelTextures modeltextures = ModelTextures.defaultTexture(pPlateMaterialBlock);
      ResourceLocation resourcelocation = StockModelShapes.PRESSURE_PLATE_UP.create(pPressurePlateBlock, modeltextures, this.modelOutput);
      ResourceLocation resourcelocation1 = StockModelShapes.PRESSURE_PLATE_DOWN.create(pPressurePlateBlock, modeltextures, this.modelOutput);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pPressurePlateBlock).with(createEmptyOrFullDispatch(BlockStateProperties.POWER, 1, resourcelocation1, resourcelocation)));
   }
   ...
   private void copyModel(Block pSourceBlock, Block pTargetBlock) {
      ResourceLocation resourcelocation = ModelsResourceUtil.getModelLocation(pSourceBlock);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pTargetBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, resourcelocation)));
   ...
   private void createNonTemplateHorizontalBlock(Block pHorizontalBlock) {
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pHorizontalBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, ModelsResourceUtil.getModelLocation(pHorizontalBlock))).with(createHorizontalFacingDispatch()));
   }
   ...
   private void createPistonVariant(Block pPistonBlock, ResourceLocation pBaseModelLocation, ModelTextures pTopTextureMapping) {
      ResourceLocation resourcelocation = StockModelShapes.PISTON.create(pPistonBlock, pTopTextureMapping, this.modelOutput);
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pPistonBlock).with(createBooleanModelDispatch(BlockStateProperties.EXTENDED, pBaseModelLocation, resourcelocation)).with(createFacingDispatch()));
   }
   ...
   private void createNormalTorch(Block pTorchBlock, Block pWallTorchBlock) {
      ModelTextures modeltextures = ModelTextures.torch(pTorchBlock);
      this.blockStateOutput.accept(createSimpleBlock(pTorchBlock, StockModelShapes.TORCH.create(pTorchBlock, modeltextures, this.modelOutput)));
      this.blockStateOutput.accept(FinishedVariantBlockState.multiVariant(pWallTorchBlock, BlockModelDefinition.variant().with(BlockModelFields.MODEL, StockModelShapes.WALL_TORCH.create(pWallTorchBlock, modeltextures, this.modelOutput))).with(createTorchHorizontalDispatch()));
   ...
   private ResourceLocation createTurtleEggModel(int pHatchAmount, String pVariantName, ModelTextures pTextureMapping) {
      switch(pHatchAmount) {
      case 1:
         return StockModelShapes.TURTLE_EGG.create(ModelsResourceUtil.decorateBlockModelLocation(pVariantName + "turtle_egg"), pTextureMapping, this.modelOutput);
      case 2:
         return StockModelShapes.TWO_TURTLE_EGGS.create(ModelsResourceUtil.decorateBlockModelLocation("two_" + pVariantName + "turtle_eggs"), pTextureMapping, this.modelOutput);
      case 3:
         return StockModelShapes.THREE_TURTLE_EGGS.create(ModelsResourceUtil.decorateBlockModelLocation("three_" + pVariantName + "turtle_eggs"), pTextureMapping, this.modelOutput);
      case 4:
         return StockModelShapes.FOUR_TURTLE_EGGS.create(ModelsResourceUtil.decorateBlockModelLocation("four_" + pVariantName + "turtle_eggs"), pTextureMapping, this.modelOutput);
      default:
   ...
   private ResourceLocation createTurtleEggModel(Integer pEggAmount, Integer pVariantId) {
      switch(pVariantId) {
      case 0:
         return this.createTurtleEggModel(pEggAmount, "", ModelTextures.cube(ModelTextures.getBlockTexture(Blocks.TURTLE_EGG)));
      case 1:
         return this.createTurtleEggModel(pEggAmount, "slightly_cracked_", ModelTextures.cube(ModelTextures.getBlockTexture(Blocks.TURTLE_EGG, "_slightly_cracked")));
      case 2:
         return this.createTurtleEggModel(pEggAmount, "very_cracked_", ModelTextures.cube(ModelTextures.getBlockTexture(Blocks.TURTLE_EGG, "_very_cracked")));
      default:
         throw new UnsupportedOperationException();
      }
   }
   ...
   private void createShulkerBox(Block pShulkerBoxBlock) {
      ...
      StockModelShapes.SHULKER_BOX_INVENTORY.create(ModelsResourceUtil.getModelLocation(pShulkerBoxBlock.asItem()), ModelTextures.particle(pShulkerBoxBlock), this.modelOutput);
   }

   private void createGrowingPlant(Block pGrowingPlantBlock, Block pPlantBlock, BlockModelProvider.TintMode pTintState) {
   ...
   private void createBedItem(Block pBedBlock, Block pWoolBlock) {
      StockModelShapes.BED_INVENTORY.create(ModelsResourceUtil.getModelLocation(pBedBlock.asItem()), ModelTextures.particle(pWoolBlock), this.modelOutput);
   }
   ...
   private void createNetherRoots(Block pPlantBlock, Block pPottedPlantBlock) {
      this.createCrossBlockWithDefaultItem(pPlantBlock, BlockModelProvider.TintMode.NOT_TINTED);
      ModelTextures modeltextures = ModelTextures.plant(ModelTextures.getBlockTexture(pPlantBlock, "_pot"));
      ResourceLocation resourcelocation = BlockModelProvider.TintMode.NOT_TINTED.getCrossPot().create(pPottedPlantBlock, modeltextures, this.modelOutput);
      this.blockStateOutput.accept(createSimpleBlock(pPottedPlantBlock, resourcelocation));
   }
   ...
   private BlockModelDefinition applyRotation(JigsawOrientation pFrontAndTop, BlockModelDefinition pVariant) {
      switch(pFrontAndTop) {
      case DOWN_NORTH:
         return pVariant.with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90);
      case DOWN_SOUTH:
         return pVariant.with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180);
      case DOWN_WEST:
         return pVariant.with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270);
      case DOWN_EAST:
         return pVariant.with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R90).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90);
      case UP_NORTH:
         return pVariant.with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180);
      case UP_SOUTH:
         return pVariant.with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270);
      case UP_WEST:
         return pVariant.with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90);
      case UP_EAST:
         return pVariant.with(BlockModelFields.X_ROT, BlockModelFields.Rotation.R270).with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270);
      case NORTH_UP:
         return pVariant;
      case SOUTH_UP:
         return pVariant.with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R180);
      case WEST_UP:
         return pVariant.with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R270);
      case EAST_UP:
         return pVariant.with(BlockModelFields.Y_ROT, BlockModelFields.Rotation.R90);
      default:
   ...
   class BlockTextureCombiner {
      ...
      public BlockTextureCombiner(ModelTextures pMapping) {
         this.mapping = pMapping;
      }

      public BlockModelProvider.BlockTextureCombiner fullBlock(Block pBlock, ModelsUtil pModelTemplate) {
         this.fullBlock = pModelTemplate.create(pBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createSimpleBlock(pBlock, this.fullBlock));
         return this;
      }
      ...
      public BlockModelProvider.BlockTextureCombiner button(Block pButtonBlock) {
         ResourceLocation resourcelocation = StockModelShapes.BUTTON.create(pButtonBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation1 = StockModelShapes.BUTTON_PRESSED.create(pButtonBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createButton(pButtonBlock, resourcelocation, resourcelocation1));
         ResourceLocation resourcelocation2 = StockModelShapes.BUTTON_INVENTORY.create(pButtonBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.delegateItemModel(pButtonBlock, resourcelocation2);
         return this;
      }

      public BlockModelProvider.BlockTextureCombiner wall(Block pWallBlock) {
         ResourceLocation resourcelocation = StockModelShapes.WALL_POST.create(pWallBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation1 = StockModelShapes.WALL_LOW_SIDE.create(pWallBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation2 = StockModelShapes.WALL_TALL_SIDE.create(pWallBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createWall(pWallBlock, resourcelocation, resourcelocation1, resourcelocation2));
         ResourceLocation resourcelocation3 = StockModelShapes.WALL_INVENTORY.create(pWallBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.delegateItemModel(pWallBlock, resourcelocation3);
         return this;
      }

      public BlockModelProvider.BlockTextureCombiner fence(Block pFenceBlock) {
         ResourceLocation resourcelocation = StockModelShapes.FENCE_POST.create(pFenceBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation1 = StockModelShapes.FENCE_SIDE.create(pFenceBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createFence(pFenceBlock, resourcelocation, resourcelocation1));
         ResourceLocation resourcelocation2 = StockModelShapes.FENCE_INVENTORY.create(pFenceBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.delegateItemModel(pFenceBlock, resourcelocation2);
         return this;
      }

      public BlockModelProvider.BlockTextureCombiner fenceGate(Block pFenceGateBlock) {
         ResourceLocation resourcelocation = StockModelShapes.FENCE_GATE_OPEN.create(pFenceGateBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation1 = StockModelShapes.FENCE_GATE_CLOSED.create(pFenceGateBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation2 = StockModelShapes.FENCE_GATE_WALL_OPEN.create(pFenceGateBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation3 = StockModelShapes.FENCE_GATE_WALL_CLOSED.create(pFenceGateBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createFenceGate(pFenceGateBlock, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3));
         return this;
      }

      public BlockModelProvider.BlockTextureCombiner pressurePlate(Block pPressurePlateBlock) {
         ResourceLocation resourcelocation = StockModelShapes.PRESSURE_PLATE_UP.create(pPressurePlateBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation1 = StockModelShapes.PRESSURE_PLATE_DOWN.create(pPressurePlateBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createPressurePlate(pPressurePlateBlock, resourcelocation, resourcelocation1));
         return this;
      }
      ...
      public BlockModelProvider.BlockTextureCombiner slab(Block pSlabBlock) {
         if (this.fullBlock == null) {
            throw new IllegalStateException("Full block not generated yet");
         } else {
            ResourceLocation resourcelocation = StockModelShapes.SLAB_BOTTOM.create(pSlabBlock, this.mapping, BlockModelProvider.this.modelOutput);
            ResourceLocation resourcelocation1 = StockModelShapes.SLAB_TOP.create(pSlabBlock, this.mapping, BlockModelProvider.this.modelOutput);
            BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createSlab(pSlabBlock, resourcelocation, resourcelocation1, this.fullBlock));
            return this;
         }
      }

      public BlockModelProvider.BlockTextureCombiner stairs(Block pStairsBlock) {
         ResourceLocation resourcelocation = StockModelShapes.STAIRS_INNER.create(pStairsBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation1 = StockModelShapes.STAIRS_STRAIGHT.create(pStairsBlock, this.mapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation2 = StockModelShapes.STAIRS_OUTER.create(pStairsBlock, this.mapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createStairs(pStairsBlock, resourcelocation, resourcelocation1, resourcelocation2));
         return this;
      }
   }
   ...
   class BreakParticleHelper {
      ...
      public BreakParticleHelper(ResourceLocation pBaseModel, Block pParticleBlock) {
         this.baseModel = StockModelShapes.PARTICLE_ONLY.create(pBaseModel, ModelTextures.particle(pParticleBlock), BlockModelProvider.this.modelOutput);
      }

      public BlockModelProvider.BreakParticleHelper create(Block... pBlocks) {
      ...
      public BlockModelProvider.BreakParticleHelper createWithoutBlockItem(Block... pBlocks) {
         for(Block block : pBlocks) {
      ...
      public BlockModelProvider.BreakParticleHelper createWithCustomBlockItemModel(ModelsUtil pModelTemplate, Block... pBlocks) {
         for(Block block : pBlocks) {
            pModelTemplate.create(ModelsResourceUtil.getModelLocation(block.asItem()), ModelTextures.particle(block), BlockModelProvider.this.modelOutput);
         }
   ...
   class LogsVariantHelper {
      ...
      public LogsVariantHelper(ModelTextures pLogMapping) {
         this.logMapping = pLogMapping;
      }

      public BlockModelProvider.LogsVariantHelper wood(Block pWoodBlock) {
         ...
         ResourceLocation resourcelocation = StockModelShapes.CUBE_COLUMN.create(pWoodBlock, modeltextures, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createAxisAlignedPillarBlock(pWoodBlock, resourcelocation));
         return this;
      }

      public BlockModelProvider.LogsVariantHelper log(Block pLogBlock) {
         ResourceLocation resourcelocation = StockModelShapes.CUBE_COLUMN.create(pLogBlock, this.logMapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createAxisAlignedPillarBlock(pLogBlock, resourcelocation));
         return this;
      }

      public BlockModelProvider.LogsVariantHelper logWithHorizontal(Block pLogBlock) {
         ResourceLocation resourcelocation = StockModelShapes.CUBE_COLUMN.create(pLogBlock, this.logMapping, BlockModelProvider.this.modelOutput);
         ResourceLocation resourcelocation1 = StockModelShapes.CUBE_COLUMN_HORIZONTAL.create(pLogBlock, this.logMapping, BlockModelProvider.this.modelOutput);
         BlockModelProvider.this.blockStateOutput.accept(BlockModelProvider.createRotatedPillarWithHorizontalVariant(pLogBlock, resourcelocation, resourcelocation1));
         return this;
      }
   }
