...
public final class StockTextureAliases {
   ...
   private static StockTextureAliases create(String pId) {
      return new StockTextureAliases(pId, (StockTextureAliases)null);
   }

   private static StockTextureAliases create(String pId, StockTextureAliases pParent) {
      return new StockTextureAliases(pId, pParent);
   }

   private StockTextureAliases(String pId, @Nullable StockTextureAliases pParent) {
      this.id = pId;
      this.parent = pParent;
   }
