...
public class BidiReorderer {
   public static IReorderingProcessor reorder(ITextProperties pText, boolean p_243508_1_) {
      BidiReorder bidireorder = BidiReorder.create(pText, UCharacter::getMirror, BidiReorderer::shape);
