...
public class JSONBlendingMode {
   ...
   private JSONBlendingMode(boolean pSeparateBlend, boolean pOpaque, int pSrcColorFactor, int pDstColorFactor, int pSrcAlphaFactor, int pDstAlphaFactor, int pBlendFunc) {
   ...
   public JSONBlendingMode(int pSrcFactor, int pDstFactor, int pBlendFunc) {
      this(false, false, pSrcFactor, pDstFactor, pSrcFactor, pDstFactor, pBlendFunc);
   }

   public JSONBlendingMode(int pSrcColorFactor, int pDstColorFactor, int pSrcAlphaFactor, int pDstAlphaFactor, int pBlendFunc) {
