...
public class VideoSettingsScreen extends SettingsScreen {
   ...
   public VideoSettingsScreen(Screen pLastScreen, GameSettings pOptions) {
      super(pLastScreen, pOptions, new TranslationTextComponent("options.videoTitle"));
      this.gpuWarnlistManager = pLastScreen.minecraft.getGpuWarnlistManager();
      this.gpuWarnlistManager.resetWarnings();
      if (pOptions.graphicsMode == GraphicsFanciness.FABULOUS) {
