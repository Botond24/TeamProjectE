...
public enum GlyphProviderTypes {
   ...
   public static GlyphProviderTypes byName(String pType) {
      GlyphProviderTypes glyphprovidertypes = BY_NAME.get(pType);
   ...
   public IGlyphProviderFactory create(JsonObject pJson) {
