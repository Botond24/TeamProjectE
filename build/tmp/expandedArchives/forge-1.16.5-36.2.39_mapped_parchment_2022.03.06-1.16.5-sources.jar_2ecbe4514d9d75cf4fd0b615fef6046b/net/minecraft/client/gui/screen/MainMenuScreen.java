...
public class MainMenuScreen extends Screen {
   ...
   private void createNormalMenuOptions(int pY, int pRowHeight) {
      this.addButton(new Button(this.width / 2 - 100, pY, 200, 20, new TranslationTextComponent("menu.singleplayer"), (p_213089_1_) -> {
      ...
      (this.addButton(new Button(this.width / 2 - 100, pY + pRowHeight * 1, 200, 20, new TranslationTextComponent("menu.multiplayer"), (p_213095_1_) -> {
      ...
      (this.addButton(new Button(this.width / 2 + 2, pY + pRowHeight * 2, 98, 20, new TranslationTextComponent("menu.online"), (p_238661_1_) -> {
   ...
   private void createDemoMenuOptions(int pY, int pRowHeight) {
      ...
      this.addButton(new Button(this.width / 2 - 100, pY, 200, 20, new TranslationTextComponent("menu.playdemo"), (p_213091_2_) -> {
         if (flag) {
      ...
      this.resetDemoButton = this.addButton(new Button(this.width / 2 - 100, pY + pRowHeight * 1, 200, 20, new TranslationTextComponent("menu.resetdemo"), (p_238658_1_) -> {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      fill(pMatrixStack, 0, 0, this.width, this.height, -1);
      this.panorama.render(pPartialTicks, MathHelper.clamp(f, 0.0F, 1.0F));
      int i = 274;
      ...
      blit(pMatrixStack, 0, 0, this.width, this.height, 0.0F, 0.0F, 16, 128, 16, 128);
      ...
      if ((l & -67108864) != 0) {
         ...
         if (this.minceraftEasterEgg) {
            this.blitOutlineBlack(j, 30, (p_238660_2_, p_238660_3_) -> {
               this.blit(pMatrixStack, p_238660_2_ + 0, p_238660_3_, 0, 0, 99, 44);
               this.blit(pMatrixStack, p_238660_2_ + 99, p_238660_3_, 129, 0, 27, 44);
               this.blit(pMatrixStack, p_238660_2_ + 99 + 26, p_238660_3_, 126, 0, 3, 44);
               this.blit(pMatrixStack, p_238660_2_ + 99 + 26 + 3, p_238660_3_, 99, 0, 26, 44);
               this.blit(pMatrixStack, p_238660_2_ + 155, p_238660_3_, 0, 45, 155, 44);
            });
         } else {
            this.blitOutlineBlack(j, 30, (p_238657_2_, p_238657_3_) -> {
               this.blit(pMatrixStack, p_238657_2_ + 0, p_238657_3_, 0, 0, 155, 44);
               this.blit(pMatrixStack, p_238657_2_ + 155, p_238657_3_, 0, 45, 155, 44);
            });
         }

         this.minecraft.getTextureManager().bind(MINECRAFT_EDITION);
         blit(pMatrixStack, j + 88, 67, 0.0F, 0.0F, 98, 14, 128, 16);
         net.minecraftforge.client.ForgeHooksClient.renderMainMenu(this, pMatrixStack, this.font, this.width, this.height, l);
         if (this.splash != null) {
            ...
            drawCenteredString(pMatrixStack, this.font, this.splash, 0, -8, 16776960 | l);
         ...
         net.minecraftforge.fml.BrandingControl.forEachLine(true, true, (brdline, brd) ->
            drawString(pMatrixStack, this.font, brd, 2, this.height - ( 10 + brdline * (this.font.lineHeight + 1)), 16777215 | l)
         );

         net.minecraftforge.fml.BrandingControl.forEachAboveCopyrightLine((brdline, brd) ->
            drawString(pMatrixStack, this.font, brd, this.width - font.width(brd), this.height - (10 + (brdline + 1) * ( this.font.lineHeight + 1)), 16777215 | l)
         );

         drawString(pMatrixStack, this.font, "Copyright Mojang AB. Do not distribute!", this.copyrightX, this.height - 10, 16777215 | l);
         if (pMouseX > this.copyrightX && pMouseX < this.copyrightX + this.copyrightWidth && pMouseY > this.height - 10 && pMouseY < this.height) {
            fill(pMatrixStack, this.copyrightX, this.height - 1, this.copyrightX + this.copyrightWidth, this.height, 16777215 | l);
         }
         ...
         if (this.realmsNotificationsEnabled() && f1 >= 1.0F) {
            this.realmsNotificationsScreen.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
         }
