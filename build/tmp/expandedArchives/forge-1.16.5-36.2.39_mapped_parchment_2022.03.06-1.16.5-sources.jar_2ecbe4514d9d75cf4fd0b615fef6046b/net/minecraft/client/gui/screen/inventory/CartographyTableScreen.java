...
public class CartographyTableScreen extends ContainerScreen<CartographyContainer> {
   ...
   public CartographyTableScreen(CartographyContainer pCartographyTableMenu, PlayerInventory pPlayerInventory, ITextComponent pTitle) {
      super(pCartographyTableMenu, pPlayerInventory, pTitle);
      this.titleLabelY -= 2;
   }
   ...
   protected void renderBg(MatrixStack pMatrixStack, float pPartialTicks, int pX, int pY) {
      ...
      this.renderResultingMap(pMatrixStack, mapdata, flag, flag1, flag2, flag3);
   }
