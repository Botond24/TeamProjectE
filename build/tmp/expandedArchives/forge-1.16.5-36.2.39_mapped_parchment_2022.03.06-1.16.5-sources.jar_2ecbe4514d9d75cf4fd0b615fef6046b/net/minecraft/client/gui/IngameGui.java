...
public class IngameGui extends AbstractGui {
   ...
   public void render(MatrixStack pMatrixStack, float pPartialTicks) {
      ...
      if (!this.minecraft.options.hideGui) {
         if (this.overlayMessageString != null && this.overlayMessageTime > 0) {
            ...
            float f3 = (float)this.overlayMessageTime - pPartialTicks;
            ...
            if (i1 > 8) {
               ...
               this.drawBackdrop(pMatrixStack, fontrenderer, -4, l, 16777215 | k);
               fontrenderer.draw(pMatrixStack, this.overlayMessageString, (float)(-l / 2), -4.0F, k1 | k);
               RenderSystem.disableBlend();
         ...
         if (this.title != null && this.titleTime > 0) {
            ...
            float f4 = (float)this.titleTime - pPartialTicks;
            int j1 = 255;
            ...
            if (j1 > 8) {
               ...
               this.drawBackdrop(pMatrixStack, fontrenderer, -10, i2, 16777215 | l1);
               fontrenderer.drawShadow(pMatrixStack, this.title, (float)(-i2 / 2), -10.0F, 16777215 | l1);
               RenderSystem.popMatrix();
               if (this.subtitle != null) {
                  RenderSystem.pushMatrix();
                  RenderSystem.scalef(2.0F, 2.0F, 2.0F);
                  int k2 = fontrenderer.width(this.subtitle);
                  this.drawBackdrop(pMatrixStack, fontrenderer, 5, k2, 16777215 | l1);
                  fontrenderer.drawShadow(pMatrixStack, this.subtitle, (float)(-k2 / 2), 5.0F, 16777215 | l1);
                  RenderSystem.popMatrix();
               }
         ...
         if (scoreobjective1 != null) {
            this.displayScoreboardSidebar(pMatrixStack, scoreobjective1);
         }
         ...
         if (!this.minecraft.options.keyPlayerList.isDown() || this.minecraft.isLocalServer() && this.minecraft.player.connection.getOnlinePlayers().size() <= 1 && scoreobjective1 == null) {
            ...
            this.tabList.render(pMatrixStack, this.screenWidth, scoreboard, scoreobjective1);
         }
      }
   ...
   protected void drawBackdrop(MatrixStack pMatrixStack, FontRenderer pRenderer, int p_238448_3_, int p_238448_4_, int p_238448_5_) {
      int i = this.minecraft.options.getBackgroundColor(0.0F);
      if (i != 0) {
         int j = -p_238448_4_ / 2;
         fill(pMatrixStack, j - 2, p_238448_3_ - 2, j + p_238448_4_ + 2, p_238448_3_ + 9 + 2, ColorHelper.PackedColor.multiply(i, p_238448_5_));
      }

   }

   protected void renderCrosshair(MatrixStack pMatrixStack) {
   ...
   private boolean canRenderCrosshairForSpectator(RayTraceResult pRayTrace) {
      if (pRayTrace == null) {
         return false;
      } else if (pRayTrace.getType() == RayTraceResult.Type.ENTITY) {
         return ((EntityRayTraceResult)pRayTrace).getEntity() instanceof INamedContainerProvider;
      } else if (pRayTrace.getType() == RayTraceResult.Type.BLOCK) {
         BlockPos blockpos = ((BlockRayTraceResult)pRayTrace).getBlockPos();
   ...
   protected void renderEffects(MatrixStack pMatrixStack) {
      ...
      if (!collection.isEmpty()) {
         ...
         for(EffectInstance effectinstance : Ordering.natural().reverse().sortedCopy(collection)) {
            ...
            if (effectinstance.showIcon()) {
               ...
               effectinstance.renderHUDEffect(this, pMatrixStack, k, l, this.getBlitOffset(), f);
            }
         }
   ...
   protected void renderHotbar(float pPartialTicks, MatrixStack pMatrixStack) {
      ...
      if (playerentity != null) {
         ...
         this.blit(pMatrixStack, i - 91 - 1 + playerentity.inventory.selected * 20, this.screenHeight - 22 - 1, 0, 22, 24, 22);
         ...
         for(int i1 = 0; i1 < 9; ++i1) {
            ...
            this.renderSlot(j1, k1, pPartialTicks, playerentity, playerentity.inventory.items.get(i1));
         }
         ...
         if (!itemstack.isEmpty()) {
            ...
            if (handside == HandSide.LEFT) {
               ...
               this.renderSlot(i + 91 + 10, i2, pPartialTicks, playerentity, itemstack);
            }
         }
         ...
         if (this.minecraft.options.attackIndicator == AttackIndicatorStatus.HOTBAR) {
            ...
            if (f < 1.0F) {
               ...
               int l1 = (int)(f * 19.0F);
               RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
               this.blit(pMatrixStack, k2, j2, 0, 94, 18, 18);
               this.blit(pMatrixStack, k2, j2 + 18 - l1, 18, 112 - l1, 18, l1);
            }
         }
   ...
   public void renderJumpMeter(MatrixStack pMatrixStack, int pXPosition) {
   ...
   public void renderExperienceBar(MatrixStack pMatrixStack, int pXPos) {
      ...
      if (this.minecraft.player.experienceLevel > 0) {
         ...
         this.getFont().draw(pMatrixStack, s, (float)(i1 + 1), (float)j1, 0);
         this.getFont().draw(pMatrixStack, s, (float)(i1 - 1), (float)j1, 0);
         this.getFont().draw(pMatrixStack, s, (float)i1, (float)(j1 + 1), 0);
         this.getFont().draw(pMatrixStack, s, (float)i1, (float)(j1 - 1), 0);
         this.getFont().draw(pMatrixStack, s, (float)i1, (float)j1, 8453920);
         this.minecraft.getProfiler().pop();
      }

   }

   public void renderSelectedItemName(MatrixStack pMatrixStack) {
      ...
      if (this.toolHighlightTimer > 0 && !this.lastToolHighlight.isEmpty()) {
         ...
         if (l > 0) {
            ...
            if (font == null) {
               this.getFont().drawShadow(pMatrixStack, highlightTip, (float)j, (float)k, 16777215 + (l << 24));
            } else {
               j = (this.screenWidth - font.width(highlightTip)) / 2;
               font.drawShadow(pMatrixStack, highlightTip, (float)j, (float)k, 16777215 + (l << 24));
            }
            RenderSystem.disableBlend();
            RenderSystem.popMatrix();
         }
   ...
   public void renderDemoOverlay(MatrixStack pMatrixStack) {
      ...
      this.getFont().drawShadow(pMatrixStack, itextcomponent, (float)(this.screenWidth - i - 10), 5.0F, 16777215);
      this.minecraft.getProfiler().pop();
   }
   ...
   private void renderPlayerHealth(MatrixStack pMatrixStack) {
      PlayerEntity playerentity = this.getCameraPlayer();
      if (playerentity != null) {
         ...
         for(int l3 = 0; l3 < 10; ++l3) {
            if (j3 > 0) {
               int i4 = i1 + l3 * 8;
               if (l3 * 2 + 1 < j3) {
                  this.blit(pMatrixStack, i4, k2, 34, 9, 9, 9);
               }

               if (l3 * 2 + 1 == j3) {
                  this.blit(pMatrixStack, i4, k2, 25, 9, 9, 9);
               }

               if (l3 * 2 + 1 > j3) {
                  this.blit(pMatrixStack, i4, k2, 16, 9, 9, 9);
               }
            }
         }
         ...
         for(int l5 = MathHelper.ceil((f + (float)l1) / 2.0F) - 1; l5 >= 0; --l5) {
            ...
            this.blit(pMatrixStack, l4, i5, 16 + j4 * 9, 9 * j5, 9, 9);
            if (flag) {
               if (l5 * 2 + 1 < k) {
                  this.blit(pMatrixStack, l4, i5, i6 + 54, 9 * j5, 9, 9);
               }

               if (l5 * 2 + 1 == k) {
                  this.blit(pMatrixStack, l4, i5, i6 + 63, 9 * j5, 9, 9);
               }
            }

            if (i3 > 0) {
               if (i3 == l1 && l1 % 2 == 1) {
                  this.blit(pMatrixStack, l4, i5, i6 + 153, 9 * j5, 9, 9);
                  --i3;
               } else {
                  this.blit(pMatrixStack, l4, i5, i6 + 144, 9 * j5, 9, 9);
                  i3 -= 2;
               }
            } else {
               if (l5 * 2 + 1 < i) {
                  this.blit(pMatrixStack, l4, i5, i6 + 36, 9 * j5, 9, 9);
               }

               if (l5 * 2 + 1 == i) {
                  this.blit(pMatrixStack, l4, i5, i6 + 45, 9 * j5, 9, 9);
               }
            }
         }
         ...
         if (j6 == 0) {
            ...
            for(int k6 = 0; k6 < 10; ++k6) {
               ...
               int k8 = j1 - k6 * 8 - 9;
               this.blit(pMatrixStack, k8, i7, 16 + i8 * 9, 27, 9, 9);
               if (k6 * 2 + 1 < l) {
                  this.blit(pMatrixStack, k8, i7, k7 + 36, 27, 9, 9);
               }

               if (k6 * 2 + 1 == l) {
                  this.blit(pMatrixStack, k8, i7, k7 + 45, 27, 9, 9);
               }
            }
         ...
         if (playerentity.isEyeInFluid(FluidTags.WATER) || j7 < l6) {
            ...
            for(int k5 = 0; k5 < j8 + l8; ++k5) {
               if (k5 < j8) {
                  this.blit(pMatrixStack, j1 - k5 * 8 - 9, l2, 16, 18, 9, 9);
               } else {
                  this.blit(pMatrixStack, j1 - k5 * 8 - 9, l2, 25, 18, 9, 9);
               }
            }
         }
   ...
   private void renderVehicleHealth(MatrixStack pMatrixStack) {
      LivingEntity livingentity = this.getPlayerVehicleWithHealth();
   ...
   private void updateVignetteBrightness(Entity pEntity) {
      if (pEntity != null) {
         float f = MathHelper.clamp(1.0F - pEntity.getBrightness(), 0.0F, 1.0F);
         this.vignetteBrightness = (float)((double)this.vignetteBrightness + (double)(f - this.vignetteBrightness) * 0.01D);
      }
   }

   protected void renderVignette(Entity pEntity) {
   ...
   protected void renderPortalOverlay(float pTimeInPortal) {
      ...
      RenderSystem.depthMask(false);
      RenderSystem.defaultBlendFunc();
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, pTimeInPortal);
   ...
   public void setOverlayMessage(ITextComponent pComponent, boolean pAnimateColor) {
