...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry> {
   ...
   protected void moveSelection(AbstractList.Ordering pOrdering) {
      this.moveSelection(pOrdering, (p_241612_0_) -> {
   ...
   public class NormalEntry extends ServerSelectionList.Entry {
      ...
      public void render(MatrixStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks) {
         ...
         List<IReorderingProcessor> list = this.minecraft.font.split(this.serverData.motd, pWidth - 32 - 2);
         ...
         this.minecraft.font.draw(pMatrixStack, itextcomponent1, (float)(pLeft + pWidth - j - 15 - 2), (float)(pTop + 1), 8421504);
         int k = 0;
         int l;
         ...
         AbstractGui.blit(pMatrixStack, pLeft + pWidth - 15, pTop, (float)(k * 10), (float)(176 + l * 8), 10, 8, 256, 256);
         ...
         net.minecraftforge.fml.client.ClientHooks.drawForgePingInfo(this.screen, serverData, pMatrixStack, pLeft, pTop, pWidth, i1, j1);
