...
public class EditGamerulesScreen extends Screen {
   ...
   public class GamerulesList extends AbstractOptionList<EditGamerulesScreen.Gamerule> {
      public GamerulesList(final GameRules p_i232316_2_) {
         ...
         GameRules.visitGameRuleTypes(new GameRules.IRuleEntryVisitor() {
            public void visitBoolean(GameRules.RuleKey<GameRules.BooleanValue> pKey, GameRules.RuleType<GameRules.BooleanValue> pType) {
               this.addEntry(pKey, (p_239012_1_, p_239012_2_, p_239012_3_, p_239012_4_) -> {
                  return EditGamerulesScreen.this.new BooleanEntry(p_239012_1_, p_239012_2_, p_239012_3_, p_239012_4_);
               });
            }

            public void visitInteger(GameRules.RuleKey<GameRules.IntegerValue> pKey, GameRules.RuleType<GameRules.IntegerValue> pType) {
               this.addEntry(pKey, (p_239013_1_, p_239013_2_, p_239013_3_, p_239013_4_) -> {
      ...
      public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
         ...
         if (this.isMouseOver((double)pMouseX, (double)pMouseY)) {
            EditGamerulesScreen.Gamerule editgamerulesscreen$gamerule = this.getEntryAtPosition((double)pMouseX, (double)pMouseY);
   ...
   public class NameEntry extends EditGamerulesScreen.Gamerule {
      ...
      public void render(MatrixStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks) {
         AbstractGui.drawCenteredString(pMatrixStack, EditGamerulesScreen.this.minecraft.font, this.label, pLeft + pWidth / 2, pTop + 5, 16777215);
      }
