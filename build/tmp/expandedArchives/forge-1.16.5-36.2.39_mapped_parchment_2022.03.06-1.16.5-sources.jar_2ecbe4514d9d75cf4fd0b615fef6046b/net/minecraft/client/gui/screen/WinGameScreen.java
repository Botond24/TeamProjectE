...
public class WinGameScreen extends Screen {
   ...
   public WinGameScreen(boolean pPoem, Runnable pOnFinished) {
   ...
   private void renderBg(int pX, int pY, float pPartialTick) {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      this.renderBg(pMouseX, pMouseY, pPartialTicks);
      int i = 274;
      ...
      this.blitOutlineBlack(j, k, (p_238665_2_, p_238665_3_) -> {
         this.blit(pMatrixStack, p_238665_2_ + 0, p_238665_3_, 0, 0, 155, 44);
         this.blit(pMatrixStack, p_238665_2_ + 155, p_238665_3_, 0, 45, 155, 44);
      });
      RenderSystem.disableBlend();
      this.minecraft.getTextureManager().bind(EDITION_LOCATION);
      blit(pMatrixStack, j + 88, k + 37, 0.0F, 0.0F, 98, 14, 128, 16);
      ...
      for(int i1 = 0; i1 < this.lines.size(); ++i1) {
         ...
         if ((float)l + f + 12.0F + 8.0F > 0.0F && (float)l + f < (float)this.height) {
            ...
            if (this.centeredLines.contains(i1)) {
               this.font.drawShadow(pMatrixStack, ireorderingprocessor, (float)(j + (274 - this.font.width(ireorderingprocessor)) / 2), (float)l, 16777215);
            } else {
               this.font.random.setSeed((long)((float)((long)i1 * 4238972211L) + this.time / 4.0F));
               this.font.drawShadow(pMatrixStack, ireorderingprocessor, (float)j, (float)l, 16777215);
            }
         }
