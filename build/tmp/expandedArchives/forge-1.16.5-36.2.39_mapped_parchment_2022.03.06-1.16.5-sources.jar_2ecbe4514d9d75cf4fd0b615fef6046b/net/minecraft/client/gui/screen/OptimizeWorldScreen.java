...
public class OptimizeWorldScreen extends Screen {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      if (this.upgrader.getTotalChunks() > 0) {
         ...
         drawString(pMatrixStack, this.font, new TranslationTextComponent("optimizeWorld.info.converted", this.upgrader.getConverted()), i, 40, 10526880);
         drawString(pMatrixStack, this.font, new TranslationTextComponent("optimizeWorld.info.skipped", this.upgrader.getSkipped()), i, 40 + 9 + 3, 10526880);
         drawString(pMatrixStack, this.font, new TranslationTextComponent("optimizeWorld.info.total", this.upgrader.getTotalChunks()), i, 40 + (9 + 3) * 2, 10526880);
         int i1 = 0;
         ...
         for(RegistryKey<World> registrykey : this.upgrader.levels()) {
            ...
            fill(pMatrixStack, i + i1, k, i + i1 + j1, l, DIMENSION_COLORS.getInt(registrykey));
            i1 += j1;
         }
         ...
         drawCenteredString(pMatrixStack, this.font, MathHelper.floor(this.upgrader.getProgress() * 100.0F) + "%", this.width / 2, k + (l - k) / 2 - 9 / 2, 10526880);
      }
