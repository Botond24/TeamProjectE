   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      if (!this.checkToClose()) {
         ...
         this.currentlyHovered.ifPresent((p_238712_2_) -> {
            drawCenteredString(pMatrixStack, this.font, p_238712_2_.getName(), this.width / 2, this.height / 2 - 30 - 20, -1);
         });
         ...
         for(GamemodeSelectionScreen.SelectorWidget gamemodeselectionscreen$selectorwidget : this.slots) {
            gamemodeselectionscreen$selectorwidget.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
