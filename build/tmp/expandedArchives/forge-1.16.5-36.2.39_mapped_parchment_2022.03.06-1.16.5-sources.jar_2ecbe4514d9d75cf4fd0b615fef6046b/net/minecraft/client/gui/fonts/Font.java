...
public class Font implements AutoCloseable {
   ...
   public void reload(List<IGlyphProvider> pGlyphProviders) {
      this.closeProviders();
      this.closeTextures();
      this.glyphs.clear();
   ...
   private TexturedGlyph stitch(IGlyphInfo pGlyphInfo) {
      for(FontTexture fonttexture : this.textures) {
         TexturedGlyph texturedglyph = fonttexture.add(pGlyphInfo);
      ...
      TexturedGlyph texturedglyph1 = fonttexture1.add(pGlyphInfo);
      return texturedglyph1 == null ? this.missingGlyph : texturedglyph1;
   }

   public TexturedGlyph getRandomGlyph(IGlyph pGlyph) {
      IntList intlist = this.glyphsByWidth.get(MathHelper.ceil(pGlyph.getAdvance(false)));
