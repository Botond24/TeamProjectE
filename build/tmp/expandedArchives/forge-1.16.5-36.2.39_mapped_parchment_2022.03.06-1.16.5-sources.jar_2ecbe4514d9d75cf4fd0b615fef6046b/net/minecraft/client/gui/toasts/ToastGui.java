...
public class ToastGui extends AbstractGui {
   ...
   public ToastGui(Minecraft pMinecraft) {
   ...
   public void addToast(IToast pToast) {
   ...
   class ToastInstance<T extends IToast> {
      ...
      private ToastInstance(T pToast) {
         this.toast = pToast;
      }
      ...
      public boolean render(int p_193684_1_, int p_193684_2_, MatrixStack pPoseStack) {
         ...
         IToast.Visibility itoast$visibility = this.toast.render(pPoseStack, ToastGui.this, i - this.visibleTime);
