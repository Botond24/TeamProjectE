...
public class RecipeOverlayGui extends AbstractGui implements IRenderable, IGuiEventListener {
   ...
   public boolean mouseClicked(double pMouseX, double pMouseY, int pButton) {
      if (pButton != 0) {
         ...
         for(RecipeOverlayGui.RecipeButtonWidget recipeoverlaygui$recipebuttonwidget : this.recipeButtons) {
            if (recipeoverlaygui$recipebuttonwidget.mouseClicked(pMouseX, pMouseY, pButton)) {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      if (this.isVisible) {
         ...
         for(RecipeOverlayGui.RecipeButtonWidget recipeoverlaygui$recipebuttonwidget : this.recipeButtons) {
            recipeoverlaygui$recipebuttonwidget.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
         }
   ...
   class RecipeButtonWidget extends Widget implements IRecipePlacer<Ingredient> {
      ...
      public void addItemToSlot(Iterator<Ingredient> pIngredients, int pSlot, int pMaxAmount, int pY, int pX) {
         ...
         if (aitemstack.length != 0) {
            this.ingredientPos.add(new RecipeOverlayGui.RecipeButtonWidget.Child(3 + pX * 7, 3 + pY * 7, aitemstack));
         }
