...
public class WorldLoadProgressScreen extends Screen {
   ...
   public WorldLoadProgressScreen(TrackingChunkStatusListener pProgressListener) {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      drawCenteredString(pMatrixStack, this.font, s, j, k - 9 / 2 - 30, 16777215);
   }

   public static void renderChunks(MatrixStack pPoseStack, TrackingChunkStatusListener pProgressListener, int p_238625_2_, int p_238625_3_, int p_238625_4_, int p_238625_5_) {
      ...
      int i2 = -16772609;
      if (p_238625_5_ != 0) {
         fill(pPoseStack, p_238625_2_ - l1, p_238625_3_ - l1, p_238625_2_ - l1 + 1, p_238625_3_ + l1, -16772609);
         fill(pPoseStack, p_238625_2_ + l1 - 1, p_238625_3_ - l1, p_238625_2_ + l1, p_238625_3_ + l1, -16772609);
         fill(pPoseStack, p_238625_2_ - l1, p_238625_3_ - l1, p_238625_2_ + l1, p_238625_3_ - l1 + 1, -16772609);
         fill(pPoseStack, p_238625_2_ - l1, p_238625_3_ + l1 - 1, p_238625_2_ + l1, p_238625_3_ + l1, -16772609);
      }
      ...
      for(int j2 = 0; j2 < l; ++j2) {
         for(int k2 = 0; k2 < l; ++k2) {
            ...
            int l2 = j1 + j2 * i;
            int i3 = k1 + k2 * i;
            fill(pPoseStack, l2, i3, l2 + p_238625_4_, i3 + p_238625_4_, COLORS.getInt(chunkstatus) | -16777216);
         }
      }
