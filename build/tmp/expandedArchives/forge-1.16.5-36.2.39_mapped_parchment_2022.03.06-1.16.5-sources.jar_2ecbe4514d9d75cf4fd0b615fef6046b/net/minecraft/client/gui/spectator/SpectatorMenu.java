...
public class SpectatorMenu {
   ...
   public void selectSlot(int pSlot) {
      ISpectatorMenuObject ispectatormenuobject = this.getItem(pSlot);
      if (ispectatormenuobject != EMPTY_SLOT) {
         if (this.selectedSlot == pSlot && ispectatormenuobject.isEnabled()) {
   ...
   public void selectCategory(ISpectatorMenuView pMenuView) {
