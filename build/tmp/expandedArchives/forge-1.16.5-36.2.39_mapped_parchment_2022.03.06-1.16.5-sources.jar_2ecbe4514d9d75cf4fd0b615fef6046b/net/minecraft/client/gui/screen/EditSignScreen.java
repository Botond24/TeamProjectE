...
public class EditSignScreen extends Screen {
   ...
   public void render(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks) {
      ...
      this.signModel.sign.render(pMatrixStack, ivertexbuilder, 15728880, OverlayTexture.NO_OVERLAY);
      if (flag) {
         this.signModel.stick.render(pMatrixStack, ivertexbuilder, 15728880, OverlayTexture.NO_OVERLAY);
      }
