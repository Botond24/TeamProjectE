...
public class UnicodeTextureGlyphProvider implements IGlyphProvider {
   ...
   @Nullable
   public IGlyphInfo getGlyph(int pCharacter) {
      if (pCharacter >= 0 && pCharacter <= 65535) {
         ...
         if (b0 != 0) {
            ...
            if (nativeimage != null) {
               int i = getLeft(b0);
               return new UnicodeTextureGlyphProvider.GlpyhInfo(pCharacter % 16 * 16 + i, (pCharacter & 255) / 16 * 16, getRight(b0) - i, 16, nativeimage);
            }
         }
   ...
   public static class Factory implements IGlyphProviderFactory {
      ...
      public IGlyphProvider create(IResourceManager pResourceManager) {
         try (IResource iresource = Minecraft.getInstance().getResourceManager().getResource(this.metadata)) {
            ...
            return new UnicodeTextureGlyphProvider(pResourceManager, abyte, this.texturePattern);
         } catch (IOException ioexception) {
