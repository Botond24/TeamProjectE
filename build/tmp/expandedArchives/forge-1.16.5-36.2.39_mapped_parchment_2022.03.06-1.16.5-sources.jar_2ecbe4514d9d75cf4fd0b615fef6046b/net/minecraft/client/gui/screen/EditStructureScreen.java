...
public class EditStructureScreen extends Screen {
   ...
   public EditStructureScreen(StructureBlockTileEntity pStructureBlockEntity) {
      super(new TranslationTextComponent(Blocks.STRUCTURE_BLOCK.getDescriptionId()));
      this.structure = pStructureBlockEntity;
   ...
   protected void init() {
      ...
      this.nameEdit = new TextFieldWidget(this.font, this.width / 2 - 152, 40, 300, 20, new TranslationTextComponent("structure_block.structure_name")) {
         public boolean charTyped(char pCodePoint, int pModifiers) {
            return !EditStructureScreen.this.isValidCharacterForName(this.getValue(), pCodePoint, this.getCursorPosition()) ? false : super.charTyped(pCodePoint, pModifiers);
         }
      };
   ...
   private boolean sendToServer(StructureBlockTileEntity.UpdateCommand pUpdateType) {
