...
public class NewChatGui extends AbstractGui {
   ...
   public NewChatGui(Minecraft pMinecraft) {
      this.minecraft = pMinecraft;
   }

   public void render(MatrixStack pPoseStack, int p_238492_2_) {
      if (!this.isChatHidden()) {
         ...
         if (j > 0) {
               ...
               if (chatline != null) {
                  ...
                  if (j1 < 200 || flag) {
                     ...
                     if (l1 > 3) {
                        ...
                        fill(pPoseStack, -2, (int)(d6 - d3), 0 + k + 4, (int)d6, i2 << 24);
                        RenderSystem.enableBlend();
                        pPoseStack.translate(0.0D, 0.0D, 50.0D);
                        this.minecraft.font.drawShadow(pPoseStack, chatline.getMessage(), 0.0F, (float)((int)(d6 + d4)), 16777215 + (l1 << 24));
            ...
            if (!this.chatQueue.isEmpty()) {
               ...
               RenderSystem.enableBlend();
               pPoseStack.translate(0.0D, 0.0D, 50.0D);
               this.minecraft.font.drawShadow(pPoseStack, new TranslationTextComponent("chat.queue", this.chatQueue.size()), 0.0F, 1.0F, 16777215 + (k2 << 24));
               pPoseStack.popPose();
               RenderSystem.disableAlphaTest();
               RenderSystem.disableBlend();
            }
   ...
   public void addMessage(ITextComponent pChatComponent) {
    ...
    */
   private void addMessage(ITextComponent pChatComponent, int pChatLineId) {
   ...
   private void addMessage(ITextComponent pMessage, int p_238493_2_, int p_238493_3_, boolean p_238493_4_) {
      if (p_238493_2_ != 0) {
         this.removeById(p_238493_2_);
      }

      int i = MathHelper.floor((double)this.getWidth() / this.getScale());
      List<IReorderingProcessor> list = RenderComponentsUtil.wrapComponents(pMessage, i, this.minecraft.font);
      ...
      if (!p_238493_4_) {
         this.allMessages.add(0, new ChatLine<>(p_238493_3_, pMessage, p_238493_2_));
   ...
   private void removeById(int pId) {
      this.trimmedMessages.removeIf((p_243251_1_) -> {
         return p_243251_1_.getId() == pId;
      });
      this.allMessages.removeIf((p_243250_1_) -> {
         return p_243250_1_.getId() == pId;
      });
   }
   ...
   public void enqueueMessage(ITextComponent pMessage) {
