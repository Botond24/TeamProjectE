...
public class OptionsScreen extends Screen {
   ...
   public OptionsScreen(Screen pLastScreen, GameSettings pOptions) {
   ...
   private ITextComponent getDifficultyText(Difficulty pDifficulty) {
      return (new TranslationTextComponent("options.difficulty")).append(": ").append(pDifficulty.getDisplayName());
   }
