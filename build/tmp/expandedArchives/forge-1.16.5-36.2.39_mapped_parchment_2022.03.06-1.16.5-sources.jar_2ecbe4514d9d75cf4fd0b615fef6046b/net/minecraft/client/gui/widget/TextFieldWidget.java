...
public class TextFieldWidget extends Widget implements IRenderable, IGuiEventListener {
   ...
   public TextFieldWidget(FontRenderer pFont, int pX, int pY, int pWidth, int pHeight, ITextComponent pMessage) {
      this(pFont, pX, pY, pWidth, pHeight, (TextFieldWidget)null, pMessage);
   }

   public TextFieldWidget(FontRenderer pFont, int pX, int pY, int pWidth, int pHeight, @Nullable TextFieldWidget p_i232259_6_, ITextComponent pMessage) {
