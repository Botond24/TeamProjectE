...
public class ResourceIndex {
   ...
   public ResourceIndex(File pFile, String p_i1047_2_) {
      File file1 = new File(pFile, "objects");
      File file2 = new File(pFile, "indexes/" + p_i1047_2_ + ".json");
   ...
   public File getRootFile(String pChild) {
      return this.rootFiles.get(pChild);
   }
   ...
   public Collection<ResourceLocation> getFiles(String p_225639_1_, String p_225639_2_, int p_225639_3_, Predicate<String> pNamePredicate) {
      return this.namespacedFiles.keySet().stream().filter((p_229273_3_) -> {
         ...
         return p_229273_3_.getNamespace().equals(p_225639_2_) && !s.endsWith(".mcmeta") && s.startsWith(p_225639_1_ + "/") && pNamePredicate.test(s);
