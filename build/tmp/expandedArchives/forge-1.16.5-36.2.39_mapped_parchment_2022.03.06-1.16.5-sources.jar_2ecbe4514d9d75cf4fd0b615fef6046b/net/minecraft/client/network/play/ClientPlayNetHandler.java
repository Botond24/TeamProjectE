...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
    ...
    */
   public void handleLogin(SJoinGamePacket pPacket) {
      ...
      ArrayList<RegistryKey<World>> arraylist = Lists.newArrayList(pPacket.levels());
      Collections.shuffle(arraylist);
      this.levels = Sets.newLinkedHashSet(arraylist);
      this.registryAccess = pPacket.registryAccess();
      RegistryKey<World> registrykey = pPacket.getDimension();
      ...
      ClientWorld.ClientWorldInfo clientworld$clientworldinfo = new ClientWorld.ClientWorldInfo(Difficulty.NORMAL, pPacket.isHardcore(), flag1);
      this.levelData = clientworld$clientworldinfo;
      this.level = new ClientWorld(this, clientworld$clientworldinfo, registrykey, dimensiontype, this.serverChunkRadius, this.minecraft::getProfiler, this.minecraft.levelRenderer, flag, pPacket.getSeed());
      ...
      this.minecraft.gameMode.setLocalMode(pPacket.getGameType());
      this.minecraft.gameMode.setPreviousLocalMode(pPacket.getPreviousGameType());
    ...
    */
   public void handleAddEntity(SSpawnObjectPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      ...
      if (entitytype == EntityType.CHEST_MINECART) {
         ...
         Entity entity1 = this.level.getEntity(pPacket.getData());
         ...
         Entity entity2 = this.level.getEntity(pPacket.getData());
         if (entity2 != null) {
         ...
         Entity entity3 = this.level.getEntity(pPacket.getData());
         if (entity3 != null) {
         ...
         Entity entity4 = this.level.getEntity(pPacket.getData());
         if (entity4 != null) {
         ...
         entity = new LlamaSpitEntity(this.level, d0, d1, d2, pPacket.getXa(), pPacket.getYa(), pPacket.getZa());
      } else if (entitytype == EntityType.ITEM_FRAME) {
         entity = new ItemFrameEntity(this.level, new BlockPos(d0, d1, d2), Direction.from3DDataValue(pPacket.getData()));
         ...
         entity = new FireballEntity(this.level, d0, d1, d2, pPacket.getXa(), pPacket.getYa(), pPacket.getZa());
      } else if (entitytype == EntityType.DRAGON_FIREBALL) {
         entity = new DragonFireballEntity(this.level, d0, d1, d2, pPacket.getXa(), pPacket.getYa(), pPacket.getZa());
      } else if (entitytype == EntityType.SMALL_FIREBALL) {
         entity = new SmallFireballEntity(this.level, d0, d1, d2, pPacket.getXa(), pPacket.getYa(), pPacket.getZa());
      } else if (entitytype == EntityType.WITHER_SKULL) {
         entity = new WitherSkullEntity(this.level, d0, d1, d2, pPacket.getXa(), pPacket.getYa(), pPacket.getZa());
      } else if (entitytype == EntityType.SHULKER_BULLET) {
         entity = new ShulkerBulletEntity(this.level, d0, d1, d2, pPacket.getXa(), pPacket.getYa(), pPacket.getZa());
         ...
         entity = new FallingBlockEntity(this.level, d0, d1, d2, Block.stateById(pPacket.getData()));
      ...
      if (entity != null) {
         ...
         entity.xRot = (float)(pPacket.getxRot() * 360) / 256.0F;
         entity.yRot = (float)(pPacket.getyRot() * 360) / 256.0F;
         entity.setId(i);
         entity.setUUID(pPacket.getUUID());
    ...
    */
   public void handleAddExperienceOrb(SSpawnExperienceOrbPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      double d0 = pPacket.getX();
      double d1 = pPacket.getY();
      double d2 = pPacket.getZ();
      Entity entity = new ExperienceOrbEntity(this.level, d0, d1, d2, pPacket.getValue());
      entity.setPacketCoordinates(d0, d1, d2);
      entity.yRot = 0.0F;
      entity.xRot = 0.0F;
    ...
    */
   public void handleAddPainting(SSpawnPaintingPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      PaintingEntity paintingentity = new PaintingEntity(this.level, pPacket.getPos(), pPacket.getDirection(), pPacket.getMotive());
      paintingentity.setId(pPacket.getId());
      paintingentity.setUUID(pPacket.getUUID());
      this.level.putNonPlayerEntity(pPacket.getId(), paintingentity);
   }

   /**
    * Sets the velocity of the specified entity to the specified value
    */
   public void handleSetEntityMotion(SEntityVelocityPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleSetEntityData(SEntityMetadataPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = this.level.getEntity(pPacket.getId());
    ...
    */
   public void handleAddPlayer(SSpawnPlayerPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      double d0 = pPacket.getX();
      double d1 = pPacket.getY();
      double d2 = pPacket.getZ();
      ...
      RemoteClientPlayerEntity remoteclientplayerentity = new RemoteClientPlayerEntity(this.minecraft.level, this.getPlayerInfo(pPacket.getPlayerId()).getProfile());
    ...
    */
   public void handleTeleportEntity(SEntityTeleportPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = this.level.getEntity(pPacket.getId());
      if (entity != null) {
         double d0 = pPacket.getX();
    ...
    */
   public void handleSetCarriedItem(SHeldItemChangePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      if (PlayerInventory.isHotbarSlot(pPacket.getSlot())) {
         this.minecraft.player.inventory.selected = pPacket.getSlot();
      }
    ...
    * rotation or both).
    */
   public void handleMoveEntity(SEntityPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = pPacket.getEntity(this.level);
      if (entity != null) {
         if (!entity.isControlledByLocalInstance()) {
            if (pPacket.hasPosition()) {
               Vector3d vector3d = pPacket.updateEntityPosition(entity.getPacketCoordinates());
               entity.setPacketCoordinates(vector3d);
               float f = pPacket.hasRotation() ? (float)(pPacket.getyRot() * 360) / 256.0F : entity.yRot;
               float f1 = pPacket.hasRotation() ? (float)(pPacket.getxRot() * 360) / 256.0F : entity.xRot;
    ...
    */
   public void handleRotateMob(SEntityHeadLookPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = pPacket.getEntity(this.level);
      if (entity != null) {
   ...
   public void handleMovePlayer(SPlayerPositionLookPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      PlayerEntity playerentity = this.minecraft.player;
      Vector3d vector3d = playerentity.getDeltaMovement();
      boolean flag = pPacket.getRelativeArguments().contains(SPlayerPositionLookPacket.Flags.X);
      boolean flag1 = pPacket.getRelativeArguments().contains(SPlayerPositionLookPacket.Flags.Y);
      boolean flag2 = pPacket.getRelativeArguments().contains(SPlayerPositionLookPacket.Flags.Z);
      double d0;
      double d1;
      if (flag) {
         d0 = vector3d.x();
         d1 = playerentity.getX() + pPacket.getX();
         playerentity.xOld += pPacket.getX();
      } else {
         d0 = 0.0D;
         d1 = pPacket.getX();
      ...
      if (flag1) {
         d2 = vector3d.y();
         d3 = playerentity.getY() + pPacket.getY();
         playerentity.yOld += pPacket.getY();
      } else {
         d2 = 0.0D;
         d3 = pPacket.getY();
      ...
      if (flag2) {
         d4 = vector3d.z();
         d5 = playerentity.getZ() + pPacket.getZ();
         playerentity.zOld += pPacket.getZ();
      } else {
         d4 = 0.0D;
         d5 = pPacket.getZ();
      ...
      if (pPacket.getRelativeArguments().contains(SPlayerPositionLookPacket.Flags.X_ROT)) {
         f1 += playerentity.xRot;
      }

      if (pPacket.getRelativeArguments().contains(SPlayerPositionLookPacket.Flags.Y_ROT)) {
         f += playerentity.yRot;
      }

      playerentity.absMoveTo(d1, d3, d5, f, f1);
      this.connection.send(new CConfirmTeleportPacket(pPacket.getId()));
    ...
    * S21PacketChunkData
    */
   public void handleChunkBlocksUpdate(SMultiBlockChangePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleLevelChunk(SChunkDataPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      int i = pPacket.getX();
      int j = pPacket.getZ();
   ...
   public void handleForgetLevelChunk(SUnloadChunkPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      int i = pPacket.getX();
      int j = pPacket.getZ();
    ...
    */
   public void handleBlockUpdate(SChangeBlockPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleDisconnect(SDisconnectPacket pPacket) {
   ...
   public void onDisconnect(ITextComponent pReason) {
      ...
      if (this.callbackScreen != null) {
         ...
         this.minecraft.setScreen(new DisconnectedScreen(new MultiplayerScreen(new MainMenuScreen()), GENERIC_DISCONNECT_MESSAGE, pReason));
      }
   ...
   public void handleTakeItemEntity(SCollectItemPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      ...
      if (entity != null) {
         ...
         if (entity instanceof ItemEntity) {
            ...
            if (itemstack.isEmpty()) {
               this.level.removeEntity(pPacket.getItemId());
            }
         } else {
            this.level.removeEntity(pPacket.getItemId());
         }
    ...
    */
   public void handleChat(SChatPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      net.minecraft.util.text.ITextComponent message = net.minecraftforge.event.ForgeEventFactory.onClientChat(pPacket.getType(), pPacket.getMessage(), pPacket.getSender());
    ...
    */
   public void handleAnimate(SAnimateHandPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = this.level.getEntity(pPacket.getId());
      if (entity != null) {
    ...
    */
   public void handleAddMob(SSpawnMobPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      double d0 = pPacket.getX();
      double d1 = pPacket.getY();
      double d2 = pPacket.getZ();
      float f = (float)(pPacket.getyRot() * 360) / 256.0F;
      float f1 = (float)(pPacket.getxRot() * 360) / 256.0F;
      LivingEntity livingentity = (LivingEntity)EntityType.create(pPacket.getType(), this.minecraft.level);
      if (livingentity != null) {
         livingentity.setPacketCoordinates(d0, d1, d2);
         livingentity.yBodyRot = (float)(pPacket.getyHeadRot() * 360) / 256.0F;
         livingentity.yHeadRot = (float)(pPacket.getyHeadRot() * 360) / 256.0F;
         ...
         if (livingentity instanceof EnderDragonEntity) {
            ...
            for(int i = 0; i < aenderdragonpartentity.length; ++i) {
               aenderdragonpartentity[i].setId(i + pPacket.getId());
            }
         }

         livingentity.setId(pPacket.getId());
         livingentity.setUUID(pPacket.getUUID());
         livingentity.absMoveTo(d0, d1, d2, f, f1);
         livingentity.setDeltaMovement((double)((float)pPacket.getXd() / 8000.0F), (double)((float)pPacket.getYd() / 8000.0F), (double)((float)pPacket.getZd() / 8000.0F));
   ...
   public void handleSetTime(SUpdateTimePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.minecraft.level.setGameTime(pPacket.getGameTime());
      this.minecraft.level.setDayTime(pPacket.getDayTime());
   }

   public void handleSetSpawn(SWorldSpawnChangedPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.minecraft.level.setDefaultSpawnPos(pPacket.getPos(), pPacket.getAngle());
   }

   public void handleSetEntityPassengersPacket(SSetPassengersPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleEntityLinkPacket(SMountEntityPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = this.level.getEntity(pPacket.getSourceId());
      if (entity instanceof MobEntity) {
         ((MobEntity)entity).setDelayedLeashHolderId(pPacket.getDestId());
      }

   }

   private static ItemStack findTotem(PlayerEntity pPlayer) {
    ...
    */
   public void handleEntityEvent(SEntityStatusPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = pPacket.getEntity(this.level);
      if (entity != null) {
   ...
   public void handleSetHealth(SUpdateHealthPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleSetExperience(SSetExperiencePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleRespawn(SRespawnPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      RegistryKey<World> registrykey = pPacket.getDimension();
      DimensionType dimensiontype = pPacket.getDimensionType();
      ...
      this.minecraft.gameMode.setLocalMode(pPacket.getPlayerGameType());
      this.minecraft.gameMode.setPreviousLocalMode(pPacket.getPreviousPlayerGameType());
   }

   /**
    * Initiates a new explosion (sound, particles, drop spawn) for the affected blocks indicated by the packet.
    */
   public void handleExplosion(SExplosionPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleHorseScreenOpen(SOpenHorseWindowPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      ...
      if (entity instanceof AbstractHorseEntity) {
         ...
         Inventory inventory = new Inventory(pPacket.getSize());
         HorseInventoryContainer horseinventorycontainer = new HorseInventoryContainer(pPacket.getContainerId(), clientplayerentity.inventory, inventory, abstracthorseentity);
   ...
   public void handleOpenScreen(SOpenWindowPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      ScreenManager.create(pPacket.getType(), this.minecraft, pPacket.getContainerId(), pPacket.getTitle());
   }

   /**
    * Handles pickin up an ItemStack or dropping one in your inventory or an open (non-creative) container
    */
   public void handleContainerSetSlot(SSetSlotPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      PlayerEntity playerentity = this.minecraft.player;
      ...
      if (pPacket.getContainerId() == -1) {
         ...
         if (pPacket.getContainerId() == 0 && pPacket.getSlot() >= 36 && i < 45) {
            if (!itemstack.isEmpty()) {
         ...
         } else if (pPacket.getContainerId() == playerentity.containerMenu.containerId && (pPacket.getContainerId() != 0 || !flag)) {
    ...
    */
   public void handleContainerContent(SWindowItemsPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      PlayerEntity playerentity = this.minecraft.player;
      if (pPacket.getContainerId() == 0) {
         playerentity.inventoryMenu.setAll(pPacket.getItems());
      } else if (pPacket.getContainerId() == playerentity.containerMenu.containerId) {
         playerentity.containerMenu.setAll(pPacket.getItems());
      }
    ...
    */
   public void handleOpenSignEditor(SOpenSignMenuPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      TileEntity tileentity = this.level.getBlockEntity(pPacket.getPos());
      if (!(tileentity instanceof SignTileEntity)) {
         tileentity = new SignTileEntity();
         tileentity.setLevelAndPosition(this.level, pPacket.getPos());
      }
    ...
    */
   public void handleBlockEntityData(SUpdateTileEntityPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      ...
      if (i == 1 && tileentity instanceof MobSpawnerTileEntity || flag || i == 3 && tileentity instanceof BeaconTileEntity || i == 4 && tileentity instanceof SkullTileEntity || i == 6 && tileentity instanceof BannerTileEntity || i == 7 && tileentity instanceof StructureBlockTileEntity || i == 8 && tileentity instanceof EndGatewayTileEntity || i == 9 && tileentity instanceof SignTileEntity || i == 11 && tileentity instanceof BedTileEntity || i == 5 && tileentity instanceof ConduitTileEntity || i == 12 && tileentity instanceof JigsawTileEntity || i == 13 && tileentity instanceof CampfireTileEntity || i == 14 && tileentity instanceof BeehiveTileEntity) {
         tileentity.load(this.minecraft.level.getBlockState(blockpos), pPacket.getTag());
      }
      ...
      if (flag && this.minecraft.screen instanceof CommandBlockScreen) {
         ...
         tileentity.onDataPacket(connection, pPacket);
      }
    ...
    */
   public void handleContainerSetData(SWindowPropertyPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      PlayerEntity playerentity = this.minecraft.player;
      if (playerentity.containerMenu != null && playerentity.containerMenu.containerId == pPacket.getContainerId()) {
         playerentity.containerMenu.setData(pPacket.getId(), pPacket.getValue());
      }

   }

   public void handleSetEquipment(SEntityEquipmentPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleContainerClose(SCloseWindowPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleBlockEvent(SBlockActionPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleBlockDestruction(SAnimateBlockBreakPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.minecraft.level.destroyBlockProgress(pPacket.getId(), pPacket.getPos(), pPacket.getProgress());
   }

   public void handleGameEvent(SChangeGameStatePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      PlayerEntity playerentity = this.minecraft.player;
      SChangeGameStatePacket.State schangegamestatepacket$state = pPacket.getEvent();
    ...
    */
   public void handleMapItemData(SMapDataPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      MapItemRenderer mapitemrenderer = this.minecraft.gameRenderer.getMapRenderer();
      String s = FilledMapItem.makeKey(pPacket.getMapId());
      ...
      pPacket.applyToMap(mapdata);
      mapitemrenderer.update(mapdata);
   }

   public void handleLevelEvent(SPlaySoundEventPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleUpdateAdvancementsPacket(SAdvancementInfoPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.advancements.update(pPacket);
   }

   public void handleSelectAdvancementsTab(SSelectAdvancementsTabPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleCommands(SCommandListPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.commands = new CommandDispatcher<>(pPacket.getRoot());
   }

   public void handleStopSoundEvent(SStopSoundPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleCommandSuggestions(STabCompletePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.suggestionsProvider.completeCustomSuggestions(pPacket.getId(), pPacket.getSuggestions());
   }

   public void handleUpdateRecipes(SUpdateRecipesPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleLookAt(SPlayerLookPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Vector3d vector3d = pPacket.getPosition(this.level);
      if (vector3d != null) {
         this.minecraft.player.lookAt(pPacket.getFromAnchor(), vector3d);
      }

   }

   public void handleTagQueryPacket(SQueryNBTResponsePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleAwardStats(SStatisticsPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleAddOrRemoveRecipes(SRecipeBookPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      ClientRecipeBook clientrecipebook = this.minecraft.player.getRecipeBook();
      clientrecipebook.setBookSettings(pPacket.getBookSettings());
      SRecipeBookPacket.State srecipebookpacket$state = pPacket.getState();
   ...
   public void handleUpdateMobEffect(SPlayEntityEffectPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = this.level.getEntity(pPacket.getEntityId());
      if (entity instanceof LivingEntity) {
         Effect effect = Effect.byId(pPacket.getEffectId() & 0xFF);
         if (effect != null) {
            EffectInstance effectinstance = new EffectInstance(effect, pPacket.getEffectDurationTicks(), pPacket.getEffectAmplifier(), pPacket.isEffectAmbient(), pPacket.isEffectVisible(), pPacket.effectShowsIcon());
            effectinstance.setNoCounter(pPacket.isSuperLongDuration());
            ((LivingEntity)entity).forceAddEffect(effectinstance);
         }
      }
   }

   public void handleUpdateTags(STagsListPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      ITagCollectionSupplier itagcollectionsupplier = pPacket.getTags();
   ...
   public void handleChangeDifficulty(SServerDifficultyPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.levelData.setDifficulty(pPacket.getDifficulty());
      this.levelData.setDifficultyLocked(pPacket.isLocked());
   }

   public void handleSetCamera(SCameraPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = pPacket.getEntity(this.level);
      if (entity != null) {
   ...
   public void handleTabListCustomisation(SPlayerListHeaderFooterPacket pPacket) {
   ...
   public void handleRemoveMobEffect(SRemoveEntityEffectPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = pPacket.getEntity(this.level);
      if (entity instanceof LivingEntity) {
   ...
   public void handlePlayerInfo(SPlayerListItemPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);

      for(SPlayerListItemPacket.AddPlayerData splayerlistitempacket$addplayerdata : pPacket.getEntries()) {
         if (pPacket.getAction() == SPlayerListItemPacket.Action.REMOVE_PLAYER) {
            ...
            if (pPacket.getAction() == SPlayerListItemPacket.Action.ADD_PLAYER) {
   ...
   public void handleKeepAlive(SKeepAlivePacket pPacket) {
      this.send(new CKeepAlivePacket(pPacket.getId()));
   }

   public void handlePlayerAbilities(SPlayerAbilitiesPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      PlayerEntity playerentity = this.minecraft.player;
      playerentity.abilities.flying = pPacket.isFlying();
      playerentity.abilities.instabuild = pPacket.canInstabuild();
      playerentity.abilities.invulnerable = pPacket.isInvulnerable();
      playerentity.abilities.mayfly = pPacket.canFly();
      playerentity.abilities.setFlyingSpeed(pPacket.getFlyingSpeed());
      playerentity.abilities.setWalkingSpeed(pPacket.getWalkingSpeed());
   }

   public void handleSoundEvent(SPlaySoundEffectPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleSoundEntityEvent(SSpawnMovingSoundEffectPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = this.level.getEntity(pPacket.getId());
      if (entity != null) {
   ...
   public void handleCustomSoundEvent(SPlaySoundPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.minecraft.getSoundManager().play(new SimpleSound(pPacket.getName(), pPacket.getSource(), pPacket.getVolume(), pPacket.getPitch(), false, 0, ISound.AttenuationType.LINEAR, pPacket.getX(), pPacket.getY(), pPacket.getZ(), false));
   }

   public void handleResourcePack(SSendResourcePackPacket pPacket) {
   ...
   private void send(CResourcePackStatusPacket.Action pAction) {
      this.connection.send(new CResourcePackStatusPacket(pAction));
   }

   public void handleBossUpdate(SUpdateBossInfoPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.minecraft.gui.getBossOverlay().update(pPacket);
   }

   public void handleItemCooldown(SCooldownPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleMoveVehicle(SMoveVehiclePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   public void handleOpenBook(SOpenBookWindowPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleCustomPayload(SCustomPayloadPlayPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      ResourceLocation resourcelocation = pPacket.getIdentifier();
      PacketBuffer packetbuffer = null;

      try {
         packetbuffer = pPacket.getData();
    ...
    */
   public void handleAddObjective(SScoreboardObjectivePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Scoreboard scoreboard = this.level.getScoreboard();
      String s = pPacket.getObjectiveName();
      if (pPacket.getMethod() == 0) {
         scoreboard.addObjective(s, ScoreCriteria.DUMMY, pPacket.getDisplayName(), pPacket.getRenderType());
         ...
         if (pPacket.getMethod() == 1) {
            ...
            scoreobjective.setRenderType(pPacket.getRenderType());
            scoreobjective.setDisplayName(pPacket.getDisplayName());
         }
      }
    ...
    */
   public void handleSetScore(SUpdateScorePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Scoreboard scoreboard = this.level.getScoreboard();
      String s = pPacket.getObjectiveName();
      ...
      case CHANGE:
         ...
         Score score = scoreboard.getOrCreatePlayerScore(pPacket.getOwner(), scoreobjective);
    ...
    */
   public void handleSetDisplayObjective(SDisplayObjectivePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Scoreboard scoreboard = this.level.getScoreboard();
      String s = pPacket.getObjectiveName();
      ScoreObjective scoreobjective = s == null ? null : scoreboard.getOrCreateObjective(s);
      scoreboard.setDisplayObjective(pPacket.getSlot(), scoreobjective);
   }
    ...
    */
   public void handleSetPlayerTeamPacket(STeamsPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Scoreboard scoreboard = this.level.getScoreboard();
      ScorePlayerTeam scoreplayerteam;
      if (pPacket.getMethod() == 0) {
         scoreplayerteam = scoreboard.addPlayerTeam(pPacket.getName());
      } else {
         scoreplayerteam = scoreboard.getPlayerTeam(pPacket.getName());
      }

      if (pPacket.getMethod() == 0 || pPacket.getMethod() == 2) {
         scoreplayerteam.setDisplayName(pPacket.getDisplayName());
         scoreplayerteam.setColor(pPacket.getColor());
         scoreplayerteam.unpackOptions(pPacket.getOptions());
         Team.Visible team$visible = Team.Visible.byName(pPacket.getNametagVisibility());
         if (team$visible != null) {
            scoreplayerteam.setNameTagVisibility(team$visible);
         }

         Team.CollisionRule team$collisionrule = Team.CollisionRule.byName(pPacket.getCollisionRule());
         if (team$collisionrule != null) {
            scoreplayerteam.setCollisionRule(team$collisionrule);
         }

         scoreplayerteam.setPlayerPrefix(pPacket.getPlayerPrefix());
         scoreplayerteam.setPlayerSuffix(pPacket.getPlayerSuffix());
      }

      if (pPacket.getMethod() == 0 || pPacket.getMethod() == 3) {
         for(String s : pPacket.getPlayers()) {
            scoreboard.addPlayerToTeam(s, scoreplayerteam);
         }
      }

      if (pPacket.getMethod() == 4) {
    ...
    * specified bounds
    */
   public void handleParticleEvent(SSpawnParticlePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
    ...
    */
   public void handleUpdateAttributes(SEntityPropertiesPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Entity entity = this.level.getEntity(pPacket.getEntityId());
      if (entity != null) {
         if (!(entity instanceof LivingEntity)) {
            ...
            for(SEntityPropertiesPacket.Snapshot sentitypropertiespacket$snapshot : pPacket.getValues()) {
   ...
   public void handlePlaceRecipe(SPlaceGhostRecipePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Container container = this.minecraft.player.containerMenu;
      if (container.containerId == pPacket.getContainerId() && container.isSynched(this.minecraft.player)) {
         this.recipeManager.byKey(pPacket.getRecipe()).ifPresent((p_241665_2_) -> {
            if (this.minecraft.screen instanceof IRecipeShownListener) {
   ...
   public void handleLightUpdatePacked(SUpdateLightPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      int i = pPacket.getX();
      int j = pPacket.getZ();
      WorldLightManager worldlightmanager = this.level.getChunkSource().getLightEngine();
      int k = pPacket.getSkyYMask();
      int l = pPacket.getEmptySkyYMask();
      Iterator<byte[]> iterator = pPacket.getSkyUpdates().iterator();
      this.readSectionList(i, j, worldlightmanager, LightType.SKY, k, l, iterator, pPacket.getTrustEdges());
      int i1 = pPacket.getBlockYMask();
      int j1 = pPacket.getEmptyBlockYMask();
      Iterator<byte[]> iterator1 = pPacket.getBlockUpdates().iterator();
      this.readSectionList(i, j, worldlightmanager, LightType.BLOCK, i1, j1, iterator1, pPacket.getTrustEdges());
   }

   public void handleMerchantOffers(SMerchantOffersPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      Container container = this.minecraft.player.containerMenu;
      if (pPacket.getContainerId() == container.containerId && container instanceof MerchantContainer) {
         ((MerchantContainer)container).setOffers(new MerchantOffers(pPacket.getOffers().createTag()));
         ((MerchantContainer)container).setXp(pPacket.getVillagerXp());
         ((MerchantContainer)container).setMerchantLevel(pPacket.getVillagerLevel());
         ((MerchantContainer)container).setShowProgressBar(pPacket.showProgress());
         ((MerchantContainer)container).setCanRestock(pPacket.canRestock());
      }

   }

   public void handleSetChunkCacheRadius(SUpdateViewDistancePacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.serverChunkRadius = pPacket.getRadius();
      this.level.getChunkSource().updateViewRadius(pPacket.getRadius());
   }

   public void handleSetChunkCacheCenter(SUpdateChunkPositionPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
      this.level.getChunkSource().updateViewCenter(pPacket.getX(), pPacket.getZ());
   }

   public void handleBlockBreakAck(SPlayerDiggingPacket pPacket) {
      PacketThreadUtil.ensureRunningOnSameThread(pPacket, this, this.minecraft);
   ...
   @Nullable
   public NetworkPlayerInfo getPlayerInfo(UUID pUniqueId) {
    ...
    */
   @Nullable
   public NetworkPlayerInfo getPlayerInfo(String pName) {
      for(NetworkPlayerInfo networkplayerinfo : this.playerInfoMap.values()) {
         if (networkplayerinfo.getProfile().getName().equals(pName)) {
