...
public class LanServerDetector {
   ...
   public static class LanServerFindThread extends Thread {
      ...
      public LanServerFindThread(LanServerDetector.LanServerList pServerList) throws IOException {
   ...
   public static class LanServerList {
      ...
      public synchronized void addServer(String pPingResponse, InetAddress pIpAddress) {
         String s = LanServerPingThread.parseMotd(pPingResponse);
         String s1 = LanServerPingThread.parseAddress(pPingResponse);
         if (s1 != null) {
