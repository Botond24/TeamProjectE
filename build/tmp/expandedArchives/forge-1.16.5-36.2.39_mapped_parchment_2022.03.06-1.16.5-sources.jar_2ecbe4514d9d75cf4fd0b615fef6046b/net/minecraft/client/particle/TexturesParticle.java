...
public class TexturesParticle {
   ...
   private TexturesParticle(@Nullable List<ResourceLocation> pTextures) {
   ...
   public static TexturesParticle fromJson(JsonObject pJson) {
      JsonArray jsonarray = JSONUtils.getAsJsonArray(pJson, "textures", (JsonArray)null);
