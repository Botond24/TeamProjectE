...
public class LargeExplosionParticle extends SpriteTexturedParticle {
   ...
   private LargeExplosionParticle(ClientWorld pLevel, double pX, double pY, double pZ, double pQuadSizeMulitiplier, IAnimatedSprite pSprites) {
   ...
   public static class Factory implements IParticleFactory<BasicParticleType> {
      ...
      public Particle createParticle(BasicParticleType pType, ClientWorld pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
         return new LargeExplosionParticle(pLevel, pX, pY, pZ, pXSpeed, this.sprites);
      }
   }
}