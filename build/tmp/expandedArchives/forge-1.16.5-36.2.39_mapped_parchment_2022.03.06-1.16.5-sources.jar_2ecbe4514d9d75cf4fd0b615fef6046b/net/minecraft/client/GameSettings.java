...
public class GameSettings {
   ...
   public GameSettings(Minecraft pMinecraft, File pGameDirectory) {
   ...
   public void setKey(KeyBinding pKeyBinding, InputMappings.Input pInput) {
   ...
   private CompoundNBT dataFix(CompoundNBT pNbt) {
      int i = 0;
      ...
      return NBTUtil.update(this.minecraft.getFixerUpper(), DefaultTypeReferences.OPTIONS, pNbt, i);
   }
   ...
   public float getSoundSourceVolume(SoundCategory pCategory) {
      return this.sourceVolumes.containsKey(pCategory) ? this.sourceVolumes.get(pCategory) : 1.0F;
   }

   public void setSoundCategoryVolume(SoundCategory pCategory, float pVolume) {
   ...
   public void loadSelectedResourcePacks(ResourcePackList pResourcePackList) {
      Set<String> set = Sets.newLinkedHashSet();
      Iterator<String> iterator = this.resourcePacks.iterator();

      while(iterator.hasNext()) {
         String s = iterator.next();
         ResourcePackInfo resourcepackinfo = pResourcePackList.getPack(s);
         if (resourcepackinfo == null && !s.startsWith("file/")) {
            resourcepackinfo = pResourcePackList.getPack("file/" + s);
         }
   ...
   public void setCameraType(PointOfView pPointOfView) {
