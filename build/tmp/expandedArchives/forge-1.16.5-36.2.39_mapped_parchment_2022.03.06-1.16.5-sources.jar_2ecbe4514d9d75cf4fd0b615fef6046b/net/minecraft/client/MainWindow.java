...
public final class MainWindow implements AutoCloseable {
   ...
   public MainWindow(IWindowEventListener pEventHandler, MonitorHandler pScreenManager, ScreenSize pDisplayData, @Nullable String pPreferredFullscreenVideoMode, String pTitle) {
   ...
   /**
    * 
    * @param p_241553_3_ {@code true} if the cursor entered the window, {@code false} if the cursor left
    */
   ...
   public void updateRawMouseInput(boolean pEnableRawMouseMotion) {
      InputMappings.updateRawMouseInput(this.window, pEnableRawMouseMotion);
   }
