...
public class ShaderGroup implements AutoCloseable {
   ...
   private void parsePassNode(TextureManager p_152764_1_, JsonElement pJson) throws IOException {
      JsonObject jsonobject = JSONUtils.convertToJsonObject(pJson, "pass");
      String s = JSONUtils.getAsString(jsonobject, "name");
   ...
   private void parseUniformNode(JsonElement pJson) throws JSONException {
      JsonObject jsonobject = JSONUtils.convertToJsonObject(pJson, "uniform");
      String s = JSONUtils.getAsString(jsonobject, "name");
   ...
   public Shader addPass(String pProgramName, Framebuffer pFramebuffer, Framebuffer pFramebufferOut) throws IOException {
      Shader shader = new Shader(this.resourceManager, pProgramName, pFramebuffer, pFramebufferOut);
   ...
   public void resize(int pWidth, int pHeight) {
      ...
      for(Framebuffer framebuffer : this.fullSizedTargets) {
         framebuffer.resize(pWidth, pHeight, Minecraft.ON_OSX);
      }
