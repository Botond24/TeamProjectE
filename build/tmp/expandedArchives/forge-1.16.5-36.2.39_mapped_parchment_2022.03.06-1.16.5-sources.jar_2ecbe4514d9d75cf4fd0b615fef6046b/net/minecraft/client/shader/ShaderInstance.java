...
public class ShaderInstance implements IShaderManager, AutoCloseable {
   ...
   public ShaderInstance(IResourceManager pResourceManager, String pName) throws IOException {
      ...
      try {
         iresource = pResourceManager.getResource(resourcelocation);
         ...
         this.vertexProgram = getOrCreate(pResourceManager, ShaderLoader.ShaderType.VERTEX, s);
         this.fragmentProgram = getOrCreate(pResourceManager, ShaderLoader.ShaderType.FRAGMENT, s2);
