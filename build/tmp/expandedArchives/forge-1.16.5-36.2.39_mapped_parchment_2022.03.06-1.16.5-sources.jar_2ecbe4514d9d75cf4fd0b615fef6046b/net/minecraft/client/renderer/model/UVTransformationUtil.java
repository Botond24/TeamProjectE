...
public class UVTransformationUtil {
   ...
   public static TransformationMatrix blockCenterToCorner(TransformationMatrix pTransformation) {
   ...
   public static TransformationMatrix getUVLockTransform(TransformationMatrix pTransformation, Direction pDirection, Supplier<String> pWarningMessage) {
      Direction direction = Direction.rotate(pTransformation.getMatrix(), pDirection);
      TransformationMatrix transformationmatrix = pTransformation.inverse();
      if (transformationmatrix == null) {
         ...
         TransformationMatrix transformationmatrix1 = vanillaUvTransformGlobalToLocal.get(pDirection).compose(transformationmatrix).compose(vanillaUvTransformLocalToGlobal.get(direction));
