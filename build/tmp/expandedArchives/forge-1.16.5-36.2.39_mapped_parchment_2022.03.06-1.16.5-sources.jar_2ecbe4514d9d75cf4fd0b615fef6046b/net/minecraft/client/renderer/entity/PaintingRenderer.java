...
public class PaintingRenderer extends EntityRenderer<PaintingEntity> {
   ...
   public void render(PaintingEntity pEntity, float pEntityYaw, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pPackedLight) {
      pMatrixStack.pushPose();
      pMatrixStack.mulPose(Vector3f.YP.rotationDegrees(180.0F - pEntityYaw));
      PaintingType paintingtype = pEntity.motive;
      float f = 0.0625F;
    ...
    */
   public ResourceLocation getTextureLocation(PaintingEntity pEntity) {
