...
public class ItemCameraTransforms {
   ...
   @Deprecated
   public ItemTransformVec3f getTransform(ItemCameraTransforms.TransformType pType) {
      switch(pType) {
   ...
   public boolean hasTransform(ItemCameraTransforms.TransformType pType) {
      return this.getTransform(pType) != ItemTransformVec3f.NO_TRANSFORM;
   }
   ...
   public static class Deserializer implements JsonDeserializer<ItemCameraTransforms> {
      ...
      private ItemTransformVec3f getTransform(JsonDeserializationContext pContext, JsonObject pJson, String pName) {
         return pJson.has(pName) ? pContext.deserialize(pJson.get(pName), ItemTransformVec3f.class) : ItemTransformVec3f.NO_TRANSFORM;
      }
   }
