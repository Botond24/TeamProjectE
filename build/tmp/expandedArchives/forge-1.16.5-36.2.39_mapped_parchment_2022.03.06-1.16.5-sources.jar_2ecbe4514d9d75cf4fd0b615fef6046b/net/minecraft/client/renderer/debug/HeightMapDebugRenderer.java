            ...
            for(Entry<Heightmap.Type, Heightmap> entry : ichunk.getHeightmaps()) {
               ...
               for(int k = 0; k < 16; ++k) {
                  for(int l = 0; l < 16; ++l) {
                     ...
                     float f = (float)((double)((float)iworld.getHeight(heightmap$type, i1, j1) + (float)heightmap$type.ordinal() * 0.09375F) - pCamY);
                     WorldRenderer.addChainedFilledBoxVertices(bufferbuilder, (double)((float)i1 + 0.25F) - pCamX, (double)f, (double)((float)j1 + 0.25F) - pCamZ, (double)((float)i1 + 0.75F) - pCamX, (double)(f + 0.09375F), (double)((float)j1 + 0.75F) - pCamZ, vector3f.x(), vector3f.y(), vector3f.z(), 1.0F);
                  }
               }
            }
         }
