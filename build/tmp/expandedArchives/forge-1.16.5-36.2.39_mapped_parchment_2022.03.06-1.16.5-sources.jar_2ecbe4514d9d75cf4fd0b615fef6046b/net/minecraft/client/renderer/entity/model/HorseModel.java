...
public class HorseModel<T extends AbstractHorseEntity> extends AgeableModel<T> {
   ...
   public void prepareMobModel(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick) {
      ...
      float f = MathHelper.rotlerp(pEntity.yBodyRotO, pEntity.yBodyRot, pPartialTick);
      float f1 = MathHelper.rotlerp(pEntity.yHeadRotO, pEntity.yHeadRot, pPartialTick);
      float f2 = MathHelper.lerp(pPartialTick, pEntity.xRotO, pEntity.xRot);
      float f3 = f1 - f;
      ...
      if (pLimbSwingAmount > 0.2F) {
         f4 += MathHelper.cos(pLimbSwing * 0.4F) * 0.15F * pLimbSwingAmount;
      }
      ...
      float f11 = MathHelper.cos(f10 * pLimbSwing * 0.6662F + (float)Math.PI);
      ...
      this.leg1.xRot = f14 - f11 * 0.5F * pLimbSwingAmount * f7;
      this.leg2.xRot = f14 + f11 * 0.5F * pLimbSwingAmount * f7;
      this.leg3.xRot = f16;
      this.leg4.xRot = f17;
