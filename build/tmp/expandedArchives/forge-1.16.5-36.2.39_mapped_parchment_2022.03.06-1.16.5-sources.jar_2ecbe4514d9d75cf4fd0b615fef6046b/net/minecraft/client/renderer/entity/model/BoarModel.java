...
public class BoarModel<T extends MobEntity & IFlinging> extends AgeableModel<T> {
   ...
   public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
      this.rightEar.zRot = -0.6981317F - pLimbSwingAmount * MathHelper.sin(pLimbSwing);
      this.leftEar.zRot = 0.6981317F + pLimbSwingAmount * MathHelper.sin(pLimbSwing);
      ...
      float f1 = 1.2F;
      this.frontRightLeg.xRot = MathHelper.cos(pLimbSwing) * 1.2F * pLimbSwingAmount;
      this.frontLeftLeg.xRot = MathHelper.cos(pLimbSwing + (float)Math.PI) * 1.2F * pLimbSwingAmount;
