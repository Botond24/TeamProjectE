...
public class GPUWarning extends ReloadListener<GPUWarning.GPUInfo> {
    ...
    */
   protected GPUWarning.GPUInfo prepare(IResourceManager pResourceManager, IProfiler pProfiler) {
   ...
   protected void apply(GPUWarning.GPUInfo pObject, IResourceManager pResourceManager, IProfiler pProfiler) {
