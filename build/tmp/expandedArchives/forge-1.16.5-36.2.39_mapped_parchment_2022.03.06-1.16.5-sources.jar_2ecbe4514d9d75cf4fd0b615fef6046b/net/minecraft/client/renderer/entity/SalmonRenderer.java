...
public class SalmonRenderer extends MobRenderer<SalmonEntity, SalmonModel<SalmonEntity>> {
    ...
    */
   public ResourceLocation getTextureLocation(SalmonEntity pEntity) {
      return SALMON_LOCATION;
   }

   protected void setupRotations(SalmonEntity pEntityLiving, MatrixStack pMatrixStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks) {
