...
public class ParrotModel extends SegmentedModel<ParrotEntity> {
    ...
    */
   public void setupAnim(ParrotEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
      this.setupAnim(getState(pEntity), pEntity.tickCount, pLimbSwing, pLimbSwingAmount, pAgeInTicks, pNetHeadYaw, pHeadPitch);
   }

   public void prepareMobModel(ParrotEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick) {
