...
public abstract class RenderType extends RenderState {
   ...
   public static RenderType armorCutoutNoCull(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setLayeringState(VIEW_OFFSET_Z_LAYERING).createCompositeState(true);
   ...
   public static RenderType entitySolid(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(true);
   ...
   public static RenderType entityCutout(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(true);
   ...
   public static RenderType entityCutoutNoCull(ResourceLocation pLocation, boolean pOutline) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(pOutline);
   ...
   public static RenderType itemEntityTranslucentCull(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setOutputState(ITEM_ENTITY_TARGET).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setWriteMaskState(RenderState.COLOR_DEPTH_WRITE).createCompositeState(true);
   ...
   public static RenderType entityTranslucentCull(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(true);
   ...
   public static RenderType entityTranslucent(ResourceLocation pLocation, boolean pOutline) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(pOutline);
   ...
   public static RenderType entitySmoothCutout(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setAlphaState(MIDWAY_ALPHA).setDiffuseLightingState(DIFFUSE_LIGHTING).setShadeModelState(SMOOTH_SHADE).setCullState(NO_CULL).setLightmapState(LIGHTMAP).createCompositeState(true);
   ...
   public static RenderType beaconBeam(ResourceLocation pLocation, boolean pColorFlag) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(pColorFlag ? TRANSLUCENT_TRANSPARENCY : NO_TRANSPARENCY).setWriteMaskState(pColorFlag ? COLOR_WRITE : COLOR_DEPTH_WRITE).setFogState(NO_FOG).createCompositeState(false);
   ...
   public static RenderType entityDecal(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setDepthTestState(EQUAL_DEPTH_TEST).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(false);
   ...
   public static RenderType entityNoOutline(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setWriteMaskState(COLOR_WRITE).createCompositeState(false);
   ...
   public static RenderType entityShadow(ResourceLocation pLocation) {
      RenderType.State rendertype$state = RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setWriteMaskState(COLOR_WRITE).setDepthTestState(LEQUAL_DEPTH_TEST).setLayeringState(VIEW_OFFSET_Z_LAYERING).createCompositeState(false);
   ...
   public static RenderType eyes(ResourceLocation pLocation) {
      RenderState.TextureState renderstate$texturestate = new RenderState.TextureState(pLocation, false, false);
   ...
   public static RenderType energySwirl(ResourceLocation pLocation, float pU, float pV) {
      return create("energy_swirl", DefaultVertexFormats.NEW_ENTITY, 7, 256, false, true, RenderType.State.builder().setTextureState(new RenderState.TextureState(pLocation, false, false)).setTexturingState(new RenderState.OffsetTexturingState(pU, pV)).setFogState(BLACK_FOG).setTransparencyState(ADDITIVE_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(false));
   }
   ...
   public static RenderType outline(ResourceLocation pLocation) {
      return outline(pLocation, NO_CULL);
   }
   ...
   public void end(BufferBuilder pBuffer, int pCameraX, int pCameraY, int pCameraZ) {
      if (pBuffer.building()) {
         if (this.sortOnUpload) {
            pBuffer.sortQuads((float)pCameraX, (float)pCameraY, (float)pCameraZ);
         }

         pBuffer.end();
         this.setupRenderState();
         WorldVertexBufferUploader.end(pBuffer);
   ...
   public static final class State {
      ...
      public static class Builder {
         ...
         public RenderType.State.Builder setTransparencyState(RenderState.TransparencyState pTransparency) {
         ...
         public RenderType.State.Builder setDepthTestState(RenderState.DepthTestState pDepthTest) {
            this.depthTestState = pDepthTest;
            return this;
         }

         public RenderType.State.Builder setCullState(RenderState.CullState pCull) {
            this.cullState = pCull;
            return this;
         }

         public RenderType.State.Builder setLightmapState(RenderState.LightmapState pLightmap) {
            this.lightmapState = pLightmap;
            return this;
         }

         public RenderType.State.Builder setOverlayState(RenderState.OverlayState pOverlay) {
         ...
         public RenderType.State.Builder setLayeringState(RenderState.LayerState pLayer) {
            this.layeringState = pLayer;
            return this;
         }

         public RenderType.State.Builder setOutputState(RenderState.TargetState pTarget) {
            this.outputState = pTarget;
            return this;
         }

         public RenderType.State.Builder setTexturingState(RenderState.TexturingState pTexturing) {
            this.texturingState = pTexturing;
            return this;
         }

         public RenderType.State.Builder setWriteMaskState(RenderState.WriteMaskState pWriteMask) {
            this.writeMaskState = pWriteMask;
            return this;
         }

         public RenderType.State.Builder setLineState(RenderState.LineState pLine) {
            this.lineState = pLine;
            return this;
         }

         public RenderType.State createCompositeState(boolean pOutline) {
            return this.createCompositeState(pOutline ? RenderType.OutlineState.AFFECTS_OUTLINE : RenderType.OutlineState.NONE);
         }

         public RenderType.State createCompositeState(RenderType.OutlineState pOutlineState) {
            return new RenderType.State(this.textureState, this.transparencyState, this.diffuseLightingState, this.shadeModelState, this.alphaState, this.depthTestState, this.cullState, this.lightmapState, this.overlayState, this.fogState, this.layeringState, this.outputState, this.texturingState, this.writeMaskState, this.lineState, pOutlineState);
         }
      }
   }
