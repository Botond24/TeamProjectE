...
public class FishRenderer extends EntityRenderer<FishingBobberEntity> {
   ...
   public void render(FishingBobberEntity pEntity, float pEntityYaw, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pPackedLight) {
