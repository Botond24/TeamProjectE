...
public class WorldRenderer implements IResourceManagerReloadListener, AutoCloseable {
   ...
   private void renderSnowAndRain(LightTexture pLightmap, float pPartialTicks, double pX, double pY, double pZ) {
      net.minecraftforge.client.IWeatherRenderHandler renderHandler = level.effects().getWeatherRenderHandler();
      if (renderHandler != null) {
         renderHandler.render(ticks, pPartialTicks, level, minecraft, pLightmap, pX, pY, pZ);
         return;
      }
      float f = this.minecraft.level.getRainLevel(pPartialTicks);
      if (!(f <= 0.0F)) {
         ...
         int i1 = -1;
         float f1 = (float)this.ticks + pPartialTicks;
               ...
               if (biome.getPrecipitation() != Biome.RainType.NONE) {
                  ...
                  if (j2 != k2) {
                     ...
                     if (f2 >= 0.15F) {
                        ...
                        float f3 = -((float)i3 + pPartialTicks) / 32.0F * (3.0F + random.nextFloat());
                        ...
                        bufferbuilder.vertex((double)k1 - pX - d0 + 0.5D, (double)k2 - pY, (double)j1 - pZ - d1 + 0.5D).uv(0.0F, (float)j2 * 0.25F + f3).color(1.0F, 1.0F, 1.0F, f5).uv2(j3).endVertex();
                        bufferbuilder.vertex((double)k1 - pX + d0 + 0.5D, (double)k2 - pY, (double)j1 - pZ + d1 + 0.5D).uv(1.0F, (float)j2 * 0.25F + f3).color(1.0F, 1.0F, 1.0F, f5).uv2(j3).endVertex();
                        bufferbuilder.vertex((double)k1 - pX + d0 + 0.5D, (double)j2 - pY, (double)j1 - pZ + d1 + 0.5D).uv(1.0F, (float)k2 * 0.25F + f3).color(1.0F, 1.0F, 1.0F, f5).uv2(j3).endVertex();
                        bufferbuilder.vertex((double)k1 - pX - d0 + 0.5D, (double)j2 - pY, (double)j1 - pZ - d1 + 0.5D).uv(0.0F, (float)k2 * 0.25F + f3).color(1.0F, 1.0F, 1.0F, f5).uv2(j3).endVertex();
                     } else {
                        if (i1 != 1) {
                           if (i1 >= 0) {
                              tessellator.end();
                        ...
                        double d3 = (double)((float)k1 + 0.5F) - pX;
                        double d5 = (double)((float)j1 + 0.5F) - pZ;
                        ...
                        int j4 = (l3 * 3 + 240) / 4;
                        int k4 = (i4 * 3 + 240) / 4;
                        bufferbuilder.vertex((double)k1 - pX - d0 + 0.5D, (double)k2 - pY, (double)j1 - pZ - d1 + 0.5D).uv(0.0F + f7, (float)j2 * 0.25F + f6 + f8).color(1.0F, 1.0F, 1.0F, f10).uv2(k4, j4).endVertex();
                        bufferbuilder.vertex((double)k1 - pX + d0 + 0.5D, (double)k2 - pY, (double)j1 - pZ + d1 + 0.5D).uv(1.0F + f7, (float)j2 * 0.25F + f6 + f8).color(1.0F, 1.0F, 1.0F, f10).uv2(k4, j4).endVertex();
                        bufferbuilder.vertex((double)k1 - pX + d0 + 0.5D, (double)j2 - pY, (double)j1 - pZ + d1 + 0.5D).uv(1.0F + f7, (float)k2 * 0.25F + f6 + f8).color(1.0F, 1.0F, 1.0F, f10).uv2(k4, j4).endVertex();
                        bufferbuilder.vertex((double)k1 - pX - d0 + 0.5D, (double)j2 - pY, (double)j1 - pZ - d1 + 0.5D).uv(0.0F + f7, (float)k2 * 0.25F + f6 + f8).color(1.0F, 1.0F, 1.0F, f10).uv2(k4, j4).endVertex();
                     }
                  }
               }
            }
   ...
   public void tickRain(ActiveRenderInfo pActiveRenderInfo) {
      net.minecraftforge.client.IWeatherParticleRenderHandler renderHandler = level.effects().getWeatherParticleRenderHandler();
      if (renderHandler != null) {
         renderHandler.render(ticks, level, minecraft, pActiveRenderInfo);
         return;
      }
   ...
   private void drawStars(BufferBuilder pBufferBuilder) {
      ...
      pBufferBuilder.begin(7, DefaultVertexFormats.POSITION);
    ...
    * set null to clear
    */
   public void setLevel(@Nullable ClientWorld pLevelClient) {
   ...
   private void setupRender(ActiveRenderInfo pActiveRenderInfo, ClippingHelper pCamera, boolean pDebugCamera, int pFrameCount, boolean pPlayerSpectator) {
      Vector3d vector3d = pActiveRenderInfo.getPosition();
      ...
      if (!pDebugCamera && this.needsUpdate) {
         ...
         if (chunkrenderdispatcher$chunkrender != null) {
            if (pPlayerSpectator && this.level.getBlockState(blockpos).isSolidRender(this.level, blockpos)) {
               flag = false;
            }

            chunkrenderdispatcher$chunkrender.setFrame(pFrameCount);
            ...
            for(int i1 = -this.lastViewDistance; i1 <= this.lastViewDistance; ++i1) {
               for(int j1 = -this.lastViewDistance; j1 <= this.lastViewDistance; ++j1) {
                  ...
                  if (chunkrenderdispatcher$chunkrender1 != null && pCamera.isVisible(chunkrenderdispatcher$chunkrender1.bb)) {
                     chunkrenderdispatcher$chunkrender1.setFrame(pFrameCount);
    ...
    */
   @Nullable
   private ChunkRenderDispatcher.ChunkRender getRelativeFrom(BlockPos pPlayerPos, ChunkRenderDispatcher.ChunkRender pRenderChunkBase, Direction pFacing) {
      BlockPos blockpos = pRenderChunkBase.getRelativeOrigin(pFacing);
      if (MathHelper.abs(pPlayerPos.getX() - blockpos.getX()) > this.lastViewDistance * 16) {
         return null;
      } else if (blockpos.getY() >= 0 && blockpos.getY() < 256) {
         return MathHelper.abs(pPlayerPos.getZ() - blockpos.getZ()) > this.lastViewDistance * 16 ? null : this.viewArea.getRenderChunkAt(blockpos);
      } else {
         return null;
      }
   }
   ...
   public void renderLevel(MatrixStack pMatrixStack, float pPartialTicks, long pFinishTimeNano, boolean pDrawBlockOutline, ActiveRenderInfo pActiveRenderInfo, GameRenderer pGameRenderer, LightTexture pLightmap, Matrix4f pProjection) {
      TileEntityRendererDispatcher.instance.prepare(this.level, this.minecraft.getTextureManager(), this.minecraft.font, pActiveRenderInfo, this.minecraft.hitResult);
      this.entityRenderDispatcher.prepare(this.level, pActiveRenderInfo, this.minecraft.crosshairPickEntity);
      ...
      if (flag) {
         ...
         clippinghelper = new ClippingHelper(matrix4f, pProjection);
         clippinghelper.prepare(d0, d1, d2);
      }

      this.minecraft.getProfiler().popPush("captureFrustum");
      if (this.captureFrustum) {
         this.captureFrustum(matrix4f, pProjection, vector3d.x, vector3d.y, vector3d.z, flag ? new ClippingHelper(matrix4f, pProjection) : clippinghelper);
         this.captureFrustum = false;
      }

      iprofiler.popPush("clear");
      FogRenderer.setupColor(pActiveRenderInfo, pPartialTicks, this.minecraft.level, this.minecraft.options.renderDistance, pGameRenderer.getDarkenWorldAmount(pPartialTicks));
      ...
      if (this.minecraft.options.renderDistance >= 4) {
         FogRenderer.setupFog(pActiveRenderInfo, FogRenderer.FogType.FOG_SKY, f, flag1, pPartialTicks);
         iprofiler.popPush("sky");
         this.renderSky(pMatrixStack, pPartialTicks);
      }

      iprofiler.popPush("fog");
      FogRenderer.setupFog(pActiveRenderInfo, FogRenderer.FogType.FOG_TERRAIN, Math.max(f - 16.0F, 32.0F), flag1, pPartialTicks);
      iprofiler.popPush("terrain_setup");
      this.setupRender(pActiveRenderInfo, clippinghelper, flag, this.frameId++, this.minecraft.player.isSpectator());
      ...
      this.renderChunkLayer(RenderType.solid(), pMatrixStack, d0, d1, d2);
      ...
      this.renderChunkLayer(RenderType.cutoutMipped(), pMatrixStack, d0, d1, d2);
      this.minecraft.getModelManager().getAtlas(AtlasTexture.LOCATION_BLOCKS).restoreLastBlurMipmap();
      this.renderChunkLayer(RenderType.cutout(), pMatrixStack, d0, d1, d2);
      if (this.level.effects().constantAmbientLight()) {
         RenderHelper.setupNetherLevel(pMatrixStack.last().pose());
      } else {
         RenderHelper.setupLevel(pMatrixStack.last().pose());
      }
      ...
      for(Entity entity : this.level.entitiesForRendering()) {
         if ((this.entityRenderDispatcher.shouldRender(entity, clippinghelper, d0, d1, d2) || entity.hasIndirectPassenger(this.minecraft.player)) && (entity != pActiveRenderInfo.getEntity() || pActiveRenderInfo.isDetached() || pActiveRenderInfo.getEntity() instanceof LivingEntity && ((LivingEntity)pActiveRenderInfo.getEntity()).isSleeping()) && (!(entity instanceof ClientPlayerEntity) || pActiveRenderInfo.getEntity() == entity || (entity == minecraft.player && !minecraft.player.isSpectator()))) { //FORGE: render local player entity when it is not the renderViewEntity
            ...
            this.renderEntity(entity, d0, d1, d2, pPartialTicks, pMatrixStack, irendertypebuffer);
         }
      }
      ...
      for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer : this.renderChunks) {
         ...
         if (!list.isEmpty()) {
            for(TileEntity tileentity1 : list) {
               ...
               TileEntityRendererDispatcher.instance.render(tileentity1, pPartialTicks, pMatrixStack, irendertypebuffer1);
      ...
      synchronized(this.globalBlockEntities) {
         for(TileEntity tileentity : this.globalBlockEntities) {
            ...
            TileEntityRendererDispatcher.instance.render(tileentity, pPartialTicks, pMatrixStack, irendertypebuffer$impl);
            pMatrixStack.popPose();
         }
      }
      ...
      for(Entry<SortedSet<DestroyBlockProgress>> entry : this.destructionProgress.long2ObjectEntrySet()) {
         ...
         if (!(d3 * d3 + d4 * d4 + d5 * d5 > 1024.0D)) {
            ...
            if (sortedset1 != null && !sortedset1.isEmpty()) {
               ...
               pMatrixStack.pushPose();
               pMatrixStack.translate((double)blockpos1.getX() - d0, (double)blockpos1.getY() - d1, (double)blockpos1.getZ() - d2);
               MatrixStack.Entry matrixstack$entry1 = pMatrixStack.last();
               ...
               this.minecraft.getBlockRenderer().renderBreakingTexture(this.level.getBlockState(blockpos1), blockpos1, this.level, pMatrixStack, ivertexbuilder1);
               pMatrixStack.popPose();
            }
         }
      }
      ...
      if (pDrawBlockOutline && raytraceresult != null && raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
         iprofiler.popPush("outline");
         BlockPos blockpos = ((BlockRayTraceResult)raytraceresult).getBlockPos();
         BlockState blockstate = this.level.getBlockState(blockpos);
         if (!net.minecraftforge.client.ForgeHooksClient.onDrawBlockHighlight(this, pActiveRenderInfo, raytraceresult, pPartialTicks, pMatrixStack, irendertypebuffer$impl))
         if (!blockstate.isAir(this.level, blockpos) && this.level.getWorldBorder().isWithinBounds(blockpos)) {
            ...
            this.renderHitOutline(pMatrixStack, ivertexbuilder2, pActiveRenderInfo.getEntity(), d0, d1, d2, blockpos, blockstate);
         }
      } else if (raytraceresult != null && raytraceresult.getType() == RayTraceResult.Type.ENTITY) {
         net.minecraftforge.client.ForgeHooksClient.onDrawBlockHighlight(this, pActiveRenderInfo, raytraceresult, pPartialTicks, pMatrixStack, irendertypebuffer$impl);
      }

      RenderSystem.pushMatrix();
      RenderSystem.multMatrix(pMatrixStack.last().pose());
      this.minecraft.debugRenderer.render(pMatrixStack, irendertypebuffer$impl, d0, d1, d2);
      ...
      if (this.transparencyChain != null) {
         ...
         this.renderChunkLayer(RenderType.translucent(), pMatrixStack, d0, d1, d2);
         iprofiler.popPush("string");
         this.renderChunkLayer(RenderType.tripwire(), pMatrixStack, d0, d1, d2);
         this.particlesTarget.clear(Minecraft.ON_OSX);
         this.particlesTarget.copyDepthFrom(this.minecraft.getMainRenderTarget());
         RenderState.PARTICLES_TARGET.setupRenderState();
         iprofiler.popPush("particles");
         this.minecraft.particleEngine.renderParticles(pMatrixStack, irendertypebuffer$impl, pLightmap, pActiveRenderInfo, pPartialTicks, clippinghelper);
      ...
      if (this.minecraft.options.getCloudsType() != CloudOption.OFF) {
         if (this.transparencyChain != null) {
            ...
            this.renderClouds(pMatrixStack, pPartialTicks, d0, d1, d2);
      ...
      if (this.transparencyChain != null) {
         ...
         this.renderSnowAndRain(pLightmap, pPartialTicks, d0, d1, d2);
         this.renderWorldBounds(pActiveRenderInfo);
      ...
      this.renderDebug(pActiveRenderInfo);
   ...
   private void checkPoseStack(MatrixStack pMatrixStack) {
      if (!pMatrixStack.clear()) {
         throw new IllegalStateException("Pose stack not empty");
      }
   }

   private void renderEntity(Entity pEntity, double pCamX, double pCamY, double pCamZ, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer) {
      ...
      this.entityRenderDispatcher.render(pEntity, d0 - pCamX, d1 - pCamY, d2 - pCamZ, f, pPartialTicks, pMatrixStack, pBuffer, this.entityRenderDispatcher.getPackedLightCoords(pEntity, pPartialTicks));
   }
   ...
   private void renderDebug(ActiveRenderInfo pActiveRenderInfo) {
      Tessellator tessellator = Tessellator.getInstance();
      BufferBuilder bufferbuilder = tessellator.getBuilder();
      ...
      if (this.capturedFrustum != null) {
         ...
         RenderSystem.lineWidth(10.0F);
         RenderSystem.pushMatrix();
         RenderSystem.translatef((float)(this.frustumPos.x - pActiveRenderInfo.getPosition().x), (float)(this.frustumPos.y - pActiveRenderInfo.getPosition().y), (float)(this.frustumPos.z - pActiveRenderInfo.getPosition().z));
         RenderSystem.depthMask(true);
         bufferbuilder.begin(7, DefaultVertexFormats.POSITION_COLOR);
   ...
   private void addFrustumVertex(IVertexBuilder pBuffer, int pVertex) {
   ...
   private void addFrustumQuad(IVertexBuilder pBuffer, int pVertex1, int pVertex2, int pVertex3, int pVertex4, int pRed, int pGreen, int pBlue) {
      float f = 0.25F;
   ...
   private void removeProgress(DestroyBlockProgress pProgress) {
   ...
   private void renderEndSky(MatrixStack pMatrixStack) {
      RenderSystem.disableAlphaTest();
      RenderSystem.enableBlend();
      RenderSystem.defaultBlendFunc();
      RenderSystem.depthMask(false);
   ...
   private void buildClouds(BufferBuilder pBuffer, double pCloudsX, double pCloudsY, double pCloudsZ, Vector3d pCloudsColor) {
      float f = 4.0F;
      float f1 = 0.00390625F;
      int i = 8;
      int j = 4;
      float f2 = 9.765625E-4F;
      float f3 = (float)MathHelper.floor(pCloudsX) * 0.00390625F;
      float f4 = (float)MathHelper.floor(pCloudsZ) * 0.00390625F;
      float f5 = (float)pCloudsColor.x;
      float f6 = (float)pCloudsColor.y;
      float f7 = (float)pCloudsColor.z;
      float f8 = f5 * 0.9F;
      float f9 = f6 * 0.9F;
      float f10 = f7 * 0.9F;
      float f11 = f5 * 0.7F;
      ...
      float f15 = f6 * 0.8F;
      float f16 = f7 * 0.8F;
      pBuffer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR_NORMAL);
      float f17 = (float)Math.floor(pCloudsY / 4.0D) * 4.0F;
   ...
   private void compileChunksUntil(long pFinishTimeNano) {
   ...
   private void renderHitOutline(MatrixStack pMatrixStack, IVertexBuilder pBuffer, Entity pEntity, double pX, double pY, double pZ, BlockPos pBlockPos, BlockState pBlockState) {
      renderShape(pMatrixStack, pBuffer, pBlockState.getShape(this.level, pBlockPos, ISelectionContext.of(pEntity)), (double)pBlockPos.getX() - pX, (double)pBlockPos.getY() - pY, (double)pBlockPos.getZ() - pZ, 0.0F, 0.0F, 0.0F, 0.4F);
   }

   public static void renderVoxelShape(MatrixStack pMatrixStack, IVertexBuilder pBuffer, VoxelShape pShape, double pX, double pY, double pZ, float pRed, float pGreen, float pBlue, float pAlpha) {
      List<AxisAlignedBB> list = pShape.toAabbs();
      ...
      for(int j = 0; j < list.size(); ++j) {
         ...
         renderShape(pMatrixStack, pBuffer, VoxelShapes.create(axisalignedbb.move(0.0D, 0.0D, 0.0D)), pX, pY, pZ, f2, f3, f4, 1.0F);
      }
   ...
   public static void renderLineBox(MatrixStack pMatrixStack, IVertexBuilder pBuffer, AxisAlignedBB pAabb, float pRed, float pGreen, float pBlue, float pAlpha) {
      renderLineBox(pMatrixStack, pBuffer, pAabb.minX, pAabb.minY, pAabb.minZ, pAabb.maxX, pAabb.maxY, pAabb.maxZ, pRed, pGreen, pBlue, pAlpha, pRed, pGreen, pBlue);
   }

   public static void renderLineBox(MatrixStack pMatrixStack, IVertexBuilder pBuffer, double pMinX, double pMinY, double pMinZ, double pMaxX, double pMaxY, double pMaxZ, float pRed, float pGreen, float pBlue, float pAlpha) {
      renderLineBox(pMatrixStack, pBuffer, pMinX, pMinY, pMinZ, pMaxX, pMaxY, pMaxZ, pRed, pGreen, pBlue, pAlpha, pRed, pGreen, pBlue);
   }

   public static void renderLineBox(MatrixStack pMatrixStack, IVertexBuilder pBuffer, double pMinX, double pMinY, double pMinZ, double pMaxX, double pMaxY, double pMaxZ, float pRed, float pGreen, float pBlue, float pAlpha, float pRed2, float pGreen2, float pBlue2) {
      Matrix4f matrix4f = pMatrixStack.last().pose();
      float f = (float)pMinX;
      ...
      pBuffer.vertex(matrix4f, f, f1, f2).color(pRed, pGreen2, pBlue2, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f1, f2).color(pRed, pGreen2, pBlue2, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f1, f2).color(pRed2, pGreen, pBlue2, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f4, f2).color(pRed2, pGreen, pBlue2, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f1, f2).color(pRed2, pGreen2, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f1, f5).color(pRed2, pGreen2, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f1, f2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f4, f2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f4, f2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f4, f2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f4, f2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f4, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f4, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f1, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f1, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f1, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f1, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f1, f2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f, f4, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f4, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f1, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f4, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f4, f2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuffer.vertex(matrix4f, f3, f4, f5).color(pRed, pGreen, pBlue, pAlpha).endVertex();
   ...
   public static void addChainedFilledBoxVertices(BufferBuilder pBuilder, double pX1, double pY1, double pZ1, double pX2, double pY2, double pZ2, float pRed, float pGreen, float pBlue, float pAlpha) {
      pBuilder.vertex(pX1, pY1, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY1, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY1, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY1, pZ2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY2, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY2, pZ2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY2, pZ2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY1, pZ2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX2, pY2, pZ2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX2, pY1, pZ2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX2, pY1, pZ2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX2, pY1, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX2, pY2, pZ2).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX2, pY2, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX2, pY2, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX2, pY1, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY2, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
      pBuilder.vertex(pX1, pY1, pZ1).color(pRed, pGreen, pBlue, pAlpha).endVertex();
   ...
   public void blockChanged(IBlockReader pLevel, BlockPos pPos, BlockState pOldState, BlockState pNewState, int pFlags) {
      ...
      for(int i = pPos.getZ() - 1; i <= pPos.getZ() + 1; ++i) {
         for(int j = pPos.getX() - 1; j <= pPos.getX() + 1; ++j) {
            for(int k = pPos.getY() - 1; k <= pPos.getY() + 1; ++k) {
               this.setSectionDirty(j >> 4, k >> 4, i >> 4, pRerenderOnMainThread);
            }
         }
      }
   ...
   public void playStreamingMusic(@Nullable SoundEvent pSound, BlockPos pPos) {
      this.playRecord(pSound, pPos, pSound == null? null : MusicDiscItem.getBySound(pSound));
   }

   public void playRecord(@Nullable SoundEvent pSound, BlockPos pPos, @Nullable MusicDiscItem musicDiscItem) {
      ISound isound = this.playingRecords.get(pPos);
      if (isound != null) {
      ...
      if (pSound != null) {
         ...
         ISound simplesound = SimpleSound.forRecord(pSound, (double)pPos.getX(), (double)pPos.getY(), (double)pPos.getZ());
         this.playingRecords.put(pPos, simplesound);
         this.minecraft.getSoundManager().play(simplesound);
      }

      this.notifyNearbyEntities(this.level, pPos, pSound != null);
   }

   /**
    * Called when a record starts or stops playing. Used to make parrots start or stop partying.
    */
   private void notifyNearbyEntities(World pLevel, BlockPos pPos, boolean pIsPartying) {
      for(LivingEntity livingentity : pLevel.getEntitiesOfClass(LivingEntity.class, (new AxisAlignedBB(pPos)).inflate(3.0D))) {
         livingentity.setRecordPlayingNearby(pPos, pIsPartying);
      }

   }

   public void addParticle(IParticleData pParticleData, boolean pAlwaysRender, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
      this.addParticle(pParticleData, pAlwaysRender, false, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
   }

   public void addParticle(IParticleData pParticleData, boolean pIgnoreRange, boolean pMinimizeLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
      try {
         this.addParticleInternal(pParticleData, pIgnoreRange, pMinimizeLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
         ...
         crashreportcategory.setDetail("Position", () -> {
            return CrashReportCategory.formatLocation(pX, pY, pZ);
         });
         throw new ReportedException(crashreport);
      }
   }

   private <T extends IParticleData> void addParticle(T pParticleData, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
      this.addParticle(pParticleData, pParticleData.getType().getOverrideLimiter(), pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
   }

   @Nullable
   private Particle addParticleInternal(IParticleData pParticleData, boolean pAlwaysRender, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
      return this.addParticleInternal(pParticleData, pAlwaysRender, false, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
   }

   @Nullable
   private Particle addParticleInternal(IParticleData pParticleData, boolean pAlwaysRender, boolean pMinimizeLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
      ...
      if (this.minecraft != null && activerenderinfo.isInitialized() && this.minecraft.particleEngine != null) {
         ParticleStatus particlestatus = this.calculateParticleLevel(pMinimizeLevel);
         if (pAlwaysRender) {
            return this.minecraft.particleEngine.createParticle(pParticleData, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
         } else if (activerenderinfo.getPosition().distanceToSqr(pX, pY, pZ) > 1024.0D) {
            return null;
         } else {
            return particlestatus == ParticleStatus.MINIMAL ? null : this.minecraft.particleEngine.createParticle(pParticleData, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
         }
      } else {
         return null;
      }
   ...
   public void globalLevelEvent(int pSoundID, BlockPos pPos, int pData) {
      ...
      case 1038:
         ...
         if (activerenderinfo.isInitialized()) {
            double d0 = (double)pPos.getX() - activerenderinfo.getPosition().x;
            double d1 = (double)pPos.getY() - activerenderinfo.getPosition().y;
            double d2 = (double)pPos.getZ() - activerenderinfo.getPosition().z;
   ...
   public void levelEvent(PlayerEntity pPlayer, int pType, BlockPos pBlockPos, int pData) {
      Random random = this.level.random;
      switch(pType) {
      case 1000:
         this.level.playLocalSound(pBlockPos, SoundEvents.DISPENSER_DISPENSE, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
         break;
      case 1001:
         this.level.playLocalSound(pBlockPos, SoundEvents.DISPENSER_FAIL, SoundCategory.BLOCKS, 1.0F, 1.2F, false);
         break;
      case 1002:
         this.level.playLocalSound(pBlockPos, SoundEvents.DISPENSER_LAUNCH, SoundCategory.BLOCKS, 1.0F, 1.2F, false);
         break;
      case 1003:
         this.level.playLocalSound(pBlockPos, SoundEvents.ENDER_EYE_LAUNCH, SoundCategory.NEUTRAL, 1.0F, 1.2F, false);
         break;
      case 1004:
         this.level.playLocalSound(pBlockPos, SoundEvents.FIREWORK_ROCKET_SHOOT, SoundCategory.NEUTRAL, 1.0F, 1.2F, false);
         break;
      case 1005:
         this.level.playLocalSound(pBlockPos, SoundEvents.IRON_DOOR_OPEN, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1006:
         this.level.playLocalSound(pBlockPos, SoundEvents.WOODEN_DOOR_OPEN, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1007:
         this.level.playLocalSound(pBlockPos, SoundEvents.WOODEN_TRAPDOOR_OPEN, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1008:
         this.level.playLocalSound(pBlockPos, SoundEvents.FENCE_GATE_OPEN, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1009:
         this.level.playLocalSound(pBlockPos, SoundEvents.FIRE_EXTINGUISH, SoundCategory.BLOCKS, 0.5F, 2.6F + (random.nextFloat() - random.nextFloat()) * 0.8F, false);
         break;
      case 1010:
         if (Item.byId(pData) instanceof MusicDiscItem) {
            this.playRecord(((MusicDiscItem)Item.byId(pData)).getSound(), pBlockPos, (MusicDiscItem) Item.byId(pData));
         } else {
            this.playStreamingMusic((SoundEvent)null, pBlockPos);
         }
         break;
      case 1011:
         this.level.playLocalSound(pBlockPos, SoundEvents.IRON_DOOR_CLOSE, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1012:
         this.level.playLocalSound(pBlockPos, SoundEvents.WOODEN_DOOR_CLOSE, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1013:
         this.level.playLocalSound(pBlockPos, SoundEvents.WOODEN_TRAPDOOR_CLOSE, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1014:
         this.level.playLocalSound(pBlockPos, SoundEvents.FENCE_GATE_CLOSE, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1015:
         this.level.playLocalSound(pBlockPos, SoundEvents.GHAST_WARN, SoundCategory.HOSTILE, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1016:
         this.level.playLocalSound(pBlockPos, SoundEvents.GHAST_SHOOT, SoundCategory.HOSTILE, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1017:
         this.level.playLocalSound(pBlockPos, SoundEvents.ENDER_DRAGON_SHOOT, SoundCategory.HOSTILE, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1018:
         this.level.playLocalSound(pBlockPos, SoundEvents.BLAZE_SHOOT, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1019:
         this.level.playLocalSound(pBlockPos, SoundEvents.ZOMBIE_ATTACK_WOODEN_DOOR, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1020:
         this.level.playLocalSound(pBlockPos, SoundEvents.ZOMBIE_ATTACK_IRON_DOOR, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1021:
         this.level.playLocalSound(pBlockPos, SoundEvents.ZOMBIE_BREAK_WOODEN_DOOR, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1022:
         this.level.playLocalSound(pBlockPos, SoundEvents.WITHER_BREAK_BLOCK, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1024:
         this.level.playLocalSound(pBlockPos, SoundEvents.WITHER_SHOOT, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1025:
         this.level.playLocalSound(pBlockPos, SoundEvents.BAT_TAKEOFF, SoundCategory.NEUTRAL, 0.05F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1026:
         this.level.playLocalSound(pBlockPos, SoundEvents.ZOMBIE_INFECT, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1027:
         this.level.playLocalSound(pBlockPos, SoundEvents.ZOMBIE_VILLAGER_CONVERTED, SoundCategory.NEUTRAL, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1029:
         this.level.playLocalSound(pBlockPos, SoundEvents.ANVIL_DESTROY, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1030:
         this.level.playLocalSound(pBlockPos, SoundEvents.ANVIL_USE, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1031:
         this.level.playLocalSound(pBlockPos, SoundEvents.ANVIL_LAND, SoundCategory.BLOCKS, 0.3F, this.level.random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1032:
         ...
         break;
      case 1033:
         this.level.playLocalSound(pBlockPos, SoundEvents.CHORUS_FLOWER_GROW, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
         break;
      case 1034:
         this.level.playLocalSound(pBlockPos, SoundEvents.CHORUS_FLOWER_DEATH, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
         break;
      case 1035:
         this.level.playLocalSound(pBlockPos, SoundEvents.BREWING_STAND_BREW, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
         break;
      case 1036:
         this.level.playLocalSound(pBlockPos, SoundEvents.IRON_TRAPDOOR_CLOSE, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1037:
         this.level.playLocalSound(pBlockPos, SoundEvents.IRON_TRAPDOOR_OPEN, SoundCategory.BLOCKS, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1039:
         this.level.playLocalSound(pBlockPos, SoundEvents.PHANTOM_BITE, SoundCategory.HOSTILE, 0.3F, this.level.random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1040:
         this.level.playLocalSound(pBlockPos, SoundEvents.ZOMBIE_CONVERTED_TO_DROWNED, SoundCategory.NEUTRAL, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1041:
         this.level.playLocalSound(pBlockPos, SoundEvents.HUSK_CONVERTED_TO_ZOMBIE, SoundCategory.NEUTRAL, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
         break;
      case 1042:
         this.level.playLocalSound(pBlockPos, SoundEvents.GRINDSTONE_USE, SoundCategory.BLOCKS, 1.0F, this.level.random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1043:
         this.level.playLocalSound(pBlockPos, SoundEvents.BOOK_PAGE_TURN, SoundCategory.BLOCKS, 1.0F, this.level.random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1044:
         this.level.playLocalSound(pBlockPos, SoundEvents.SMITHING_TABLE_USE, SoundCategory.BLOCKS, 1.0F, this.level.random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1500:
         ComposterBlock.handleFill(this.level, pBlockPos, pData > 0);
         break;
      case 1501:
         this.level.playLocalSound(pBlockPos, SoundEvents.LAVA_EXTINGUISH, SoundCategory.BLOCKS, 0.5F, 2.6F + (random.nextFloat() - random.nextFloat()) * 0.8F, false);
         ...
         break;
      case 1502:
         this.level.playLocalSound(pBlockPos, SoundEvents.REDSTONE_TORCH_BURNOUT, SoundCategory.BLOCKS, 0.5F, 2.6F + (random.nextFloat() - random.nextFloat()) * 0.8F, false);

         for(int l1 = 0; l1 < 5; ++l1) {
            double d15 = (double)pBlockPos.getX() + random.nextDouble() * 0.6D + 0.2D;
            double d20 = (double)pBlockPos.getY() + random.nextDouble() * 0.6D + 0.2D;
            double d26 = (double)pBlockPos.getZ() + random.nextDouble() * 0.6D + 0.2D;
            this.level.addParticle(ParticleTypes.SMOKE, d15, d20, d26, 0.0D, 0.0D, 0.0D);
         }
         break;
      case 1503:
         this.level.playLocalSound(pBlockPos, SoundEvents.END_PORTAL_FRAME_FILL, SoundCategory.BLOCKS, 1.0F, 1.0F, false);

         for(int k1 = 0; k1 < 16; ++k1) {
            double d14 = (double)pBlockPos.getX() + (5.0D + random.nextDouble() * 6.0D) / 16.0D;
            double d19 = (double)pBlockPos.getY() + 0.8125D;
            double d25 = (double)pBlockPos.getZ() + (5.0D + random.nextDouble() * 6.0D) / 16.0D;
      ...
      case 2000:
         ...
         double d18 = (double)pBlockPos.getX() + (double)j1 * 0.6D + 0.5D;
         double d24 = (double)pBlockPos.getY() + (double)j2 * 0.6D + 0.5D;
         double d28 = (double)pBlockPos.getZ() + (double)k2 * 0.6D + 0.5D;
      ...
      case 2001:
         ...
         if (!blockstate.isAir(this.level, pBlockPos)) {
            SoundType soundtype = blockstate.getSoundType(this.level, pBlockPos, null);
            this.level.playLocalSound(pBlockPos, soundtype.getBreakSound(), SoundCategory.BLOCKS, (soundtype.getVolume() + 1.0F) / 2.0F, soundtype.getPitch() * 0.8F, false);
         }

         this.minecraft.particleEngine.destroy(pBlockPos, blockstate);
         break;
      case 2002:
      case 2007:
         Vector3d vector3d = Vector3d.atBottomCenterOf(pBlockPos);
         ...
         IParticleData iparticledata = pType == 2007 ? ParticleTypes.INSTANT_EFFECT : ParticleTypes.EFFECT;
         ...
         this.level.playLocalSound(pBlockPos, SoundEvents.SPLASH_POTION_BREAK, SoundCategory.NEUTRAL, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 2003:
         double d0 = (double)pBlockPos.getX() + 0.5D;
         double d13 = (double)pBlockPos.getY();
         double d17 = (double)pBlockPos.getZ() + 0.5D;
      ...
      case 2004:
         for(int l = 0; l < 20; ++l) {
            double d12 = (double)pBlockPos.getX() + 0.5D + (random.nextDouble() - 0.5D) * 2.0D;
            double d16 = (double)pBlockPos.getY() + 0.5D + (random.nextDouble() - 0.5D) * 2.0D;
            double d21 = (double)pBlockPos.getZ() + 0.5D + (random.nextDouble() - 0.5D) * 2.0D;
      ...
      case 2006:
         for(int k = 0; k < 200; ++k) {
            ...
            Particle particle = this.addParticleInternal(ParticleTypes.DRAGON_BREATH, false, (double)pBlockPos.getX() + d1 * 0.1D, (double)pBlockPos.getY() + 0.3D, (double)pBlockPos.getZ() + d3 * 0.1D, d1, d2, d3);
            if (particle != null) {
               particle.setPower(f);
            }
         }
         ...
         if (pData == 1) {
            this.level.playLocalSound(pBlockPos, SoundEvents.DRAGON_FIREBALL_EXPLODE, SoundCategory.HOSTILE, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
         }
         break;
      case 2008:
      ...
      case 3000:
         ...
         this.level.playLocalSound(pBlockPos, SoundEvents.END_GATEWAY_SPAWN, SoundCategory.BLOCKS, 10.0F, (1.0F + (this.level.random.nextFloat() - this.level.random.nextFloat()) * 0.2F) * 0.7F, false);
         break;
      case 3001:
         this.level.playLocalSound(pBlockPos, SoundEvents.ENDER_DRAGON_GROWL, SoundCategory.HOSTILE, 64.0F, 0.8F + this.level.random.nextFloat() * 0.3F, false);
      }
   ...
   public void destroyBlockProgress(int pBreakerId, BlockPos pPos, int pProgress) {
      if (pProgress >= 0 && pProgress < 10) {
         DestroyBlockProgress destroyblockprogress1 = this.destroyingBlocks.get(pBreakerId);
         if (destroyblockprogress1 != null) {
            this.removeProgress(destroyblockprogress1);
         }

         if (destroyblockprogress1 == null || destroyblockprogress1.getPos().getX() != pPos.getX() || destroyblockprogress1.getPos().getY() != pPos.getY() || destroyblockprogress1.getPos().getZ() != pPos.getZ()) {
            destroyblockprogress1 = new DestroyBlockProgress(pBreakerId, pPos);
            this.destroyingBlocks.put(pBreakerId, destroyblockprogress1);
         }

         destroyblockprogress1.setProgress(pProgress);
         ...
         DestroyBlockProgress destroyblockprogress = this.destroyingBlocks.remove(pBreakerId);
   ...
   public void updateGlobalBlockEntities(Collection<TileEntity> pTileEntitiesToRemove, Collection<TileEntity> pTileEntitiesToAdd) {
      synchronized(this.globalBlockEntities) {
