...
public class ItemColors {
   ...
   public static ItemColors createDefault(BlockColors pColors) {
      ...
      itemcolors.register((p_210235_1_, p_210235_2_) -> {
         ...
         return pColors.getColor(blockstate, (IBlockDisplayReader)null, (BlockPos)null, p_210235_2_);
   ...
   public int getColor(ItemStack pStack, int pTintIndex) {
      IItemColor iitemcolor = this.itemColors.get(pStack.getItem().delegate);
      return iitemcolor == null ? -1 : iitemcolor.getColor(pStack, pTintIndex);
   }

   public void register(IItemColor pItemColor, IItemProvider... pItems) {
      for(IItemProvider iitemprovider : pItems) {
         this.itemColors.put(iitemprovider.asItem().delegate, pItemColor);
      }
