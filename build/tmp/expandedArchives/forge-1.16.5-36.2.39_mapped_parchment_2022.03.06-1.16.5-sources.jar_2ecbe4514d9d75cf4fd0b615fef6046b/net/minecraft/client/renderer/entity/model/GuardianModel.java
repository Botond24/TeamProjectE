...
public class GuardianModel extends SegmentedModel<GuardianEntity> {
    ...
    */
   public void setupAnim(GuardianEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
      ...
      if (entity != null) {
         ...
         Vector3d vector3d1 = pEntity.getEyePosition(0.0F);
         ...
         Vector3d vector3d2 = pEntity.getViewVector(0.0F);
