...
public class GlDebugTextUtils {
   ...
   protected static final ByteBuffer BYTE_BUFFER = GLAllocation.createByteBuffer(64);
   ...
   private static String sourceToString(int pSource) {
      switch(pSource) {
      case 33350:
         return "API";
      case 33351:
   ...
   private static String typeToString(int pType) {
      switch(pType) {
      case 33356:
         return "ERROR";
      case 33357:
   ...
   private static String severityToString(int pSeverity) {
      switch(pSeverity) {
      case 33387:
         return "NOTIFICATION";
      case 37190:
   ...
   /**
    * 
    * @param p_209244_0_ The GLenum source represented as an ordinal integer.
    * @param p_209244_1_ The GLenum type represented as an ordinal integer.
    * @param p_209244_2_ The unbounded integer id of the message callback.
    * @param p_209244_3_ The GLenum severity represented as an ordinal integer.
    * @param p_209244_4_ The {@link org.lwjgl.opengl.GLDebugMessageCallback} length argument.
    * @param p_209244_5_ The {@link org.lwjgl.opengl.GLDebugMessageCallback} message argument
    * @param p_209244_7_ An user supplied pointer that will be passed on each invocation of callback.
    */
   ...
   private static void setup(int p_209243_0_, String p_209243_1_) {
      BY_ID.merge(p_209243_0_, p_209243_1_, (p_209249_0_, p_209249_1_) -> {
   ...
   public static void enableDebugCallback(int pDebugVerbosity, boolean pSynchronous) {
      ...
      if (pDebugVerbosity > 0) {
         ...
         if (glcapabilities.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(GlDebugTextUtils::printDebugLog), LWJGLMemoryUntracker::untrack), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(GlDebugTextUtils::printDebugLog), LWJGLMemoryUntracker::untrack), 0L);
         }
