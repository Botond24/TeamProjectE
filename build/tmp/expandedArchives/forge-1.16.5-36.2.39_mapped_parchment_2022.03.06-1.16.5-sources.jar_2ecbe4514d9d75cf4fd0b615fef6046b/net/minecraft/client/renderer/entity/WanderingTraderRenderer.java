...
public class WanderingTraderRenderer extends MobRenderer<WanderingTraderEntity, VillagerModel<WanderingTraderEntity>> {
    ...
    */
   public ResourceLocation getTextureLocation(WanderingTraderEntity pEntity) {
      return VILLAGER_BASE_SKIN;
   }

   protected void scale(WanderingTraderEntity pLivingEntity, MatrixStack pMatrixStack, float pPartialTickTime) {
      float f = 0.9375F;
