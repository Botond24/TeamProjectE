...
public class VillagerRenderer extends MobRenderer<VillagerEntity, VillagerModel<VillagerEntity>> {
    ...
    */
   public ResourceLocation getTextureLocation(VillagerEntity pEntity) {
      return VILLAGER_BASE_SKIN;
   }

   protected void scale(VillagerEntity pLivingEntity, MatrixStack pMatrixStack, float pPartialTickTime) {
      float f = 0.9375F;
