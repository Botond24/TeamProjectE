...
public enum FaceDirection {
   ...
   public static FaceDirection fromFacing(Direction pFacing) {
      return BY_FACING[pFacing.get3DDataValue()];
   }

   private FaceDirection(FaceDirection.VertexInformation... pInfos) {
      this.infos = pInfos;
   }

   public FaceDirection.VertexInformation getVertexInfo(int pIndex) {
