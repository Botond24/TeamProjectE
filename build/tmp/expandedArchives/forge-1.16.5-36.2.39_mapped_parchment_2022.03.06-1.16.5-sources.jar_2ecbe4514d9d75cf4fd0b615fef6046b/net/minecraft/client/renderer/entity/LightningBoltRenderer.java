...
public class LightningBoltRenderer extends EntityRenderer<LightningBoltEntity> {
   ...
   public void render(LightningBoltEntity pEntity, float pEntityYaw, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pPackedLight) {
    ...
    */
   public ResourceLocation getTextureLocation(LightningBoltEntity pEntity) {
