...
public class BipedArmorLayer<T extends LivingEntity, M extends BipedModel<T>, A extends BipedModel<T>> extends LayerRenderer<T, M> {
   ...
   public void render(MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pPackedLight, T pLivingEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTicks, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
      this.renderArmorPiece(pMatrixStack, pBuffer, pLivingEntity, EquipmentSlotType.CHEST, pPackedLight, this.getArmorModel(EquipmentSlotType.CHEST));
      this.renderArmorPiece(pMatrixStack, pBuffer, pLivingEntity, EquipmentSlotType.LEGS, pPackedLight, this.getArmorModel(EquipmentSlotType.LEGS));
      this.renderArmorPiece(pMatrixStack, pBuffer, pLivingEntity, EquipmentSlotType.FEET, pPackedLight, this.getArmorModel(EquipmentSlotType.FEET));
