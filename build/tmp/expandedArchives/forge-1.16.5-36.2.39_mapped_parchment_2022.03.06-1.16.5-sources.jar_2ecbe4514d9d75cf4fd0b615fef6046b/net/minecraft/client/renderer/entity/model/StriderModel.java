...
public class StriderModel<T extends StriderEntity> extends SegmentedModel<T> {
    ...
    */
   public void setupAnim(StriderEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
      pLimbSwingAmount = Math.min(0.25F, pLimbSwingAmount);
      if (pEntity.getPassengers().size() <= 0) {
      ...
      float f = 1.5F;
      this.body.zRot = 0.1F * MathHelper.sin(pLimbSwing * 1.5F) * 4.0F * pLimbSwingAmount;
      this.body.y = 2.0F;
      this.body.y -= 2.0F * MathHelper.cos(pLimbSwing * 1.5F) * 2.0F * pLimbSwingAmount;
      this.leftLeg.xRot = MathHelper.sin(pLimbSwing * 1.5F * 0.5F) * 2.0F * pLimbSwingAmount;
      this.rightLeg.xRot = MathHelper.sin(pLimbSwing * 1.5F * 0.5F + (float)Math.PI) * 2.0F * pLimbSwingAmount;
      this.leftLeg.zRot = 0.17453292F * MathHelper.cos(pLimbSwing * 1.5F * 0.5F) * pLimbSwingAmount;
      this.rightLeg.zRot = 0.17453292F * MathHelper.cos(pLimbSwing * 1.5F * 0.5F + (float)Math.PI) * pLimbSwingAmount;
      this.leftLeg.y = 8.0F + 2.0F * MathHelper.sin(pLimbSwing * 1.5F * 0.5F + (float)Math.PI) * 2.0F * pLimbSwingAmount;
      this.rightLeg.y = 8.0F + 2.0F * MathHelper.sin(pLimbSwing * 1.5F * 0.5F) * 2.0F * pLimbSwingAmount;
      ...
      float f1 = MathHelper.cos(pLimbSwing * 1.5F + (float)Math.PI) * pLimbSwingAmount;
      ...
      float f2 = 1.0F;
      float f3 = 1.0F;
      this.bristle0.zRot += 0.05F * MathHelper.sin(pAgeInTicks * 1.0F * -0.4F);
      this.bristle1.zRot += 0.1F * MathHelper.sin(pAgeInTicks * 1.0F * 0.2F);
      this.bristle2.zRot += 0.1F * MathHelper.sin(pAgeInTicks * 1.0F * 0.4F);
      this.bristle3.zRot += 0.1F * MathHelper.sin(pAgeInTicks * 1.0F * 0.4F);
      this.bristle4.zRot += 0.1F * MathHelper.sin(pAgeInTicks * 1.0F * 0.2F);
      this.bristle5.zRot += 0.05F * MathHelper.sin(pAgeInTicks * 1.0F * -0.4F);
   }
