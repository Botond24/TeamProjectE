...
public class DragonFireballRenderer extends EntityRenderer<DragonFireballEntity> {
   ...
   protected int getBlockLightLevel(DragonFireballEntity pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(DragonFireballEntity pEntity, float pEntityYaw, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pPackedLight) {
    ...
    */
   public ResourceLocation getTextureLocation(DragonFireballEntity pEntity) {
