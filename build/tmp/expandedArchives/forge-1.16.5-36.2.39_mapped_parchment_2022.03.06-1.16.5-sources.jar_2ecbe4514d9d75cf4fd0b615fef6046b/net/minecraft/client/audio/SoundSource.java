...
public class SoundSource {
   ...
   private SoundSource(int pSource) {
      this.source = pSource;
   }
   ...
   public void setSelfPosition(Vector3d pSource) {
   ...
   public void attachStaticBuffer(AudioStreamBuffer pBuffer) {
      pBuffer.getAlBuffer().ifPresent((p_216431_1_) -> {
         AL10.alSourcei(this.source, 4105, p_216431_1_);
      });
   }

   public void attachBufferStream(IAudioStream pStream) {
      this.stream = pStream;
