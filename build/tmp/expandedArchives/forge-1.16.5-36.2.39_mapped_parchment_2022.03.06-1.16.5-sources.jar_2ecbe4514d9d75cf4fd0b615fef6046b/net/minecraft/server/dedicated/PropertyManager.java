...
public abstract class PropertyManager<T extends PropertyManager<T>> {
   ...
   public static Properties loadFromFile(Path pPath) {
      ...
      try (InputStream inputstream = Files.newInputStream(pPath)) {
         ...
         LOGGER.error("Failed to load properties from file: " + pPath);
      }
   ...
   public void store(Path pPath) {
      try (OutputStream outputstream = Files.newOutputStream(pPath)) {
   ...
   private static <V extends Number> Function<String, V> wrapNumberDeserializer(Function<String, V> pParseFunc) {
      return (p_218975_1_) -> {
         try {
            return pParseFunc.apply(p_218975_1_);
   ...
   protected static <V> Function<String, V> dispatchNumberOrString(IntFunction<V> pById, Function<String, V> pByName) {
      return (p_218971_2_) -> {
         try {
            return pById.apply(Integer.parseInt(p_218971_2_));
         } catch (NumberFormatException numberformatexception) {
            return pByName.apply(p_218971_2_);
         }
      };
   }
   ...
   protected String get(String pKey, String p_218973_2_) {
      return this.get(pKey, Function.identity(), Function.identity(), p_218973_2_);
   }
   ...
   protected int get(String pKey, int p_218968_2_) {
      return this.get(pKey, wrapNumberDeserializer(Integer::parseInt), p_218968_2_);
   }
   ...
   protected boolean get(String pKey, boolean p_218982_2_) {
      return this.get(pKey, Boolean::valueOf, p_218982_2_);
   }
