...
public class PlayerProfileCache {
   ...
   @Nullable
   private static GameProfile lookupGameProfile(GameProfileRepository pProfileRepo, String pName) {
      ...
      if (!usesAuthentication() && gameprofile == null) {
         UUID uuid = PlayerEntity.createPlayerUUID(new GameProfile((UUID)null, pName));
         gameprofile = new GameProfile(uuid, pName);
      }
   ...
   public void add(GameProfile pGameProfile) {
      ...
      PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = new PlayerProfileCache.ProfileEntry(pGameProfile, date);
    ...
    */
   @Nullable
   public GameProfile get(String pUsername) {
    ...
    */
   @Nullable
   public GameProfile get(UUID pUuid) {
      PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = this.profilesByUUID.get(pUuid);
      if (playerprofilecache$profileentry == null) {
         return null;
      } else {
         playerprofilecache$profileentry.setLastAccess(this.getNextOperation());
