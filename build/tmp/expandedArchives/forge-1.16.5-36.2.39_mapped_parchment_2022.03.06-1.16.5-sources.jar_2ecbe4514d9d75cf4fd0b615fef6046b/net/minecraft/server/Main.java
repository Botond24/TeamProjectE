...
public class Main {
   ...
   private static void forceUpgrade(SaveFormat.LevelSave pLevelStorage, DataFixer pFixer, boolean pClearHeightAndLightMaps, BooleanSupplier p_240761_3_, ImmutableSet<RegistryKey<World>> p_240761_4_) {
      LOGGER.info("Forcing world upgrade!");
      WorldOptimizer worldoptimizer = new WorldOptimizer(pLevelStorage, pFixer, p_240761_4_, pClearHeightAndLightMaps);
