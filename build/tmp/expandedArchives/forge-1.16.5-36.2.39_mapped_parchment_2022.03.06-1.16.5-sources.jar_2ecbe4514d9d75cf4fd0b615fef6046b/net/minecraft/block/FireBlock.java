...
public class FireBlock extends AbstractFireBlock {
   ...
   protected BlockState getStateForPlacement(IBlockReader pLevel, BlockPos pPos) {
   ...
   protected boolean isNearRain(World pLevel, BlockPos pPos) {
   ...
   public int getBurnOdd(BlockState pState) {
   ...
   public int getFlameOdds(BlockState pState) {
