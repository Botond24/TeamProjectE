...
public class RailState {
   ...
   public RailState(World pLevel, BlockPos pPos, BlockState pState) {
      this.level = pLevel;
      this.pos = pPos;
      this.state = pState;
      this.block = (AbstractRailBlock)pState.getBlock();
   ...
   private boolean hasRail(BlockPos pPos) {
      return AbstractRailBlock.isRail(this.level, pPos) || AbstractRailBlock.isRail(this.level, pPos.above()) || AbstractRailBlock.isRail(this.level, pPos.below());
   }
