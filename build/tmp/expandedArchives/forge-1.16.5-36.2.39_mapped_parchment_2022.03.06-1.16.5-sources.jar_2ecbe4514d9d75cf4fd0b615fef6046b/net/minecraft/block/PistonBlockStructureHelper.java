...
public class PistonBlockStructureHelper {
   ...
   public PistonBlockStructureHelper(World pLevel, BlockPos pPistonPos, Direction pPistonDirection, boolean pExtending) {
      this.level = pLevel;
   ...
   private boolean addBlockLine(BlockPos pOriginPos, Direction pDirection) {
      ...
      if (level.isEmptyBlock(pOriginPos)) {
         return true;
      } else if (!PistonBlock.isPushable(blockstate, this.level, pOriginPos, this.pushDirection, false, pDirection)) {
         return true;
