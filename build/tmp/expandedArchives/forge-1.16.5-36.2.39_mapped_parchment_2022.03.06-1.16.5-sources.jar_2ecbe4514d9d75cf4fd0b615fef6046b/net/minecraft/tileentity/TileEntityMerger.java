...
public class TileEntityMerger {
   public static <S extends TileEntity> TileEntityMerger.ICallbackWrapper<S> combineWithNeigbour(TileEntityType<S> pBlockEntityType, Function<BlockState, TileEntityMerger.Type> p_226924_1_, Function<BlockState, Direction> p_226924_2_, DirectionProperty p_226924_3_, BlockState p_226924_4_, IWorld p_226924_5_, BlockPos p_226924_6_, BiPredicate<IWorld, BlockPos> p_226924_7_) {
      S s = pBlockEntityType.getBlockEntity(p_226924_5_, p_226924_6_);
      if (s == null) {
         ...
         if (flag) {
            ...
            BlockPos blockpos = p_226924_6_.relative(p_226924_2_.apply(p_226924_4_));
            BlockState blockstate = p_226924_5_.getBlockState(blockpos);
            if (blockstate.is(p_226924_4_.getBlock())) {
               TileEntityMerger.Type tileentitymerger$type1 = p_226924_1_.apply(blockstate);
               if (tileentitymerger$type1 != TileEntityMerger.Type.SINGLE && tileentitymerger$type != tileentitymerger$type1 && blockstate.getValue(p_226924_3_) == p_226924_4_.getValue(p_226924_3_)) {
                  if (p_226924_7_.test(p_226924_5_, blockpos)) {
                     return TileEntityMerger.ICallback::acceptNone;
                  }

                  S s1 = pBlockEntityType.getBlockEntity(p_226924_5_, blockpos);
                  if (s1 != null) {
                     S s2 = flag1 ? s : s1;
                     S s3 = flag1 ? s1 : s;
   ...
   public interface ICallback<S, T> {
      T acceptDouble(S p_225539_1_, S p_225539_2_);

      T acceptSingle(S p_225538_1_);
   ...
   public interface ICallbackWrapper<S> {
      ...
      public static final class Double<S> implements TileEntityMerger.ICallbackWrapper<S> {
         ...
         public Double(S p_i225760_1_, S p_i225760_2_) {
            this.first = p_i225760_1_;
            this.second = p_i225760_2_;
         }

         public <T> T apply(TileEntityMerger.ICallback<? super S, T> p_apply_1_) {
            return p_apply_1_.acceptDouble(this.first, this.second);
         }
      }
      ...
      public static final class Single<S> implements TileEntityMerger.ICallbackWrapper<S> {
         ...
         public Single(S p_i225761_1_) {
            this.single = p_i225761_1_;
         }

         public <T> T apply(TileEntityMerger.ICallback<? super S, T> p_apply_1_) {
            return p_apply_1_.acceptSingle(this.single);
         }
      }
   }
