...
public class BeehiveTileEntity extends TileEntity implements ITickableTileEntity {
   ...
   public void emptyAllLivingFromHive(@Nullable PlayerEntity pPlayer, BlockState pState, BeehiveTileEntity.State pReleaseStatus) {
   ...
   private List<Entity> releaseAllOccupants(BlockState pState, BeehiveTileEntity.State pReleaseStatus) {
