...
public abstract class JigsawPiece {
   ...
   protected JigsawPiece(JigsawPattern.PlacementBehaviour pProjection) {
      this.projection = pProjection;
   }

   public abstract List<Template.BlockInfo> getShuffledJigsawBlocks(TemplateManager pTemplateManager, BlockPos pPos, Rotation pRotation, Random pRandom);

   public abstract MutableBoundingBox getBoundingBox(TemplateManager pTemplateManager, BlockPos pPos, Rotation pRotation);
   ...
   public void handleDataMarker(IWorld pLevel, Template.BlockInfo pBlockInfo, BlockPos pPos, Rotation pRotation, Random pRandom, MutableBoundingBox p_214846_6_) {
   }

   public JigsawPiece setProjection(JigsawPattern.PlacementBehaviour pDecoratorBehaviour) {
