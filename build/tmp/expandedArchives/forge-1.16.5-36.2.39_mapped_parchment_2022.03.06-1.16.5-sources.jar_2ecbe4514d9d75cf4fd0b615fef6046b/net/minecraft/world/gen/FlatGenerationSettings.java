...
public class FlatGenerationSettings {
   ...
   public FlatGenerationSettings(DimensionStructuresSettings pSettings, Registry<Biome> pBiomes) {
      this.biomes = pBiomes;
      this.structureSettings = pSettings;
      this.biome = () -> {
   ...
   @OnlyIn(Dist.CLIENT)
   public FlatGenerationSettings withStructureSettings(DimensionStructuresSettings pSettings) {
      return this.withLayers(this.layersInfo, pSettings);
   }

   @OnlyIn(Dist.CLIENT)
   public FlatGenerationSettings withLayers(List<FlatLayerInfo> pFlatLayers, DimensionStructuresSettings pSettings) {
      FlatGenerationSettings flatgenerationsettings = new FlatGenerationSettings(pSettings, this.biomes);
   ...
   @OnlyIn(Dist.CLIENT)
   public void setBiome(Supplier<Biome> pBiome) {
      this.biome = pBiome;
   }
   ...
   public static FlatGenerationSettings getDefault(Registry<Biome> pBiomes) {
      ...
      FlatGenerationSettings flatgenerationsettings = new FlatGenerationSettings(dimensionstructuressettings, pBiomes);
