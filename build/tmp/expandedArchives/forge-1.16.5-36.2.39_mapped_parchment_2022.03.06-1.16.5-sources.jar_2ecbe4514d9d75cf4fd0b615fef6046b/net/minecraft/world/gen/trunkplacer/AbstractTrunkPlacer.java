...
public abstract class AbstractTrunkPlacer {
   ...
   protected static <P extends AbstractTrunkPlacer> P3<Mu<P>, Integer, Integer, Integer> trunkPlacerParts(Instance<P> pInstance) {
      return pInstance.group(Codec.intRange(0, 32).fieldOf("base_height").forGetter((p_236919_0_) -> {
   ...
   public AbstractTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
   ...
   private static boolean isDirt(IWorldGenerationBaseReader pLevel, BlockPos pPos) {
      return pLevel.isStateAtPosition(pPos, (p_236914_0_) -> {
