...
public abstract class WorldCarver<C extends ICarverConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<WorldCarver<?>> {
   ...
   private static <C extends ICarverConfig, F extends WorldCarver<C>> F register(String pKey, F pCarver) {
   ...
   private boolean isEdge(int pMinX, int pMaxX, int pMinZ, int pMaxZ, int pX, int pZ) {
      return pX == pMinX || pX == pMaxX - 1 || pZ == pMinZ || pZ == pMaxZ - 1;
   }
