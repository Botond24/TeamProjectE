...
public class JunglePyramidPiece extends ScatteredStructurePiece {
   ...
   public JunglePyramidPiece(Random pRandom, int pX, int pZ) {
      super(IStructurePieceType.JUNGLE_PYRAMID_PIECE, pRandom, pX, 64, pZ, 12, 10, 15);
   }
   ...
   public boolean postProcess(ISeedReader pLevel, StructureManager pStructureManager, ChunkGenerator pChunkGenerator, Random pRandom, MutableBoundingBox pBox, ChunkPos pChunkPos, BlockPos pPos) {
      if (!this.updateAverageGroundHeight(pLevel, pBox, 0)) {
         ...
         if (!this.placedTrap1) {
            this.placedTrap1 = this.createDispenser(pLevel, pBox, pRandom, 3, -2, 1, Direction.NORTH, LootTables.JUNGLE_TEMPLE_DISPENSER);
         }
         ...
         if (!this.placedTrap2) {
            this.placedTrap2 = this.createDispenser(pLevel, pBox, pRandom, 9, -2, 3, Direction.WEST, LootTables.JUNGLE_TEMPLE_DISPENSER);
         }
         ...
         if (!this.placedMainChest) {
            this.placedMainChest = this.createChest(pLevel, pBox, pRandom, 8, -3, 3, LootTables.JUNGLE_TEMPLE);
         }
         ...
         this.placeBlock(pLevel, Blocks.STICKY_PISTON.defaultBlockState().setValue(PistonBlock.FACING, Direction.UP), 9, -2, 8, pBox);
         this.placeBlock(pLevel, Blocks.STICKY_PISTON.defaultBlockState().setValue(PistonBlock.FACING, Direction.WEST), 10, -2, 8, pBox);
         this.placeBlock(pLevel, Blocks.STICKY_PISTON.defaultBlockState().setValue(PistonBlock.FACING, Direction.WEST), 10, -1, 8, pBox);
         this.placeBlock(pLevel, Blocks.REPEATER.defaultBlockState().setValue(RepeaterBlock.FACING, Direction.NORTH), 10, -2, 10, pBox);
         if (!this.placedHiddenChest) {
            this.placedHiddenChest = this.createChest(pLevel, pBox, pRandom, 9, -3, 10, LootTables.JUNGLE_TEMPLE);
         }
