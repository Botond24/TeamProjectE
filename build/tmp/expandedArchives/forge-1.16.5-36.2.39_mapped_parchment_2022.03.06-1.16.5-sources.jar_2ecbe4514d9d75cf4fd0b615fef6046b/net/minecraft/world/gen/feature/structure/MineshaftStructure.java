...
public class MineshaftStructure extends Structure<MineshaftConfig> {
   ...
   protected boolean isFeatureChunk(ChunkGenerator p_230363_1_, BiomeProvider p_230363_2_, long p_230363_3_, SharedSeedRandom p_230363_5_, int p_230363_6_, int p_230363_7_, Biome p_230363_8_, ChunkPos p_230363_9_, MineshaftConfig p_230363_10_) {
   ...
   public static class Start extends StructureStart<MineshaftConfig> {
      ...
      public void generatePieces(DynamicRegistries p_230364_1_, ChunkGenerator p_230364_2_, TemplateManager p_230364_3_, int p_230364_4_, int p_230364_5_, Biome p_230364_6_, MineshaftConfig p_230364_7_) {
         MineshaftPieces.Room mineshaftpieces$room = new MineshaftPieces.Room(0, this.random, (p_230364_4_ << 4) + 2, (p_230364_5_ << 4) + 2, p_230364_7_.type);
         ...
         if (p_230364_7_.type == MineshaftStructure.Type.MESA) {
            int i = -5;
            int j = p_230364_2_.getSeaLevel() - this.boundingBox.y1 + this.boundingBox.getYSpan() / 2 - -5;
   ...
   public static enum Type implements IStringSerializable {
      ...
      public static final Codec<MineshaftStructure.Type> CODEC = IStringSerializable.fromEnum(MineshaftStructure.Type::values, MineshaftStructure.Type::byName);
