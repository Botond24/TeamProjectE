...
public class OctavesNoiseGenerator implements INoiseGenerator {
   ...
   public double getValue(double pX, double pY, double pZ, double p_215462_7_, double p_215462_9_, boolean p_215462_11_) {
      double d0 = 0.0D;
      ...
      for(int i = 0; i < this.noiseLevels.length; ++i) {
         ...
         if (improvednoisegenerator != null) {
            d0 += this.amplitudes.getDouble(i) * improvednoisegenerator.noise(wrap(pX * d1), p_215462_11_ ? -improvednoisegenerator.yo : wrap(pY * d1), wrap(pZ * d1), p_215462_7_ * d1, p_215462_9_ * d1) * d2;
         }
   ...
   @Nullable
   public ImprovedNoiseGenerator getOctaveNoise(int pOctaveIndex) {
   ...
   public double getSurfaceNoiseValue(double pX, double pY, double pZ, double p_215460_7_) {
      return this.getValue(pX, pY, 0.0D, pZ, p_215460_7_, false);
   }
}