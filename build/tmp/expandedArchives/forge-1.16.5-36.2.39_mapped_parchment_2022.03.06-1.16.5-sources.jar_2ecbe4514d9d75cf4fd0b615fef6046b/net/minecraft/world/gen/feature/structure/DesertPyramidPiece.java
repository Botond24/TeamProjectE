...
public class DesertPyramidPiece extends ScatteredStructurePiece {
   ...
   public DesertPyramidPiece(Random pRandom, int pX, int pZ) {
      super(IStructurePieceType.DESERT_PYRAMID_PIECE, pRandom, pX, 64, pZ, 21, 15, 21);
   }
   ...
   public boolean postProcess(ISeedReader pLevel, StructureManager pStructureManager, ChunkGenerator pChunkGenerator, Random pRandom, MutableBoundingBox pBox, ChunkPos pChunkPos, BlockPos pPos) {
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         if (!this.hasPlacedChest[direction.get2DDataValue()]) {
            ...
            this.hasPlacedChest[direction.get2DDataValue()] = this.createChest(pLevel, pBox, pRandom, 10 + i1, -11, 10 + j1, LootTables.DESERT_PYRAMID);
         }
      }
