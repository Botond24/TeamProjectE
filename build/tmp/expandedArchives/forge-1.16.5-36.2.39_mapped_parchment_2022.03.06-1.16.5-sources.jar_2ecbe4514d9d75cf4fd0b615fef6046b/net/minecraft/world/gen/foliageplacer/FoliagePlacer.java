...
public abstract class FoliagePlacer {
   ...
   public abstract int foliageHeight(Random pRandom, int pHeight, BaseTreeFeatureConfig pConfig);
   ...
   protected abstract boolean shouldSkipLocation(Random pRandom, int p_230373_2_, int p_230373_3_, int p_230373_4_, int p_230373_5_, boolean p_230373_6_);

   protected boolean shouldSkipLocationSigned(Random pRandom, int p_230375_2_, int p_230375_3_, int p_230375_4_, int p_230375_5_, boolean p_230375_6_) {
      int i;
      int j;
      if (p_230375_6_) {
      ...
      return this.shouldSkipLocation(pRandom, i, p_230375_3_, j, p_230375_5_, p_230375_6_);
   }
   ...
   public static final class Foliage {
      ...
      public Foliage(BlockPos pPos, int pRadiusOffset, boolean pDoubleTrunk) {
         this.foliagePos = pPos;
