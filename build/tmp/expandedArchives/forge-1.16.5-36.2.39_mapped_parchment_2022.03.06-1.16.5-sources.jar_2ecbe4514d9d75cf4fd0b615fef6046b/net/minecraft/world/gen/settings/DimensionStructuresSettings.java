...
public class DimensionStructuresSettings {
   ...
   public DimensionStructuresSettings(boolean pWithStronghold) {
      this.structureConfig = Maps.newHashMap(DEFAULTS);
      this.stronghold = pWithStronghold ? DEFAULT_STRONGHOLD : null;
   }
   ...
   @Nullable
   public StructureSeparationSettings getConfig(Structure<?> pStructure) {
      return this.structureConfig.get(pStructure);
   }
