...
public enum JigsawOrientation implements IStringSerializable {
   ...
   private static int lookupKey(Direction pFront, Direction pTop) {
      return pFront.ordinal() << 3 | pTop.ordinal();
   }

   private JigsawOrientation(String pName, Direction pFront, Direction pTop) {
      this.name = pName;
      this.front = pFront;
      this.top = pTop;
   }
   ...
   public static JigsawOrientation fromFrontAndTop(Direction pFront, Direction pTop) {
      int i = lookupKey(pTop, pFront);
