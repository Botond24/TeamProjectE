...
public class StructureFeatures {
   ...
   private static <FC extends IFeatureConfig, F extends Structure<FC>> StructureFeature<FC, F> register(String pId, StructureFeature<FC, F> pConfiguredStructureFeature) {
      return WorldGenRegistries.register(WorldGenRegistries.CONFIGURED_STRUCTURE_FEATURE, pId, pConfiguredStructureFeature);
   }
}