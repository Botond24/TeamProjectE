...
public class ConfiguredCarvers {
   ...
   private static <WC extends ICarverConfig> ConfiguredCarver<WC> register(String pId, ConfiguredCarver<WC> pCarver) {
      return WorldGenRegistries.register(WorldGenRegistries.CONFIGURED_CARVER, pId, pCarver);
   }
}