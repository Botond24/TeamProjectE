...
public abstract class StructureStart<C extends IFeatureConfig> {
      ...
      synchronized(this.pieces) {
         if (!this.pieces.isEmpty()) {
            ...
            while(iterator.hasNext()) {
               ...
               if (structurepiece.getBoundingBox().intersects(pBox) && !structurepiece.postProcess(pLevel, pStructureManager, pChunkGenerator, pRandom, pBox, pChunkPos, blockpos)) {
                  iterator.remove();
               }
            }
   ...
   protected void moveInsideHeights(Random pRandom, int p_214626_2_, int p_214626_3_) {
      int i = p_214626_3_ - p_214626_2_ + 1 - this.boundingBox.getYSpan();
      int j;
      if (i > 1) {
         j = p_214626_2_ + pRandom.nextInt(i);
      } else {
         j = p_214626_2_;
      }
