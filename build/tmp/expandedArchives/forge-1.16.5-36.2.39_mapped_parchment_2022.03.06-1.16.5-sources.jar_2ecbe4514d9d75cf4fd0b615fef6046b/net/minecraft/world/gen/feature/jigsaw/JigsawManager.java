...
public class JigsawManager {
   ...
   public static void addPieces(DynamicRegistries p_242837_0_, VillageConfig p_242837_1_, JigsawManager.IPieceFactory p_242837_2_, ChunkGenerator p_242837_3_, TemplateManager p_242837_4_, BlockPos p_242837_5_, List<? super AbstractVillagePiece> p_242837_6_, Random p_242837_7_, boolean p_242837_8_, boolean p_242837_9_) {
      ...
      if (p_242837_1_.maxDepth() > 0) {
         ...
         JigsawManager.Assembler jigsawmanager$assembler = new JigsawManager.Assembler(mutableregistry, p_242837_1_.maxDepth(), p_242837_2_, p_242837_3_, p_242837_4_, p_242837_6_, p_242837_7_);
   ...
   static final class Assembler {
      ...
      private Assembler(Registry<JigsawPattern> pPools, int pMaxDepth, JigsawManager.IPieceFactory pFactory, ChunkGenerator pChunkGenerator, TemplateManager pStructureManager, List<? super AbstractVillagePiece> pPieces, Random pRandom) {
         this.pools = pPools;
