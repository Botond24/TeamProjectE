...
public final class DimensionSettings {
   ...
   public boolean stable(RegistryKey<DimensionSettings> pSettings) {
      return Objects.equals(this, WorldGenRegistries.NOISE_GENERATOR_SETTINGS.get(pSettings));
   }

   private static DimensionSettings register(RegistryKey<DimensionSettings> pKey, DimensionSettings pSettings) {
      WorldGenRegistries.register(WorldGenRegistries.NOISE_GENERATOR_SETTINGS, pKey.location(), pSettings);
      return pSettings;
   }
