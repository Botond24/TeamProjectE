...
public class ListJigsawPiece extends JigsawPiece {
   ...
   public List<Template.BlockInfo> getShuffledJigsawBlocks(TemplateManager pTemplateManager, BlockPos pPos, Rotation pRotation, Random pRandom) {
      return this.elements.get(0).getShuffledJigsawBlocks(pTemplateManager, pPos, pRotation, pRandom);
   }
   ...
   public MutableBoundingBox getBoundingBox(TemplateManager pTemplateManager, BlockPos pPos, Rotation pRotation) {
      ...
      for(JigsawPiece jigsawpiece : this.elements) {
         MutableBoundingBox mutableboundingbox1 = jigsawpiece.getBoundingBox(pTemplateManager, pPos, pRotation);
   ...
   private void setProjectionOnEachElement(JigsawPattern.PlacementBehaviour pProjection) {
      this.elements.forEach((p_214863_1_) -> {
         p_214863_1_.setProjection(pProjection);
      });
   }
}