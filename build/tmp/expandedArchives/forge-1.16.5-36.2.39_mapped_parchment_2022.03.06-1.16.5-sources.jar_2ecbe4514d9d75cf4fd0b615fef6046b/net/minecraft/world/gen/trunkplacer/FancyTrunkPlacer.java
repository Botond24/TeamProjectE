...
public class FancyTrunkPlacer extends AbstractTrunkPlacer {
   ...
   private int getSteps(BlockPos pPos) {
      int i = MathHelper.abs(pPos.getX());
      int j = MathHelper.abs(pPos.getY());
      int k = MathHelper.abs(pPos.getZ());
   ...
   static class Foliage {
      ...
      public Foliage(BlockPos pPos, int pBranchBase) {
         this.attachment = new FoliagePlacer.Foliage(pPos, 0, false);
