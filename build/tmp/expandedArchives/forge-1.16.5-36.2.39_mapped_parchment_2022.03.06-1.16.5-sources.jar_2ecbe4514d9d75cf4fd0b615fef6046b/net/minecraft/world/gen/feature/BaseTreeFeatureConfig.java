...
public class BaseTreeFeatureConfig implements IFeatureConfig {
   ...
   public BaseTreeFeatureConfig withDecorators(List<TreeDecorator> pDecorators) {
      return new BaseTreeFeatureConfig(this.trunkProvider, this.leavesProvider, this.foliagePlacer, this.trunkPlacer, this.minimumSize, pDecorators, this.maxWaterDepth, this.ignoreVines, this.heightmap);
   }
   ...
   public static class Builder {
      ...
      public BaseTreeFeatureConfig.Builder decorators(List<TreeDecorator> pDecorators) {
