...
public class FortressPieces {
   ...
   public static class Corridor extends FortressPieces.Piece {
      ...
      public Corridor(int pGenDepth, Random pRandom, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_CASTLE_SMALL_CORRIDOR_LEFT_TURN, pGenDepth);
      ...
      public boolean postProcess(ISeedReader pLevel, StructureManager pStructureManager, ChunkGenerator pChunkGenerator, Random pRandom, MutableBoundingBox pBox, ChunkPos pChunkPos, BlockPos pPos) {
         ...
         if (this.isNeedingChest && pBox.isInside(new BlockPos(this.getWorldX(3, 3), this.getWorldY(2), this.getWorldZ(3, 3)))) {
            this.isNeedingChest = false;
            this.createChest(pLevel, pBox, pRandom, 3, 2, 3, LootTables.NETHER_BRIDGE);
         }
   ...
   public static class Corridor2 extends FortressPieces.Piece {
      ...
      public Corridor2(int pGenDepth, Random pRandom, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_CASTLE_SMALL_CORRIDOR_RIGHT_TURN, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
         this.isNeedingChest = pRandom.nextInt(3) == 0;
      }
      ...
      public boolean postProcess(ISeedReader pLevel, StructureManager pStructureManager, ChunkGenerator pChunkGenerator, Random pRandom, MutableBoundingBox pBox, ChunkPos pChunkPos, BlockPos pPos) {
         ...
         this.generateBox(pLevel, pBox, 1, 3, 4, 1, 4, 4, blockstate, blockstate, false);
         this.generateBox(pLevel, pBox, 3, 3, 4, 3, 4, 4, blockstate, blockstate, false);
         if (this.isNeedingChest && pBox.isInside(new BlockPos(this.getWorldX(1, 3), this.getWorldY(2), this.getWorldZ(1, 3)))) {
            this.isNeedingChest = false;
            this.createChest(pLevel, pBox, pRandom, 1, 2, 3, LootTables.NETHER_BRIDGE);
         }
   ...
   public static class Corridor3 extends FortressPieces.Piece {
      public Corridor3(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_CASTLE_CORRIDOR_STAIRS, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   public static class Corridor4 extends FortressPieces.Piece {
      public Corridor4(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_CASTLE_CORRIDOR_T_BALCONY, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   public static class Corridor5 extends FortressPieces.Piece {
      public Corridor5(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_CASTLE_SMALL_CORRIDOR, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   public static class Crossing extends FortressPieces.Piece {
      public Crossing(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_ROOM_CROSSING, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   public static class Crossing2 extends FortressPieces.Piece {
      public Crossing2(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_CASTLE_SMALL_CORRIDOR_CROSSING, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   public static class Crossing3 extends FortressPieces.Piece {
      public Crossing3(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_BRIDGE_CROSSING, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   public static class End extends FortressPieces.Piece {
      ...
      public End(int pGenDepth, Random pRandom, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_BRIDGE_END_FILLER, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
   ...
   public static class Entrance extends FortressPieces.Piece {
      public Entrance(int pGenDepth, Random pRandom, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_CASTLE_ENTRANCE, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
      ...
      public boolean postProcess(ISeedReader pLevel, StructureManager pStructureManager, ChunkGenerator pChunkGenerator, Random pRandom, MutableBoundingBox pBox, ChunkPos pChunkPos, BlockPos pPos) {
         ...
         if (pBox.isInside(blockpos)) {
            pLevel.getLiquidTicks().scheduleTick(blockpos, Fluids.LAVA, 0);
         }
   ...
   public static class NetherStalkRoom extends FortressPieces.Piece {
      public NetherStalkRoom(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_CASTLE_STALK_ROOM, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   abstract static class Piece extends StructurePiece {
      ...
      private int updatePieceWeight(List<FortressPieces.PieceWeight> pWeights) {
         boolean flag = false;
         int i = 0;

         for(FortressPieces.PieceWeight fortresspieces$pieceweight : pWeights) {
   ...
   static class PieceWeight {
      ...
      public PieceWeight(Class<? extends FortressPieces.Piece> pPieceClass, int pWeight, int pMaxPlaceCount, boolean pAllowInRow) {
      ...
      public PieceWeight(Class<? extends FortressPieces.Piece> pPieceClass, int pWeight, int pMaxPlaceCount) {
   ...
   public static class Stairs extends FortressPieces.Piece {
      public Stairs(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_STAIRS_ROOM, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   public static class Start extends FortressPieces.Crossing3 {
      ...
      public Start(Random pRandom, int pX, int pZ) {
         super(pRandom, pX, pZ);
   ...
   public static class Straight extends FortressPieces.Piece {
      public Straight(int pGenDepth, Random pRandom, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_BRIDGE_STRAIGHT, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
   ...
   public static class Throne extends FortressPieces.Piece {
      ...
      public Throne(int pGenDepth, MutableBoundingBox pBox, Direction pOrientation) {
         super(IStructurePieceType.NETHER_FORTRESS_MONSTER_THRONE, pGenDepth);
         this.setOrientation(pOrientation);
         this.boundingBox = pBox;
      }
