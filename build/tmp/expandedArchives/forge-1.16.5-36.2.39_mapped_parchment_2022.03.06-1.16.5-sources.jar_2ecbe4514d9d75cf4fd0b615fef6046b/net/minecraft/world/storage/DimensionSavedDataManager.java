...
public class DimensionSavedDataManager {
   ...
   public CompoundNBT readTagFromDisk(String pName, int pLevelVersion) throws IOException {
      ...
      try (
         ...
         compoundnbt1 = NBTUtil.update(this.fixerUpper, DefaultTypeReferences.SAVED_DATA, compoundnbt, i, pLevelVersion);
      }
