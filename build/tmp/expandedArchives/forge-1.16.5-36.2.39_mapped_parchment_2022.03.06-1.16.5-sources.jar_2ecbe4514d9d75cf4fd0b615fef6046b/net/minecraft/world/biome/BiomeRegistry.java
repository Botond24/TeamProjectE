...
public abstract class BiomeRegistry {
   ...
   private static Biome register(int pId, RegistryKey<Biome> pKey, Biome pBiome) {
      TO_NAME.put(pId, pKey);
      return WorldGenRegistries.registerMapping(WorldGenRegistries.BIOME, pId, pKey, pBiome);
   }

   public static RegistryKey<Biome> byId(int pId) {
      return ((net.minecraftforge.registries.ForgeRegistry<Biome>)net.minecraftforge.registries.ForgeRegistries.BIOMES).getKey(pId);
   }
