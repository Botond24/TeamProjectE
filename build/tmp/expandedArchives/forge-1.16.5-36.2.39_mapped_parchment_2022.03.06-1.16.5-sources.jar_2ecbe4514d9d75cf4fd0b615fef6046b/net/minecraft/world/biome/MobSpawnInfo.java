...
public class MobSpawnInfo {
   ...
   @Nullable
   public MobSpawnInfo.SpawnCosts getMobSpawnCost(EntityType<?> pEntityType) {
   ...
   public static class Builder {
      ...
      public MobSpawnInfo.Builder addSpawn(EntityClassification pClassification, MobSpawnInfo.Spawners pSpawner) {
         this.spawners.get(pClassification).add(pSpawner);
         return this;
      }

      public MobSpawnInfo.Builder addMobCharge(EntityType<?> pEntityType, double pSpawnCostPerEntity, double pMaxSpawnCost) {
         this.mobSpawnCosts.put(pEntityType, new MobSpawnInfo.SpawnCosts(pMaxSpawnCost, pSpawnCostPerEntity));
         return this;
      }

      public MobSpawnInfo.Builder creatureGenerationProbability(float pProbability) {
