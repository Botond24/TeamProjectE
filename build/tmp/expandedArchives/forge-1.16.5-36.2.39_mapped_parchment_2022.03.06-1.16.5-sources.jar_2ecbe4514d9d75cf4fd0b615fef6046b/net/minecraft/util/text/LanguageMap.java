...
public abstract class LanguageMap {
   ...
   private static LanguageMap loadDefault() {
      ...
      return new LanguageMap() {
         public String getOrDefault(String pId) {
            return map.getOrDefault(pId, pId);
         }
         ...
         public IReorderingProcessor getVisualOrder(ITextProperties pText) {
            return (p_244262_1_) -> {
               return pText.visit((p_244261_1_, p_244261_2_) -> {
   ...
   public abstract String getOrDefault(String pId);
   ...
   @OnlyIn(Dist.CLIENT)
   public abstract IReorderingProcessor getVisualOrder(ITextProperties pText);
