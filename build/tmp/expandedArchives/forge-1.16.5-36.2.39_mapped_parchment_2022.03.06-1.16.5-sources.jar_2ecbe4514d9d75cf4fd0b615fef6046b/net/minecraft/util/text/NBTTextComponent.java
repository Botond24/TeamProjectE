...
public abstract class NBTTextComponent extends TextComponent implements ITargetedTextComponent {
   ...
   protected abstract Stream<CompoundNBT> getData(CommandSource pCommandSourceStack) throws CommandSyntaxException;
   ...
   public IFormattableTextComponent resolve(@Nullable CommandSource pCommandSourceStack, @Nullable net.minecraft.entity.Entity pEntity, int pRecursionDepth) throws CommandSyntaxException {
      if (pCommandSourceStack != null && this.compiledNbtPath != null) {
         Stream<String> stream = this.getData(pCommandSourceStack).flatMap((p_218675_1_) -> {
            try {
         ...
         return (IFormattableTextComponent)(this.interpreting ? stream.flatMap((p_223137_3_) -> {
            try {
               ...
               return Stream.of(TextComponentUtils.updateForEntity(pCommandSourceStack, iformattabletextcomponent, pEntity, pRecursionDepth));
   ...
   public static class Block extends NBTTextComponent {
      ...
      @Nullable
      private ILocationArgument compilePos(String pPosPattern) {
         try {
      ...
      protected Stream<CompoundNBT> getData(CommandSource pCommandSourceStack) {
         if (this.compiledPos != null) {
            ServerWorld serverworld = pCommandSourceStack.getLevel();
   ...
   public static class Entity extends NBTTextComponent {
      ...
      protected Stream<CompoundNBT> getData(CommandSource pCommandSourceStack) throws CommandSyntaxException {
         if (this.compiledSelector != null) {
            List<? extends net.minecraft.entity.Entity> list = this.compiledSelector.findEntities(pCommandSourceStack);
   ...
   public static class Storage extends NBTTextComponent {
      ...
      protected Stream<CompoundNBT> getData(CommandSource pCommandSourceStack) {
         CompoundNBT compoundnbt = pCommandSourceStack.getServer().getCommandStorage().get(this.id);
