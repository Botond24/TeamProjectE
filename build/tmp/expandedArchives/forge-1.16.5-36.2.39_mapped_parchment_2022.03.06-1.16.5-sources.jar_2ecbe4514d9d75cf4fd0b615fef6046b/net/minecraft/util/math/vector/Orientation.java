...
public enum Orientation implements IStringSerializable {
   ...
   private Orientation(String pName, TriplePermutation pPermutation, boolean pInvertX, boolean pInvertY, boolean pInvertZ) {
      this.name = pName;
      ...
      this.transformation.m00 = pInvertX ? -1.0F : 1.0F;
      this.transformation.m11 = pInvertY ? -1.0F : 1.0F;
      this.transformation.m22 = pInvertZ ? -1.0F : 1.0F;
   ...
   public JigsawOrientation rotate(JigsawOrientation pFrontAndTop) {
      return JigsawOrientation.fromFrontAndTop(this.rotate(pFrontAndTop.front()), this.rotate(pFrontAndTop.top()));
   }
}