...
public final class RegistryKeyCodec<E> implements Codec<Supplier<E>> {
   ...
   public static <E> RegistryKeyCodec<E> create(RegistryKey<? extends Registry<E>> pRegistryKey, Codec<E> pCodec) {
    ...
    */
   public static <E> Codec<List<Supplier<E>>> homogeneousList(RegistryKey<? extends Registry<E>> pRegistryKey, Codec<E> pRegistryKeyCodec) {
      return Codec.either(create(pRegistryKey, pRegistryKeyCodec, false).listOf(), pRegistryKeyCodec.<Supplier<E>>xmap((p_244329_0_) -> {
         return () -> {
            return p_244329_0_;
         };
   ...
   private static <E> RegistryKeyCodec<E> create(RegistryKey<? extends Registry<E>> pRegistryKey, Codec<E> pRegistryKeyCodec, boolean pAllowInlineDefinitions) {
      return new RegistryKeyCodec<>(pRegistryKey, pRegistryKeyCodec, pAllowInlineDefinitions);
   }
