...
public final class SimpleRegistryCodec<E> implements Codec<SimpleRegistry<E>> {
   ...
   public static <E> SimpleRegistryCodec<E> create(RegistryKey<? extends Registry<E>> pRegistryKey, Lifecycle pLifecycle, Codec<E> pRawCodec) {
      return new SimpleRegistryCodec<>(pRegistryKey, pLifecycle, pRawCodec);
   }
