...
public class V0705 extends NamespacedSchema {
   protected static final HookFunction ADD_NAMES = new HookFunction() {
      public <T> T apply(DynamicOps<T> p_apply_1_, T p_apply_2_) {
         return V0099.addNames(new Dynamic<>(p_apply_1_, p_apply_2_), V0704.ITEM_TO_BLOCKENTITY, "minecraft:armor_stand");
      }
   };
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:armor_stand");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:bat");
      registerMob(p_registerEntities_1_, map, "minecraft:blaze");
      p_registerEntities_1_.registerSimple(map, "minecraft:boat");
      registerMob(p_registerEntities_1_, map, "minecraft:cave_spider");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:chicken");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:cow");
      registerMob(p_registerEntities_1_, map, "minecraft:creeper");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:elder_guardian");
      p_registerEntities_1_.registerSimple(map, "minecraft:ender_crystal");
      registerMob(p_registerEntities_1_, map, "minecraft:ender_dragon");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:endermite");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:ghast");
      registerMob(p_registerEntities_1_, map, "minecraft:giant");
      registerMob(p_registerEntities_1_, map, "minecraft:guardian");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:husk");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:magma_cube");
      p_registerEntities_1_.register(map, "minecraft:minecart", (p_206568_1_) -> {
         return DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(p_registerEntities_1_));
      });
      registerMob(p_registerEntities_1_, map, "minecraft:mooshroom");
      p_registerEntities_1_.register(map, "minecraft:mule", (p_206579_1_) -> {
         return DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(p_registerEntities_1_)), "SaddleItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), V0100.equipment(p_registerEntities_1_));
      });
      registerMob(p_registerEntities_1_, map, "minecraft:ocelot");
      p_registerEntities_1_.registerSimple(map, "minecraft:painting");
      p_registerEntities_1_.registerSimple(map, "minecraft:parrot");
      registerMob(p_registerEntities_1_, map, "minecraft:pig");
      registerMob(p_registerEntities_1_, map, "minecraft:polar_bear");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:rabbit");
      registerMob(p_registerEntities_1_, map, "minecraft:sheep");
      registerMob(p_registerEntities_1_, map, "minecraft:shulker");
      p_registerEntities_1_.registerSimple(map, "minecraft:shulker_bullet");
      registerMob(p_registerEntities_1_, map, "minecraft:silverfish");
      registerMob(p_registerEntities_1_, map, "minecraft:skeleton");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:slime");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:snowman");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:spider");
      registerMob(p_registerEntities_1_, map, "minecraft:squid");
      registerMob(p_registerEntities_1_, map, "minecraft:stray");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:villager_golem");
      registerMob(p_registerEntities_1_, map, "minecraft:witch");
      registerMob(p_registerEntities_1_, map, "minecraft:wither");
      registerMob(p_registerEntities_1_, map, "minecraft:wither_skeleton");
      registerThrowableProjectile(p_registerEntities_1_, map, "minecraft:wither_skull");
      registerMob(p_registerEntities_1_, map, "minecraft:wolf");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:zombie");
      p_registerEntities_1_.register(map, "minecraft:zombie_horse", (p_206569_1_) -> {
         return DSL.optionalFields("SaddleItem", TypeReferences.ITEM_STACK.in(p_registerEntities_1_), V0100.equipment(p_registerEntities_1_));
      });
      registerMob(p_registerEntities_1_, map, "minecraft:zombie_pigman");
      registerMob(p_registerEntities_1_, map, "minecraft:zombie_villager");
      p_registerEntities_1_.registerSimple(map, "minecraft:evocation_fangs");
      registerMob(p_registerEntities_1_, map, "minecraft:evocation_illager");
      ...
      registerMob(p_registerEntities_1_, map, "minecraft:vex");
      registerMob(p_registerEntities_1_, map, "minecraft:vindication_illager");
      return map;
   }
   ...
   public void registerTypes(Schema p_registerTypes_1_, Map<String, Supplier<TypeTemplate>> p_registerTypes_2_, Map<String, Supplier<TypeTemplate>> p_registerTypes_3_) {
      ...
      p_registerTypes_1_.registerType(true, TypeReferences.ENTITY, () -> {
         return DSL.taggedChoiceLazy("id", namespacedString(), p_registerTypes_2_);
      });
