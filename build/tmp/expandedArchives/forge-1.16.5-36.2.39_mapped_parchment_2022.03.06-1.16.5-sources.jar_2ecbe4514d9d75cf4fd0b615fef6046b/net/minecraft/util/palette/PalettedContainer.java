...
public class PalettedContainer<T> implements IResizeCallback<T> {
   ...
   public PalettedContainer(IPalette<T> pGlobalPalette, ObjectIntIdentityMap<T> pRegistry, Function<CompoundNBT, T> pReader, Function<T, CompoundNBT> pWriter, T pDefaultValue) {
   ...
   protected void set(int pIndex, T pState) {
      int i = this.palette.idFor(pState);
