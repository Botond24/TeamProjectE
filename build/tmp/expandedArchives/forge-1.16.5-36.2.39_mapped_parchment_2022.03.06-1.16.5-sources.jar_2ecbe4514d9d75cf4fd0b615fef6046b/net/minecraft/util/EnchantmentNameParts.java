...
public class EnchantmentNameParts {
   ...
   public ITextProperties getRandomName(FontRenderer pFontRenderer, int pMaxWidth) {
      ...
      return pFontRenderer.getSplitter().headByWidth((new StringTextComponent(stringbuilder.toString())).withStyle(ROOT_STYLE), pMaxWidth, Style.EMPTY);
   }
