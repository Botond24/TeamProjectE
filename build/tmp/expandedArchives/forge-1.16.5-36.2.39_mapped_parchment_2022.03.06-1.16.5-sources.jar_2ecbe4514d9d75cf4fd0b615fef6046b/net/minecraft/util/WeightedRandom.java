...
public class WeightedRandom {
    ...
    */
   public static int getTotalWeight(List<? extends WeightedRandom.Item> pCollection) {
      int i = 0;
      int j = 0;

      for(int k = pCollection.size(); j < k; ++j) {
         WeightedRandom.Item weightedrandom$item = pCollection.get(j);
