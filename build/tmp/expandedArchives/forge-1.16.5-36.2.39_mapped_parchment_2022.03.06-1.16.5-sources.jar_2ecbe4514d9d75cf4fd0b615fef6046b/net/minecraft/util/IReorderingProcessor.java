...
public interface IReorderingProcessor {
   ...
   @OnlyIn(Dist.CLIENT)
   static IReorderingProcessor codepoint(int pCodePoint, Style pStyle) {
      return (p_242243_2_) -> {
         return p_242243_2_.accept(0, pStyle, pCodePoint);
      };
   }

   @OnlyIn(Dist.CLIENT)
   static IReorderingProcessor forward(String pString, Style pStyle) {
      return pString.isEmpty() ? EMPTY : (p_242245_2_) -> {
         return TextProcessing.iterate(pString, pStyle, p_242245_2_);
      };
   }
