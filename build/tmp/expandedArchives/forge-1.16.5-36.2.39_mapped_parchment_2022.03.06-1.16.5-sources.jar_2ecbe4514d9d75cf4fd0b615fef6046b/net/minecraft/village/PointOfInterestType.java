...
public class PointOfInterestType extends net.minecraftforge.registries.ForgeRegistryEntry<PointOfInterestType> {
   ...
   private static PointOfInterestType register(String pKey, Set<BlockState> pBlockStates, int pMaxFreeTickets, int pValidRange) {
      return registerBlockStates(Registry.register(Registry.POINT_OF_INTEREST_TYPE, new ResourceLocation(pKey), new PointOfInterestType(pKey, pBlockStates, pMaxFreeTickets, pValidRange)));
   }

   private static PointOfInterestType register(String pKey, Set<BlockState> pBlockStates, int pMaxFreeTickets, Predicate<PointOfInterestType> pPredicate, int pValidRange) {
      return registerBlockStates(Registry.register(Registry.POINT_OF_INTEREST_TYPE, new ResourceLocation(pKey), new PointOfInterestType(pKey, pBlockStates, pMaxFreeTickets, pPredicate, pValidRange)));
   }

   private static PointOfInterestType registerBlockStates(PointOfInterestType pPoit) {
      return pPoit;
   }

   public static Optional<PointOfInterestType> forState(BlockState pState) {
