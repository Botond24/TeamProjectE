...
public class Potions {
   ...
   public static final Potion SWIFTNESS = register("swiftness", new Potion(new EffectInstance(Effects.MOVEMENT_SPEED, 3600)));
   public static final Potion LONG_SWIFTNESS = register("long_swiftness", new Potion("swiftness", new EffectInstance(Effects.MOVEMENT_SPEED, 9600)));
   public static final Potion STRONG_SWIFTNESS = register("strong_swiftness", new Potion("swiftness", new EffectInstance(Effects.MOVEMENT_SPEED, 1800, 1)));
   public static final Potion SLOWNESS = register("slowness", new Potion(new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 1800)));
   public static final Potion LONG_SLOWNESS = register("long_slowness", new Potion("slowness", new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 4800)));
   public static final Potion STRONG_SLOWNESS = register("strong_slowness", new Potion("slowness", new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 400, 3)));
   public static final Potion TURTLE_MASTER = register("turtle_master", new Potion("turtle_master", new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 400, 3), new EffectInstance(Effects.DAMAGE_RESISTANCE, 400, 2)));
   public static final Potion LONG_TURTLE_MASTER = register("long_turtle_master", new Potion("turtle_master", new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 800, 3), new EffectInstance(Effects.DAMAGE_RESISTANCE, 800, 2)));
   public static final Potion STRONG_TURTLE_MASTER = register("strong_turtle_master", new Potion("turtle_master", new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 400, 5), new EffectInstance(Effects.DAMAGE_RESISTANCE, 400, 3)));
   ...
   public static final Potion HEALING = register("healing", new Potion(new EffectInstance(Effects.HEAL, 1)));
   public static final Potion STRONG_HEALING = register("strong_healing", new Potion("healing", new EffectInstance(Effects.HEAL, 1, 1)));
   public static final Potion HARMING = register("harming", new Potion(new EffectInstance(Effects.HARM, 1)));
   public static final Potion STRONG_HARMING = register("strong_harming", new Potion("harming", new EffectInstance(Effects.HARM, 1, 1)));
   ...
   /**
    * Registers a new potion type with the game.
    * @see net.minecraft.core.Registry#POTION
    * @return The newly registered potion.
    * @param pKey The identifier to register the potion with.
    * @param pPotion The potion to register.
    */
