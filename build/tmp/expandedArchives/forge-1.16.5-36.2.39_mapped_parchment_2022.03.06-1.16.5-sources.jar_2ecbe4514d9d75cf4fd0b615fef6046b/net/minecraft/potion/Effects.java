...
public class Effects {
   ...
   public static final Effect MOVEMENT_SLOWDOWN = register(2, "slowness", (new Effect(EffectType.HARMFUL, 5926017)).addAttributeModifier(Attributes.MOVEMENT_SPEED, "7107DE5E-7CE8-4030-940E-514C1F160890", (double)-0.15F, AttributeModifier.Operation.MULTIPLY_TOTAL));
   public static final Effect DIG_SPEED = register(3, "haste", (new Effect(EffectType.BENEFICIAL, 14270531)).addAttributeModifier(Attributes.ATTACK_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", (double)0.1F, AttributeModifier.Operation.MULTIPLY_TOTAL));
   public static final Effect DIG_SLOWDOWN = register(4, "mining_fatigue", (new Effect(EffectType.HARMFUL, 4866583)).addAttributeModifier(Attributes.ATTACK_SPEED, "55FCED67-E92A-486E-9800-B47F202C4386", (double)-0.1F, AttributeModifier.Operation.MULTIPLY_TOTAL));
   ...
   public static final Effect LUCK = register(26, "luck", (new Effect(EffectType.BENEFICIAL, 3381504)).addAttributeModifier(Attributes.LUCK, "03C3C89D-7037-4B42-869F-B146BCB64D2E", 1.0D, AttributeModifier.Operation.ADDITION));
   public static final Effect UNLUCK = register(27, "unluck", (new Effect(EffectType.HARMFUL, 12624973)).addAttributeModifier(Attributes.LUCK, "CC5AF142-2BD2-4215-B636-2605AED11727", -1.0D, AttributeModifier.Operation.ADDITION));
   ...
   public static final Effect BAD_OMEN = register(31, "bad_omen", new Effect(EffectType.NEUTRAL, 745784) {
      ...
      public void applyEffectTick(LivingEntity pLivingEntity, int pAmplifier) {
         if (pLivingEntity instanceof ServerPlayerEntity && !pLivingEntity.isSpectator()) {
            ServerPlayerEntity serverplayerentity = (ServerPlayerEntity)pLivingEntity;
   ...
   private static Effect register(int pId, String pKey, Effect pEffect) {
