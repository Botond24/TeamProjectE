...
public class TestArgArgument implements ArgumentType<TestFunctionInfo> {
   ...
   public static TestFunctionInfo getTestFunction(CommandContext<CommandSource> pContext, String pArgument) {
      return pContext.getArgument(pArgument, TestFunctionInfo.class);
   }
