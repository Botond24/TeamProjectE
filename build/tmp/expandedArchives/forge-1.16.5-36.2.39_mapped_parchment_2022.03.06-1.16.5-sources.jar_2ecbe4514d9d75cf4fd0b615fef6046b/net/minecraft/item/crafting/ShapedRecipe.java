...
public class ShapedRecipe implements ICraftingRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingInventory> {
   ...
   public ShapedRecipe(ResourceLocation pId, String pGroup, int pWidth, int pHeight, NonNullList<Ingredient> pRecipeItems, ItemStack pResult) {
      this.id = pId;
      this.group = pGroup;
      this.width = pWidth;
      this.height = pHeight;
    ...
    */
   private boolean matches(CraftingInventory pCraftingInventory, int pWidth, int pHeight, boolean pMirrored) {
   ...
   public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>>  implements IRecipeSerializer<ShapedRecipe> {
      ...
      public ShapedRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
         ...
         Map<String, Ingredient> map = ShapedRecipe.keyFromJson(JSONUtils.getAsJsonObject(pJson, "key"));
         String[] astring = ShapedRecipe.shrink(ShapedRecipe.patternFromJson(JSONUtils.getAsJsonArray(pJson, "pattern")));
      ...
      public ShapedRecipe fromNetwork(ResourceLocation pRecipeId, PacketBuffer pBuffer) {
      ...
      public void toNetwork(PacketBuffer pBuffer, ShapedRecipe pRecipe) {
