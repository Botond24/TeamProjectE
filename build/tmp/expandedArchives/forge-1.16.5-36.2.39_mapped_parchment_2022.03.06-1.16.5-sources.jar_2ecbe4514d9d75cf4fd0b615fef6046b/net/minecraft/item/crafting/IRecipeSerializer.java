...
public interface IRecipeSerializer<T extends IRecipe<?>> extends net.minecraftforge.registries.IForgeRegistryEntry<IRecipeSerializer<?>> {
   ...
   T fromNetwork(ResourceLocation pRecipeId, PacketBuffer pBuffer);

   void toNetwork(PacketBuffer pBuffer, T pRecipe);

   static <S extends IRecipeSerializer<T>, T extends IRecipe<?>> S register(String pKey, S pRecipeSerializer) {
