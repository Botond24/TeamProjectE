...
public class TagRegistryManager {
   ...
   public static void resetAll(ITagCollectionSupplier pSupplier) {
      HELPERS.values().forEach((p_242194_1_) -> {
         p_242194_1_.reset(pSupplier);
      });
   }
   ...
   public static Multimap<ResourceLocation, ResourceLocation> getAllMissingTags(ITagCollectionSupplier pSupplier) {
      Multimap<ResourceLocation, ResourceLocation> multimap = HashMultimap.create();
      HELPERS.forEach((p_242195_2_, p_242195_3_) -> {
         multimap.putAll(p_242195_2_, p_242195_3_.getMissingTags(pSupplier));
      });
      return multimap;
   }
